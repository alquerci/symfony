 ...
 */
class Symfony_Component_DependencyInjection_Exception_RuntimeException extends RuntimeException implements Symfony_Component_DependencyInjection_Exception_ExceptionInterface
{
    /**
     * @var Exception
     */
