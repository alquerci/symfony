 ...
 */
class Symfony_Component_DependencyInjection_Exception_OutOfBoundsException extends OutOfBoundsException implements Symfony_Component_DependencyInjection_Exception_ExceptionInterface
{
    /**
     * @var Exception
     */
