 ...
 */
class Symfony_Component_DependencyInjection_Compiler_RemoveUnusedDefinitionsPass implements Symfony_Component_DependencyInjection_Compiler_RepeatablePassInterface
{
    ...
    public function process(Symfony_Component_DependencyInjection_ContainerBuilder $container)
    {
        ...
        foreach ($container->getDefinitions() as $id => $definition) {
            ...
            if (1 === count($referencingAliases) && false === $isReferenced) {
                $container->setDefinition((string) reset($referencingAliases)->__toString(), $definition);
