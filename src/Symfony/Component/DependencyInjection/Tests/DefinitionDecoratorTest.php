...
class Symfony_Component_DependencyInjection_Tests_DefinitionDecoratorTest extends PHPUnit_Framework_TestCase
{
    public function testConstructor()
    {
        $def = new Symfony_Component_DependencyInjection_DefinitionDecorator('foo');
