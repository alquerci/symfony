...
class Symfony_Component_DependencyInjection_Tests_Dumper_XmlDumperTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $dumper = new Symfony_Component_DependencyInjection_Dumper_XmlDumper($container = new Symfony_Component_DependencyInjection_ContainerBuilder());
