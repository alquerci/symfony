...
class Symfony_Component_DependencyInjection_Tests_Dumper_PhpDumperTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $dumper = new Symfony_Component_DependencyInjection_Dumper_PhpDumper($container = new Symfony_Component_DependencyInjection_ContainerBuilder());
        ...
        new Symfony_Component_DependencyInjection_Dumper_PhpDumper($container);
    }
    ...
    {
        $dumper = new Symfony_Component_DependencyInjection_Dumper_PhpDumper(new Symfony_Component_DependencyInjection_ContainerBuilder(new Symfony_Component_DependencyInjection_ParameterBag_ParameterBag(array('foo' => new Symfony_Component_DependencyInjection_Reference('foo')))));
        $dumper->dump();
    }
    ...
    public function testAddService()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symfony_Component_DependencyInjection_Exception_RuntimeException', $e, '->dump() throws a RuntimeException if the container to be dumped has reference to objects or resources');
