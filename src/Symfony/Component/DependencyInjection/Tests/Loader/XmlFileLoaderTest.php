...
class Symfony_Component_DependencyInjection_Tests_Loader_XmlFileLoaderTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $loader = new Symfony_Component_DependencyInjection_Loader_XmlFileLoader(new Symfony_Component_DependencyInjection_ContainerBuilder(), new Symfony_Component_Config_FileLocator(self::$fixturesPath.'/ini'));
    ...
    {
        $loader = new Symfony_Component_DependencyInjection_Tests_Loader_XmlFileLoader(new Symfony_Component_DependencyInjection_ContainerBuilder(), new Symfony_Component_Config_FileLocator(self::$fixturesPath.'/ini'));
        ...
        try {
            ...
            $this->assertInstanceOf('Symfony_Component_DependencyInjection_Exception_InvalidArgumentException', $e, '->parseFile() throws an InvalidArgumentException if the loaded file is not a valid XML file');
        ...
        $loader = new Symfony_Component_DependencyInjection_Tests_Loader_XmlFileLoader(new Symfony_Component_DependencyInjection_ContainerBuilder(), new Symfony_Component_Config_FileLocator(self::$fixturesPath.'/xml'));

        $xml = $loader->parseFile(self::$fixturesPath.'/xml/services1.xml');
        $this->assertEquals('Symfony_Component_DependencyInjection_SimpleXMLElement', get_class($xml), '->parseFile() returns an SimpleXMLElement object');

        if (version_compare(LIBXML_DOTTED_VERSION, '2.6.27', '<')) {
            $this->markTestIncomplete('Cannot test non valid schema until libxml 2.6.27');
        }
        ...
        try {
            ...
            $this->assertInstanceOf('Symfony_Component_DependencyInjection_Exception_InvalidArgumentException', $e, '->parseFile() throws an InvalidArgumentException if the loaded file does not validate the XSD');
    ...
    public function testLoadParameters()
    {
        ...
        $loader = new Symfony_Component_DependencyInjection_Loader_XmlFileLoader($container, new Symfony_Component_Config_FileLocator(self::$fixturesPath.'/xml'));
        $loader->load('services2.xml');

        $actual = $container->getParameterBag()->all();
        $expected = array('a string', 'foo' => 'bar', 'values' => array(0, 'integer' => 4, 100 => null, 'true', true, false, 'on', 'off', 'float' => 1.3, 1000.3, 'a string', array('foo', 'bar')), 'foo_bar' => new Symfony_Component_DependencyInjection_Reference('foo_bar'), 'mixedcase' => array('MixedCaseKey' => 'value'));
    ...
    public function testLoadImports()
    {
        ...
        $resolver = new Symfony_Component_Config_Loader_LoaderResolver(array(
            new Symfony_Component_DependencyInjection_Loader_IniFileLoader($container, new Symfony_Component_Config_FileLocator(self::$fixturesPath.'/xml')),
            new Symfony_Component_DependencyInjection_Loader_YamlFileLoader($container, new Symfony_Component_Config_FileLocator(self::$fixturesPath.'/xml')),
            $loader = new Symfony_Component_DependencyInjection_Loader_XmlFileLoader($container, new Symfony_Component_Config_FileLocator(self::$fixturesPath.'/xml')),
        ));
        ...
        $actual = $container->getParameterBag()->all();
        $expected = array('a string', 'foo' => 'bar', 'values' => array(true, false), 'foo_bar' => new Symfony_Component_DependencyInjection_Reference('foo_bar'), 'mixedcase' => array('MixedCaseKey' => 'value'), 'bar' => '%foo%', 'imported_from_ini' => true, 'imported_from_yaml' => true);
    ...
    public function testLoadAnonymousServices()
    {
        ...
        $this->assertEquals('Symfony_Component_DependencyInjection_Reference', get_class($args[0]), '->load() converts anonymous services to references to "normal" services');
        $this->assertTrue(isset($services[(string) $args[0]->__toString()]), '->load() makes a reference to the created ones');
        $inner = $services[(string) $args[0]->__toString()];
        ...
        $this->assertEquals('Symfony_Component_DependencyInjection_Reference', get_class($property), '->load() converts anonymous services to references to "normal" services');
        $this->assertTrue(isset($services[(string) $property->__toString()]), '->load() makes a reference to the created ones');
        $inner = $services[(string) $property->__toString()];
        $this->assertEquals('BazClass', $inner->getClass(), '->load() uses the same configuration as for the anonymous ones');
    }
    ...
    public function testLoadServices()
    {
        ...
        $this->assertEquals(array(new Symfony_Component_DependencyInjection_Reference('baz', Symfony_Component_DependencyInjection_ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, false), 'configure'), $services['configurator2']->getConfigurator(), '->load() parses the configurator tag');
    ...
    public function testConvertDomElementToArray()
    {
        ...
        $this->assertEquals('bar', Symfony_Component_DependencyInjection_Loader_XmlFileLoader::convertDomElementToArray($doc->documentElement), '::convertDomElementToArray() converts a DomElement to an array');

        $doc = new DOMDocument("1.0");
        $doc->loadXML('<foo foo="bar" />');
        $this->assertEquals(array('foo' => 'bar'), Symfony_Component_DependencyInjection_Loader_XmlFileLoader::convertDomElementToArray($doc->documentElement), '::convertDomElementToArray() converts a DomElement to an array');
        ...
        $this->assertEquals(array('foo' => array('value' => 'bar', 'foo' => 'bar')), Symfony_Component_DependencyInjection_Loader_XmlFileLoader::convertDomElementToArray($doc->documentElement), '::convertDomElementToArray() converts a DomElement to an array');

        $doc = new DOMDocument("1.0");
        $doc->loadXML('<foo><foo></foo></foo>');
        $this->assertEquals(array('foo' => null), Symfony_Component_DependencyInjection_Loader_XmlFileLoader::convertDomElementToArray($doc->documentElement), '::convertDomElementToArray() converts a DomElement to an array');
        ...
        $this->assertEquals(array('foo' => array(array('foo' => 'bar'), array('foo' => 'bar'))), Symfony_Component_DependencyInjection_Loader_XmlFileLoader::convertDomElementToArray($doc->documentElement), '::convertDomElementToArray() converts a DomElement to an array');
    }
    ...
    public function testExtensions()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symfony_Component_DependencyInjection_Exception_InvalidArgumentException', $e, '->load() throws an InvalidArgumentException if the configuration does not validate the XSD');
    ...
    public function testExtensionInPhar()
    {
        ...
        if (!in_array('phar', stream_get_wrappers())) {
            $this->markTestSkipped('Require phar stream wrapper');
        }
    ...
    /**
     * @covers Symfony_Component_DependencyInjection_Loader_XmlFileLoader::supports
     */
    public function testSupports()
    {
        $loader = new Symfony_Component_DependencyInjection_Loader_XmlFileLoader(new Symfony_Component_DependencyInjection_ContainerBuilder(), new Symfony_Component_Config_FileLocator());
    ...
    public function testNoNamingConflictsForAnonymousServices()
    {
        ...
        $loader1 = new Symfony_Component_DependencyInjection_Loader_XmlFileLoader($container, new Symfony_Component_Config_FileLocator(self::$fixturesPath.'/xml/extension1'));
        $loader1->load('services.xml');
        $services = $container->getDefinitions();
        $this->assertEquals(2, count($services), '->load() attributes unique ids to anonymous services');
        $loader2 = new Symfony_Component_DependencyInjection_Loader_XmlFileLoader($container, new Symfony_Component_Config_FileLocator(self::$fixturesPath.'/xml/extension2'));
        ...
        $inner1 = $services[(string) $args1[0]->__toString()];
        ...
        $inner2 = $services[(string) $args2[0]->__toString()];
    ...
    public function testDocTypeIsNotAllowed()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symfony_Component_DependencyInjection_Exception_InvalidArgumentException', $e, '->load() throws an InvalidArgumentException if the configuration contains a document type');
...
class Symfony_Component_DependencyInjection_Tests_Loader_XmlFileLoader extends Symfony_Component_DependencyInjection_Loader_XmlFileLoader
{
