 ...
 */
class ProjectServiceContainer extends Symfony_Component_DependencyInjection_Container
{
    /**
     * Constructor.
     */
    ...
    {
        parent::__construct(new Symfony_Component_DependencyInjection_ParameterBag_ParameterBag($this->getDefaultParameters()));
    }
    ...
    protected function getMethodCall1Service()
    {
        ...
        $instance->setBar($this->get('foo2', Symfony_Component_DependencyInjection_ContainerInterface::NULL_ON_INVALID_REFERENCE));
        if ($this->has('foo3')) {
            $instance->setBar($this->get('foo3', Symfony_Component_DependencyInjection_ContainerInterface::NULL_ON_INVALID_REFERENCE));
        }
        if ($this->has('foobaz')) {
            $instance->setBar($this->get('foobaz', Symfony_Component_DependencyInjection_ContainerInterface::NULL_ON_INVALID_REFERENCE));
        }
