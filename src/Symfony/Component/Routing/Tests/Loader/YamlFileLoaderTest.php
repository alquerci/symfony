...
class Symfony_Component_Routing_Tests_Loader_YamlFileLoaderTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $loader = new Symfony_Component_Routing_Loader_YamlFileLoader($this->getMock('Symfony_Component_Config_FileLocator'));
    ...
    {
        $loader = new Symfony_Component_Routing_Loader_YamlFileLoader(new Symfony_Component_Config_FileLocator(array(dirname(__FILE__).'/../Fixtures')));
        $collection = $loader->load('empty.yml');

        $this->assertEquals(array(), $collection->all());
        $this->assertEquals(array(new Symfony_Component_Config_Resource_FileResource(realpath(dirname(__FILE__).'/../Fixtures/empty.yml'))), $collection->getResources());
    }
    ...
    public function testLoadSpecialRouteName()
    {
        ...
        $this->assertInstanceOf('Symfony_Component_Routing_Route', $route);
