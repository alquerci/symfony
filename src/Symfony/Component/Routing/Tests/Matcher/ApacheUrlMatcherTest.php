...
class Symfony_Component_Routing_Tests_Matcher_ApacheUrlMatcherTest extends PHPUnit_Framework_TestCase
{
    protected $server;
    ...
    public function testMatch($name, $pathinfo, $server, $expect)
    {
        ...
        $matcher = new Symfony_Component_Routing_Matcher_ApacheUrlMatcher($collection, $context);
