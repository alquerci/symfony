...
class Symfony_Component_Routing_Tests_RouteCompilerTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $r = new ReflectionClass('Symfony_Component_Routing_Route');
    ...
    {
        $route = new Symfony_Component_Routing_Route('/{name}/{name}');
    ...
    {
        $route = new Symfony_Component_Routing_Route('/{'. $name . '}');
        $route->compile();
    }
