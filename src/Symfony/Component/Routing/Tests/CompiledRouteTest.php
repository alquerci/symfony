...
class Symfony_Component_Routing_Tests_CompiledRouteTest extends PHPUnit_Framework_TestCase
{
    public function testAccessors()
    {
        $compiled = new Symfony_Component_Routing_CompiledRoute('prefix', 'regex', array('tokens'), array(), array(), array(), array(), array('variables'));
