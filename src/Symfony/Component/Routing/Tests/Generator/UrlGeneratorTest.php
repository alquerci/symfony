...
class Symfony_Component_Routing_Tests_Generator_UrlGeneratorTest extends PHPUnit_Framework_TestCase
{
    public function testAbsoluteUrlWithPort80()
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/testing'));
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/testing/{foo}'));
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/testing.{format}', array('format' => null)));
        $url = $this->getGenerator($routes)->generate('test', array(), false);
    ...
    /**
     * @expectedException Symfony_Component_Routing_Exception_InvalidParameterException
     */
    public function testRelativeUrlWithNullParameterButNotOptional()
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/testing/{foo}/bar', array('foo' => null)));
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/testing/{page}'));
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/{slug}/{page}', array('slug' => 'index', 'page' => 0)));
    ...
    public function testUrlWithExtraParametersFromGlobals()
    {
        ...
        $context = new Symfony_Component_Routing_RequestContext('/app.php');
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/{_locale}', array('_locale' => 'en')));
        $generator = $this->getGenerator($routes);
        $context = new Symfony_Component_Routing_RequestContext('/app.php');
    ...
    {
        $routes = $this->getRoutes('foo', new Symfony_Component_Routing_Route('/testing/{foo}'));
        $this->getGenerator($routes)->generate('test', array(), true);
    }

    /**
     * @expectedException Symfony_Component_Routing_Exception_MissingMandatoryParametersException
     */
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/testing/{foo}', array('foo' => '1'), array('foo' => 'd+')));
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/testing/{foo}', array(), array('foo' => '1|2')));
    ...
    {
        if (!interface_exists('Psr_Log_LoggerInterface')) {
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/testing/{foo}', array(), array('foo' => 'd+')));
        $this->getGenerator($routes)->generate('test', array('foo' => 'bar'), true);
    }
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/{slug}', array(), array('slug' => '.+')));
        $this->getGenerator($routes)->generate('test', array('slug' => ''));
    }

    public function testSchemeRequirementDoesNothingIfSameCurrentScheme()
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/', array(), array('_scheme' => 'http')));
        $this->assertEquals('/app.php/', $this->getGenerator($routes)->generate('test'));

        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/', array(), array('_scheme' => 'https')));
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('//path-and-not-domain'));
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/category/{slug1}/{slug2}/{slug3}', array('slug2' => null, 'slug3' => null)));
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/{default}', array('default' => 0)));
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/test/{default}', array('default' => 0)));
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/test', array('default' => 'value')));
    ...
    {
        $routes = $this->getRoutes('$péß^a|', new Symfony_Component_Routing_Route('/bar'));
    ...
    public function testUrlEncoding()
    {
        ...
        $chars = '@:[]/()*\'" +,;-._~&$<>|{}%\\^`!?foo=bar#id';
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route("/$chars/{varpath}", array(), array('varpath' => '.+')));
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/dir/../dir/..'));
        ...
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/a./.a/a../..a/...'));
        $this->assertSame('/app.php/a./.a/a../..a/...', $this->getGenerator($routes)->generate('test'));
    }

    public function testAdjacentVariables()
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/{x}{y}{z}.{_format}', array('z' => 'default-z', '_format' => 'html'), array('y' => '\d+')));
        $generator = $this->getGenerator($routes);
        ...
        $this->setExpectedException('Symfony_Component_Routing_Exception_InvalidParameterException');
        $generator->generate('test', array('x' => 'do.t', 'y' => '123', 'z' => 'bar', '_format' => 'xml'));
    }

    public function testOptionalVariableWithNoRealSeparator()
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/get{what}', array('what' => 'All')));
        $generator = $this->getGenerator($routes);
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/get{what}Suffix'));
        $generator = $this->getGenerator($routes);
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/{page}.{_format}'));
        $generator = $this->getGenerator($routes);
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/{name}', array(), array(), array(), '{locale}.example.com'));
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/', array(), array('foo' => 'bar'), array(), '{foo}.example.com'));
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/', array('foo' => 'bar'), array('foo' => 'bar'), array(), '{foo}.example.com'));
        $this->getGenerator($routes)->generate('test', array('foo' => 'baz'), false);
    }
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/', array('foo' => 'baz'), array('foo' => 'bar'), array(), '{foo}.example.com'));
        $this->getGenerator($routes)->generate('test', array('foo' => 'baz'), false);
    }
    ...
    {
        $routes = $this->getRoutes('test', new Symfony_Component_Routing_Route('/{name}', array(), array('_scheme' => 'http'), array(), '{locale}.example.com'));

        $this->assertSame('//fr.example.com/app.php/Fabien', $this->getGenerator($routes)->generate('test',
            array('name' =>'Fabien', 'locale' => 'fr'), Symfony_Component_Routing_Generator_UrlGeneratorInterface::NETWORK_PATH), 'network path with different host'
        );
        $this->assertSame('//fr.example.com/app.php/Fabien?query=string', $this->getGenerator($routes, array('host' => 'fr.example.com'))->generate('test',
            array('name' =>'Fabien', 'locale' => 'fr', 'query' => 'string'), Symfony_Component_Routing_Generator_UrlGeneratorInterface::NETWORK_PATH), 'network path although host same as context'
        );
        $this->assertSame('http://fr.example.com/app.php/Fabien', $this->getGenerator($routes, array('scheme' => 'https'))->generate('test',
            array('name' =>'Fabien', 'locale' => 'fr'), Symfony_Component_Routing_Generator_UrlGeneratorInterface::NETWORK_PATH), 'absolute URL because scheme requirement does not match context'
        );
        $this->assertSame('http://fr.example.com/app.php/Fabien', $this->getGenerator($routes)->generate('test',
            array('name' =>'Fabien', 'locale' => 'fr'), Symfony_Component_Routing_Generator_UrlGeneratorInterface::ABSOLUTE_URL), 'absolute URL with same scheme because it is requested'
        );
    }
    ...
    public function testGenerateRelativePath()
    {
        ...
        $routes->add('article', new Symfony_Component_Routing_Route('/{author}/{article}/'));
        $routes->add('comments', new Symfony_Component_Routing_Route('/{author}/{article}/comments'));
        $routes->add('host', new Symfony_Component_Routing_Route('/{article}', array(), array(), array(), '{author}.example.com'));
        $routes->add('scheme', new Symfony_Component_Routing_Route('/{author}', array(), array('_scheme' => 'https')));
        $routes->add('unrelated', new Symfony_Component_Routing_Route('/about'));
        ...
        $this->assertSame('comments', $generator->generate('comments',
            array('author' =>'fabien', 'article' => 'symfony-is-great'), Symfony_Component_Routing_Generator_UrlGeneratorInterface::RELATIVE_PATH)
        );
        $this->assertSame('comments?page=2', $generator->generate('comments',
            array('author' =>'fabien', 'article' => 'symfony-is-great', 'page' => 2), Symfony_Component_Routing_Generator_UrlGeneratorInterface::RELATIVE_PATH)
        );
        $this->assertSame('../twig-is-great/', $generator->generate('article',
            array('author' =>'fabien', 'article' => 'twig-is-great'), Symfony_Component_Routing_Generator_UrlGeneratorInterface::RELATIVE_PATH)
        );
        $this->assertSame('../../bernhard/forms-are-great/', $generator->generate('article',
            array('author' =>'bernhard', 'article' => 'forms-are-great'), Symfony_Component_Routing_Generator_UrlGeneratorInterface::RELATIVE_PATH)
        );
        ...
        $this->assertSame('https://example.com/app.php/bernhard', $generator->generate('scheme',
            array('author' =>'bernhard'), Symfony_Component_Routing_Generator_UrlGeneratorInterface::RELATIVE_PATH)
        );
        $this->assertSame('../../about', $generator->generate('unrelated',
            array(), Symfony_Component_Routing_Generator_UrlGeneratorInterface::RELATIVE_PATH)
        );
    }
    ...
    {
        $this->assertSame($expectedPath, Symfony_Component_Routing_Generator_UrlGenerator::getRelativePath($sourcePath, $targetPath));
    }
    ...
    protected function getGenerator(Symfony_Component_Routing_RouteCollection $routes, array $parameters = array(), $logger = null)
    {
        $context = new Symfony_Component_Routing_RequestContext('/app.php');
        ...
        $generator = new Symfony_Component_Routing_Generator_UrlGenerator($routes, $context, $logger);

        return $generator;
    }

    protected function getRoutes($name, Symfony_Component_Routing_Route $route)
    {
        $routes = new Symfony_Component_Routing_RouteCollection();
