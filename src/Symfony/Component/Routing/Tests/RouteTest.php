...
class Symfony_Component_Routing_Tests_RouteTest extends PHPUnit_Framework_TestCase
{
    public function testConstructor()
    {
        $route = new Symfony_Component_Routing_Route('/{foo}', array('foo' => 'bar'), array('foo' => '\d+'), array('foo' => 'bar'), '{locale}.example.com');
        ...
        $route = new Symfony_Component_Routing_Route('/', array(), array(), array(), '', array('Https'), array('POST', 'put'));
        ...
        $route = new Symfony_Component_Routing_Route('/', array(), array(), array(), '', 'Https', 'Post');
    ...
    public function testOptions()
    {
        ...
        'compiler_class'     => 'Symfony_Component_Routing_RouteCompiler',
        ...
        $this->assertEquals(array('foo' => 'foo', 'bar' => 'bar', 'compiler_class' => 'Symfony_Component_Routing_RouteCompiler'), $route->getOptions(), '->addDefaults() keep previous defaults');
    }
    ...
    public function testDefaults()
    {
        ...
        $route->setDefault('_controller', $closure = create_function('', 'return "Hello";'));
    ...
    {
        $route = new Symfony_Component_Routing_Route('/{foo}');
        $this->assertInstanceOf('Symfony_Component_Routing_CompiledRoute', $compiled = $route->compile(), '->compile() returns a compiled route');
