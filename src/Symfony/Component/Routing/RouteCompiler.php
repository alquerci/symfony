 ...
 */
class Symfony_Component_Routing_RouteCompiler implements Symfony_Component_Routing_RouteCompilerInterface
{
    ...
    public static function compile(Symfony_Component_Routing_Route $route)
    {
        ...
        return new Symfony_Component_Routing_CompiledRoute(
            $staticPrefix,
            $regex,
            $tokens,
            $pathVariables,
    ...
    private static function compilePattern(Symfony_Component_Routing_Route $route, $pattern, $isHost)
    {
        $tokens = array();
        $variables = array();
        $matches = array();
        ...
        foreach ($matches as $match) {
            ...
            $isSeparator = '' !== $precedingChar && false !== strpos(/* static */ self::SEPARATORS, $precedingChar);
    ...
    private static function findNextSeparator($pattern)
    {
        ...
        return isset($pattern[0]) && false !== strpos(/* static */ self::SEPARATORS, $pattern[0]) ? $pattern[0] : '';
    }
