 ...
 */
class Symfony_Component_Routing_Matcher_ApacheUrlMatcher extends Symfony_Component_Routing_Matcher_UrlMatcher
{
    /**
     ...
     *
     * @throws Symfony_Component_Routing_Exception_MethodNotAllowedException If the current method is not allowed
     */
    public function match($pathinfo)
    {
        ...
        if (null !== $route) {
            ...
            throw new Symfony_Component_Routing_Exception_MethodNotAllowedException($allow);
        } else {
