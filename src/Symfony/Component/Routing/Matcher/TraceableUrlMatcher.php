 ...
 */
class Symfony_Component_Routing_Matcher_TraceableUrlMatcher extends Symfony_Component_Routing_Matcher_UrlMatcher
{
    ...
    public function getTraces($pathinfo)
    {
        ...
        try {
            $this->match($pathinfo);
        } catch (Symfony_Component_Routing_Exception_ExceptionInterface $e) {
        }
    ...
    protected function matchCollection($pathinfo, Symfony_Component_Routing_RouteCollection $routes)
    {
        foreach ($routes as $name => $route) {
            ...
            if (!preg_match($compiledRoute->getRegex(), $pathinfo, $matches)) {
                ...
                $r = new Symfony_Component_Routing_Route($route->getPath(), $route->getDefaults(), array(), $route->getOptions());
                $cr = $r->compile();
                ...
                foreach ($route->getRequirements() as $n => $regex) {
                    $r = new Symfony_Component_Routing_Route($route->getPath(), $route->getDefaults(), array($n => $regex), $route->getOptions());
                    $cr = $r->compile();
