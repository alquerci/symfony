 ...
 */
class Symfony_Component_Routing_Matcher_Dumper_DumperPrefixCollection extends Symfony_Component_Routing_Matcher_Dumper_DumperCollection
{
    /**
     * @var string
     */
     ...
     *
     * @param Symfony_Component_Routing_Matcher_Dumper_DumperRoute $route The route
     *
     * @return Symfony_Component_Routing_Matcher_Dumper_DumperPrefixCollection The node the route was added to
     *
     * @throws LogicException
     */
    public function addPrefixRoute(Symfony_Component_Routing_Matcher_Dumper_DumperRoute $route)
    {
        ...
        if ('' === $this->prefix || 0 === strpos($prefix, $this->prefix)) {
            $collection = new Symfony_Component_Routing_Matcher_Dumper_DumperPrefixCollection();
