 ...
 * @api
 */
class Symfony_Component_Routing_RouteCollection implements IteratorAggregate, Countable
{
    /**
     ...
     *
     * @return Symfony_Component_Routing_RouteCollection|null The parent RouteCollection or null when it's the root
     *
     * @deprecated since version 2.2, will be removed in 2.3
     */
     ...
     *
     * @return Symfony_Component_Routing_RouteCollection The root RouteCollection
     *
     * @deprecated since version 2.2, will be removed in 2.3
     */
     ...
     * @api
     */
    public function add($name, Symfony_Component_Routing_Route $route)
    {
     ...
     *
     * @return Symfony_Component_Routing_Route[] An array of routes
     */
    public function all()
    {
        return $this->routes;
     ...
     * @param string $name The route name
     *
     * @return Symfony_Component_Routing_Route|null A Route instance or null when not found
     */
     ...
     *
     * @param Symfony_Component_Routing_RouteCollection $collection      A RouteCollection instance
     *
     * @api
     */
    public function addCollection(Symfony_Component_Routing_RouteCollection $collection)
    {
