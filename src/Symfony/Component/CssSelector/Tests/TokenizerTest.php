...
class Symfony_Component_CssSelector_Tests_TokenizerTest extends PHPUnit_Framework_TestCase
{
    protected $tokenizer;

    protected function setUp()
    {
        $this->tokenizer = new Symfony_Component_CssSelector_Tokenizer();
    }
    ...
    /**
     * @expectedException Symfony_Component_CssSelector_Exception_ParseException
     */
    ...
    protected function tokensToString($tokens)
    {
        ...
        foreach ($tokens as $token) {
            $str .= str_repeat(' ', $token->getPosition() - strlen($str)).$token->__toString();
        }
