 ...
 */
class Symfony_Component_CssSelector_XPathExpr
{
    private $prefix;
    private $path;
    private $element;
    ...
    public function addNameTest()
    {
        ...
        $this->addCondition(sprintf('name() = %s', Symfony_Component_CssSelector_XPathExpr::xpathLiteral($this->element)));
        $this->element = '*';
    }
     ...
     * @param Symfony_Component_CssSelector_XPathExpr $other    The other XPath expression to combine with
     *                            this one.
     */
    public function join($combiner, $other)
    {
        $prefix = (string) $this->__toString();
     ...
     *
     * @param mixed $s Can either be a Symfony_Component_CssSelector_Node_ElementNode or a string.
     *
     * @return string
     */
    public static function xpathLiteral($s)
    {
        if ($s instanceof Symfony_Component_CssSelector_Node_ElementNode) {
            ...
            $s = (string) ((is_object($s) && method_exists($s, '__toString')) ? $s->__toString() : $s);
        }
