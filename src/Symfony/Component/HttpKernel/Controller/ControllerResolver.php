 ...
 * @api
 */
class Symfony_Component_HttpKernel_Controller_ControllerResolver implements Symfony_Component_HttpKernel_Controller_ControllerResolverInterface
{
    private $logger;
    ...
    protected function doGetArguments(Symfony_Component_HttpFoundation_Request $request, $controller, array $parameters)
    {
