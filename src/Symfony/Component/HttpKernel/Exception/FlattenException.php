 ...
 */
class Symfony_Component_HttpKernel_Exception_FlattenException
{
    private $message;
    private $code;
    private $previous;
    ...
    public function setPrevious(Symfony_Component_HttpKernel_Exception_FlattenException $previous)
    {
    ...
    public function setTraceFromException(\Exception $exception)
    {
        ...
        if ($exception instanceof Symfony_Component_HttpKernel_Exception_FatalErrorException) {
