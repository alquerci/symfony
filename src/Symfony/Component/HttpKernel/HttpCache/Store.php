 ...
 */
class Symfony_Component_HttpKernel_HttpCache_Store implements Symfony_Component_HttpKernel_HttpCache_StoreInterface
{
    protected $root;
    private $keyCache;
    private $locks;
    ...
    public function lock(Symfony_Component_HttpFoundation_Request $request)
    {
        ...
        return !file_exists($path) ? true : $path;
    }
     ...
     * @return string
     */
    protected function generateContentDigest(Symfony_Component_HttpFoundation_Response $response)
    {
    ...
    {
        if (is_file($path = $this->getPath($this->getCacheKey(Symfony_Component_HttpFoundation_Request::create($url))))) {
            unlink($path);
     ...
     */
    private function getCacheKey(Symfony_Component_HttpFoundation_Request $request)
    {
     ...
     */
    private function persistRequest(Symfony_Component_HttpFoundation_Request $request)
    {
     ...
     * @return array An array of HTTP headers
     */
    private function persistResponse(Symfony_Component_HttpFoundation_Response $response)
    {
    ...
    private function restoreResponse($headers, $body = null)
    {
        ...
        return new Symfony_Component_HttpFoundation_Response($body, $status, $headers);
    }
}
