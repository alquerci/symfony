 ...
 * @api
 */
class Symfony_Component_HttpKernel_HttpCache_HttpCache implements Symfony_Component_HttpKernel_HttpKernelInterface, Symfony_Component_HttpKernel_TerminableInterface
{
    private $kernel;
    private $store;
    private $request;
     ...
     * @param Symfony_Component_HttpKernel_HttpCache_StoreInterface      $store   A Store instance
     * @param Symfony_Component_HttpKernel_HttpCache_Esi                 $esi     An Esi instance
     * @param array               $options An array of options
     */
    public function __construct(Symfony_Component_HttpKernel_HttpKernelInterface $kernel, Symfony_Component_HttpKernel_HttpCache_StoreInterface $store, Symfony_Component_HttpKernel_HttpCache_Esi $esi = null, array $options = array())
    {
        $this->store = $store;
        $this->kernel = $kernel;
     ...
     *
     * @return Symfony_Component_HttpKernel_HttpCache_StoreInterface $store A StoreInterface instance
     */
     ...
     *
     * @return Symfony_Component_HttpKernel_HttpKernelInterface An HttpKernelInterface instance
     */
     ...
     *
     * @return Symfony_Component_HttpKernel_HttpCache_Esi An Esi instance
     */
    ...
    public function handle(Symfony_Component_HttpFoundation_Request $request, $type = Symfony_Component_HttpKernel_HttpKernelInterface::MASTER_REQUEST, $catch = true)
    {
        ...
        if (Symfony_Component_HttpKernel_HttpKernelInterface::MASTER_REQUEST === $type) {
            $this->traces = array();
        ...
        if (Symfony_Component_HttpKernel_HttpKernelInterface::MASTER_REQUEST === $type && $this->options['debug']) {
    ...
    {
        if ($this->getKernel() instanceof Symfony_Component_HttpKernel_TerminableInterface) {
     ...
     */
    protected function pass(Symfony_Component_HttpFoundation_Request $request, $catch = false)
    {
     ...
     * @see RFC2616 13.10
     */
    protected function invalidate(Symfony_Component_HttpFoundation_Request $request, $catch = false)
    {
        $response = $this->pass($request, $catch);
     ...
     * @throws Exception
     */
    protected function lookup(Symfony_Component_HttpFoundation_Request $request, $catch = false)
    {
     ...
     *
     * @param Symfony_Component_HttpFoundation_Request  $request A Request instance
     * @param Symfony_Component_HttpFoundation_Response $entry   A Response instance to validate
     * @param Boolean  $catch   Whether to process exceptions
     *
     * @return Symfony_Component_HttpFoundation_Response A Response instance
     */
    protected function validate(Symfony_Component_HttpFoundation_Request $request, Symfony_Component_HttpFoundation_Response $entry, $catch = false)
    {
     ...
     * @return Symfony_Component_HttpFoundation_Response A Response instance
     */
    protected function fetch(Symfony_Component_HttpFoundation_Request $request, $catch = false)
    {
        $subRequest = clone $request;
     ...
     * @return Symfony_Component_HttpFoundation_Response A Response instance
     */
    protected function forward(Symfony_Component_HttpFoundation_Request $request, $catch = false, Symfony_Component_HttpFoundation_Response $entry = null)
    {
        if ($this->esi) {
        ...
        $response = $this->kernel->handle($request, Symfony_Component_HttpKernel_HttpKernelInterface::MASTER_REQUEST, $catch);
     ...
     *
     * @param Symfony_Component_HttpFoundation_Request  $request A Request instance
     * @param Symfony_Component_HttpFoundation_Response $entry   A Response instance
     *
     * @return Boolean true if the cache entry if fresh enough, false otherwise
     */
    protected function isFreshEnough(Symfony_Component_HttpFoundation_Request $request, Symfony_Component_HttpFoundation_Response $entry)
    {
        if (!$entry->isFresh()) {
     ...
     */
    protected function lock(Symfony_Component_HttpFoundation_Request $request, Symfony_Component_HttpFoundation_Response $entry)
    {
     ...
     * @throws Exception
     */
    protected function store(Symfony_Component_HttpFoundation_Request $request, Symfony_Component_HttpFoundation_Response $response)
    {
        try {
     ...
     * @return Symfony_Component_HttpFoundation_Response A Response instance
     */
    private function restoreResponseBody(Symfony_Component_HttpFoundation_Request $request, Symfony_Component_HttpFoundation_Response $response)
    {
    ...
    protected function processResponseBody(Symfony_Component_HttpFoundation_Request $request, Symfony_Component_HttpFoundation_Response $response)
    {
     ...
     */
    private function isPrivateRequest(Symfony_Component_HttpFoundation_Request $request)
    {
     ...
     */
    private function record(Symfony_Component_HttpFoundation_Request $request, $event)
    {
        $path = $request->getPathInfo();
        if ($qs = $request->getQueryString()) {
            $path .= '?'.$qs;
