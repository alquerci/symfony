 ...
 */
class Symfony_Component_HttpKernel_HttpCache_Esi
{
     ...
     *
     * @return Symfony_Component_HttpKernel_HttpCache_EsiResponseCacheStrategyInterface A EsiResponseCacheStrategyInterface instance
     */
    public function createCacheStrategy()
    {
        return new Symfony_Component_HttpKernel_HttpCache_EsiResponseCacheStrategy();
    }
     ...
     */
    public function hasSurrogateEsiCapability(Symfony_Component_HttpFoundation_Request $request)
    {
     ...
     * @param Symfony_Component_HttpFoundation_Request $request A Request instance
     */
    public function addSurrogateEsiCapability(Symfony_Component_HttpFoundation_Request $request)
    {
     ...
     */
    public function addSurrogateControl(Symfony_Component_HttpFoundation_Response $response)
    {
     ...
     */
    public function needsEsiParsing(Symfony_Component_HttpFoundation_Response $response)
    {
     ...
     */
    public function process(Symfony_Component_HttpFoundation_Request $request, Symfony_Component_HttpFoundation_Response $response)
    {
     ...
     *
     * @param Symfony_Component_HttpKernel_HttpCache_HttpCache $cache        An HttpCache instance
     ...
     * @throws Exception
     */
    public function handle(Symfony_Component_HttpKernel_HttpCache_HttpCache $cache, $uri, $alt, $ignoreErrors)
    {
        $subRequest = Symfony_Component_HttpFoundation_Request::create($uri, 'get', array(), $cache->getRequest()->cookies->all(), array(), $cache->getRequest()->server->all());

        try {
            $response = $cache->handle($subRequest, Symfony_Component_HttpKernel_HttpKernelInterface::SUB_REQUEST, true);
