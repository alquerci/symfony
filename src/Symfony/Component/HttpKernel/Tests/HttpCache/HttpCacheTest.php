...
class Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTest extends Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestCase
{
    ...
    public function testTerminateDelegatesTerminationOnlyForTerminableInterface()
    {
        ...
        $storeMock = $this->getMockBuilder('Symfony_Component_HttpKernel_HttpCache_StoreInterface')
            ->disableOriginalConstructor()
            ->getMock();

        // does not implement TerminableInterface
        $kernelMock = $this->getMockBuilder('Symfony_Component_HttpKernel_HttpKernelInterface')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $kernel = new Symfony_Component_HttpKernel_HttpCache_HttpCache($kernelMock, $storeMock);
        $kernel->terminate(Symfony_Component_HttpFoundation_Request::create('/'), new Symfony_Component_HttpFoundation_Response());

        // implements TerminableInterface
        $kernelMock = $this->getMockBuilder('Symfony_Component_HttpKernel_Kernel')
            ->disableOriginalConstructor()
    ...
    public function testRespondsWith304OnlyIfIfNoneMatchAndIfModifiedSinceBothMatch()
    {
        ...
        $this->setNextResponse(200, array(), '', array(new Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure1($time), '__invoke'));
    ...
    {
        $this->setNextResponse(200, array(), '', create_function('$request, $response', '
    ...
    public function testReloadsResponsesWhenCacheHitsButNoCacheRequestDirectivePresentWhenAllowReloadIsSetTrue()
    {
        ...
        $this->setNextResponse(200, array('Cache-Control' => 'public, max-age=10000'), '', array(new Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure2($count), '__invoke'));
    ...
    public function testRevalidatesFreshCacheEntryWhenMaxAgeRequestDirectiveIsExceededWhenAllowRevalidateOptionIsSetTrue()
    {
        ...
        $this->setNextResponse(200, array(), '', array(new Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure3($count), '__invoke'));
    ...
    {
        $time = DateTime::createFromFormat('U', time());
        $this->setNextResponse(200, array(), 'Hello World', array(new Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure4($time), '__invoke'));
    ...
    {
        $this->setNextResponse(200, array(), 'Hello World', create_function('$request, $response', '
            $response->headers->set("Cache-Control", "public");
    ...
    public function testReplacesCachedResponsesWhenValidationResultsInNon304Response()
    {
        $time = DateTime::createFromFormat('U', time());
        $count = 0;
        $this->setNextResponse(200, array(), 'Hello World', array(new Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure5($time, $count), '__invoke'));
    ...
    {
        $that = $this;
        $this->setNextResponse(200, array(), 'Hello World', array(new Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure6($that), '__invoke'));
    ...
    {
        $that = $this;
        $this->setNextResponse(200, array(), 'Hello World', array(new Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure7($that), '__invoke'));
    ...
    public function testSendsNoContentWhenFresh()
    {
        $time = DateTime::createFromFormat('U', time());
        $that = $this;
        $this->setNextResponse(200, array(), 'Hello World', array(new Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure8($that, $time), '__invoke'));
    ...
    {
        $count = 0;
        $this->setNextResponse(200, array('Cache-Control' => 'max-age=10000'), '', array(new Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure9($count), '__invoke'));
...
class Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure1
{
    private $time;
...
class Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure2
{
    private $count;
    ...
    {
        ++$this->count;
        $response->setContent(1 == $this->count ? 'Hello World' : 'Goodbye World');
    }
}

class Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure3
{
    private $count;
    ...
    public function __invoke($request, $response)
    {
        ...
        $response->setETag($this->count);
        $response->setContent(1 == $this->count ? 'Hello World' : 'Goodbye World');
    }
}

class Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure4
{
    private $time;
...
class Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure5
{
    private $time;
    private $count;

    public function __construct($time, &$count)
    {
        $this->time = $time;
        $this->count = &$count;
    }
...
class Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure6
{
    private $that;
    ...
    public function __invoke($request, $response)
    {
        $response->setContent('');
        $response->setStatusCode(200);
        $this->that->assertEquals('HEAD', $request->getMethod());
    }
}

class Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure7
{
    private $that;
    ...
    public function __invoke($request, $response)
    {
        ...
        $response->setContent('Hello World');
        $response->setStatusCode(200);
        $this->that->assertNotEquals('HEAD', $request->getMethod());
    }
}

class Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure8
{
    private $that;
    private $time;

    public function __construct($that, $time)
    {
        $this->that = $that;
        $this->time = $time;
    }
...
class Symfony_Component_HttpKernel_Tests_HttpCache_HttpCacheTestClosure9
{
    private $count;
    ...
    public function __invoke($request, $response)
    {
        ...
        $response->headers->set('Cache-Control', 'public, max-age=10');
        $response->headers->set('X-Response-Count', ++$this->count);
