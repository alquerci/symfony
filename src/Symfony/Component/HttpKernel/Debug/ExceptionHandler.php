 ...
 */
class Symfony_Component_HttpKernel_Debug_ExceptionHandler
{
    private $debug;
    private $charset;
     ...
     * @param Boolean $debug
     *
     * @return Symfony_Component_HttpKernel_Debug_ExceptionHandler The registered exception handler
     */
    ...
    {
        if (!$exception instanceof Symfony_Component_HttpKernel_Exception_FlattenException) {
            $exception = Symfony_Component_HttpKernel_Exception_FlattenException::create($exception);
        }

        return new Symfony_Component_HttpFoundation_Response($this->decorate($this->getContent($exception), $this->getStylesheet($exception)), $exception->getStatusCode(), $exception->getHeaders());
    }

    /**
     * Gets the HTML content associated with the given exception.
     *
     * @param Symfony_Component_HttpKernel_Exception_FlattenException $exception A FlattenException instance
     *
     * @return string The content as a string
     */
    public function getContent(Symfony_Component_HttpKernel_Exception_FlattenException $exception)
    {
...
EOF;
     ...
     */
    public function getStylesheet(Symfony_Component_HttpKernel_Exception_FlattenException $exception)
    {
        return <<<EOF
