 ...
 */
class Symfony_Component_HttpKernel_Debug_ErrorHandler
{
     ...
     *
     * @return Symfony_Component_HttpKernel_Debug_ErrorHandler The registered error handler
     */
    ...
    public static function setLogger(Psr_Log_LoggerInterface $logger)
    {
        self::$logger = $logger;
    }
    ...
    public function handleFatal()
    {
        ...
        $exceptionHandler = set_exception_handler(create_function('', ''));
        restore_exception_handler();

        if (is_array($exceptionHandler) && $exceptionHandler[0] instanceof Symfony_Component_HttpKernel_Debug_ExceptionHandler) {
