...
namespace Symfony\Component\Kernel\Tests\CacheWarmer;

use PHPUnit\Framework\TestCase;
use Symfony\Component\Kernel\CacheWarmer\CacheWarmerAggregate;
...
class CacheWarmerAggregateTest extends TestCase
{
    ...
    {
        $warmer = $this->getMockBuilder('Symfony\Component\Kernel\CacheWarmer\CacheWarmerInterface')
