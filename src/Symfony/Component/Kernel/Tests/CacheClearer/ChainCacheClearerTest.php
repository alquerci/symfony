...
namespace Symfony\Component\Kernel\Tests\CacheClearer;

use PHPUnit\Framework\TestCase;
use Symfony\Component\Kernel\CacheClearer\ChainCacheClearer;
...
class ChainCacheClearerTest extends TestCase
{
    ...
    {
        return $this->getMockBuilder('Symfony\Component\Kernel\CacheClearer\CacheClearerInterface')->getMock();
    }
}
