...
namespace Symfony\Component\Kernel\Tests;
...
use Symfony\Component\Kernel\DependencyInjection\ResettableServicePass;
use Symfony\Component\Kernel\DependencyInjection\ServicesResetter;
use Symfony\Component\Kernel\Kernel;
use Symfony\Component\Kernel\Tests\Fixtures\KernelForOverrideName;
use Symfony\Component\Kernel\Tests\Fixtures\KernelForTest;
use Symfony\Component\Kernel\Tests\Fixtures\KernelWithoutBundles;
use Symfony\Component\Kernel\Tests\Fixtures\ResettableService;
...
class KernelTest extends TestCase
{
    ...
    {
        $bundle = $this->getMockBuilder('Symfony\Component\Kernel\Bundle\Bundle')->getMock();
...
EOF;
    ...
    public function testKernelRootDirNameStartingWithANumber()
    {
        ...
        $kernel = new \Symfony\Component\Kernel\Tests\Fixtures\_123\Kernel123('dev', true);
    ...
    {
        $bundle = $this
            ->getMockBuilder('Symfony\Component\Kernel\Bundle\BundleInterface')
    ...
    protected function getKernel(array $methods = array(), array $bundles = array())
    {
        ...
        $kernel = $this
            ->getMockBuilder('Symfony\Component\Kernel\Kernel')
            ->setMethods($methods)
    ...
    {
        $kernel = $this->getMockBuilder('Symfony\Component\Kernel\Tests\Fixtures\KernelForTest')
