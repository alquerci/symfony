 ...
 * @api
 */
class Symfony_Component_HttpFoundation_Response
{
    /**
     * @var Symfony_Component_HttpFoundation_ResponseHeaderBag
     */
    public $headers;
    ...
    {
        $this->headers = new Symfony_Component_HttpFoundation_ResponseHeaderBag($headers);
     ...
     *
     * @return Symfony_Component_HttpFoundation_Response The current response.
     */
    ...
    public function sendHeaders()
    {
        ...
        foreach ($this->headers->getCookies() as $cookie) {
            if (version_compare(phpversion(), '5.2.0', '>=')) {
                ...
                setcookie($cookie->getName(), $cookie->getValue(), $cookie->getExpiresTime(), $cookie->getPath(), $cookie->getDomain(), $cookie->isSecure());
            }
        }
