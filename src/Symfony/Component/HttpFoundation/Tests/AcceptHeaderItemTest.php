...
class Symfony_Component_HttpFoundation_Tests_AcceptHeaderItemTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $item = Symfony_Component_HttpFoundation_AcceptHeaderItem::fromString($string);
    ...
    {
        $item = new Symfony_Component_HttpFoundation_AcceptHeaderItem($value, $attributes);
        $this->assertEquals($string, (string) $item->__toString());
    }
    ...
    {
        $item = new Symfony_Component_HttpFoundation_AcceptHeaderItem('value', array());
        $this->assertEquals('value', $item->getValue());
