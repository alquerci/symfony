 ...
 */
class Symfony_Component_HttpFoundation_Tests_Session_SessionTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->session = new Symfony_Component_HttpFoundation_Session_Session($this->storage, new Symfony_Component_HttpFoundation_Session_Attribute_AttributeBag(), new Symfony_Component_HttpFoundation_Session_Flash_FlashBag());
    }
    ...
    {
        $this->assertInstanceOf('Symfony_Component_HttpFoundation_Session_Flash_FlashBagInterface', $this->session->getFlashBag());
    }
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Session_Session::getIterator
     */
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Session_Session::count
     */
    ...
    {
        $this->assertInstanceOf('Symfony_Component_HttpFoundation_Session_Storage_MetadataBag', $this->session->getMetadataBag());
    }
}
