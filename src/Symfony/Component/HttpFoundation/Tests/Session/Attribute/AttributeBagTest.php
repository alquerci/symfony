...
/**
 * Tests Symfony_Component_HttpFoundation_Session_Attribute_AttributeBag
 *
 * @author Drak <drak@zikula.org>
 */
class Symfony_Component_HttpFoundation_Tests_Session_Attribute_AttributeBagTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var array
     */
    ...
    protected function setUp()
    {
        ...
        $this->bag = new Symfony_Component_HttpFoundation_Session_Attribute_AttributeBag('_sf2');
    ...
    {
        $bag = new Symfony_Component_HttpFoundation_Session_Attribute_AttributeBag();
    ...
    public function testGetStorageKey()
    {
        ...
        $attributeBag = new Symfony_Component_HttpFoundation_Session_Attribute_AttributeBag('test');
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Session_Attribute_AttributeBag::getIterator
     */
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Session_Attribute_AttributeBag::count
     */
