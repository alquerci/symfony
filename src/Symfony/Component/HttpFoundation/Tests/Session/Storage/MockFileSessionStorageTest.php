...
/**
 * Test class for Symfony_Component_HttpFoundation_Session_Storage_MockFileSessionStorage.
 *
 * @author Drak <drak@zikula.org>
 */
class Symfony_Component_HttpFoundation_Tests_Session_Storage_MockFileSessionStorageTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var string
     */
    ...
    {
        $storage = new Symfony_Component_HttpFoundation_Session_Storage_MockFileSessionStorage($this->sessionDir);
        $storage->registerBag(new Symfony_Component_HttpFoundation_Session_Flash_FlashBag());
