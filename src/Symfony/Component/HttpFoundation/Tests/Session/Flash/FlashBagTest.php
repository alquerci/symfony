 ...
 */
class Symfony_Component_HttpFoundation_Tests_Session_Flash_FlashBagTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Symfony_Component_HttpFoundation_SessionFlash_FlashBagInterface
     */
    private $bag;
    ...
    {
        parent::setUp();
        $this->bag = new Symfony_Component_HttpFoundation_Session_Flash_FlashBag();
    ...
    public function testGetStorageKey()
    {
        ...
        $attributeBag = new Symfony_Component_HttpFoundation_Session_Flash_FlashBag('test');
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Session_Flash_FlashBag::count
     */
    public function testCount()
    {
        version_compare(PHP_VERSION, '5.3.0', '>=') && $this->setExpectedException('PHPUnit_Framework_Error_Deprecated');
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Session_Flash_FlashBag::getIterator
     */
