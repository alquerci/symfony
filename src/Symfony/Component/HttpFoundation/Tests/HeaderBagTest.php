...
class Symfony_Component_HttpFoundation_Tests_HeaderBagTest extends PHPUnit_Framework_TestCase
{
    /**
     * @covers Symfony_Component_HttpFoundation_HeaderBag::__construct
     */
    public function testConstructor()
    {
        $bag = new Symfony_Component_HttpFoundation_HeaderBag(array('foo' => 'bar'));
        $this->assertTrue($bag->has('foo'));
    }

    public function testToStringNull()
    {
        $bag = new Symfony_Component_HttpFoundation_HeaderBag();
    ...
    {
        $bag = new Symfony_Component_HttpFoundation_HeaderBag(array('foo' => 'Tue, 4 Sep 2012 20:00:00 +0200'));
    ...
    {
        $bag = new Symfony_Component_HttpFoundation_HeaderBag(array('foo' => 'Tue'));
        $headerDate = $bag->getDate('foo');
    }
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_HeaderBag::all
     */
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_HeaderBag::replace
     */
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_HeaderBag::get
     */
    public function testGet()
    {
        $bag = new Symfony_Component_HttpFoundation_HeaderBag(array('foo' => 'bar', 'fuzz' => 'bizz'));
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_HeaderBag::contains
     */
    ...
    {
        $bag = new Symfony_Component_HttpFoundation_HeaderBag(array('cache-control' => 'public, max-age=10'));
        $this->assertTrue($bag->hasCacheControlDirective('public'));
        $this->assertTrue($bag->getCacheControlDirective('public'));
    ...
    {
        $bag = new Symfony_Component_HttpFoundation_HeaderBag(array('cache-control' => 'max-age="0"'));
        $this->assertTrue($bag->hasCacheControlDirective('max-age'));
    ...
    {
        $bag = new Symfony_Component_HttpFoundation_HeaderBag(array('cache-control' => 'private, max-age=100'));
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_HeaderBag::getIterator
     */
    public function testGetIterator()
    {
        $headers   = array('foo' => 'bar', 'hello' => 'world', 'third' => 'charm');
        $headerBag = new Symfony_Component_HttpFoundation_HeaderBag($headers);
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_HeaderBag::count
     */
