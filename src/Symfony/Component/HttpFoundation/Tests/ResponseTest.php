...
class Symfony_Component_HttpFoundation_Tests_ResponseTest extends PHPUnit_Framework_TestCase
{
    public function testCreate()
    {
        $response = Symfony_Component_HttpFoundation_Response::create('foo', 301, array('Foo' => 'bar'));
    ...
    {
        $response = new Symfony_Component_HttpFoundation_Response();
        $modified = $response->isNotModified(new Symfony_Component_HttpFoundation_Request());
    ...
    {
        $headerMock = $this->getMock('Symfony_Component_HttpFoundation_ResponseHeaderBag', array('set'));
        ...
        $response->prepare(new Symfony_Component_HttpFoundation_Request());
    }
    ...
    {
        $request = Symfony_Component_HttpFoundation_Request::create('/', 'GET');
    ...
    {
        $response = new Symfony_Component_HttpFoundation_Response('test response rendering', 200);
    ...
    public function testSetStatusCode($code, $text, $expectedText)
    {
        ...
        $this->assertEquals($expectedText, $this->readAttribute($response, 'statusText'));
    }
    ...
    {
        $response = new Symfony_Component_HttpFoundation_Response('', 100);
    ...
    public function testIsRedirectRedirection()
    {
        foreach (array(301, 302, 303, 307) as $code) {
            $response = new Symfony_Component_HttpFoundation_Response('', $code);
            $this->assertTrue($response->isRedirection());
            $this->assertTrue($response->isRedirect());
        }

        $response = new Symfony_Component_HttpFoundation_Response('', 304);
        $this->assertTrue($response->isRedirection());
        ...
        $response = new Symfony_Component_HttpFoundation_Response('', 404);
        $this->assertFalse($response->isRedirection());
        $this->assertFalse($response->isRedirect());

        $response = new Symfony_Component_HttpFoundation_Response('', 301, array('Location' => '/good-uri'));
    ...
    {
        $response = new Symfony_Component_HttpFoundation_Response('', 403);
    ...
    public function testIsServerOrClientError()
    {
        ...
        $response = new Symfony_Component_HttpFoundation_Response('', 500);
    ...
    protected function createDateTimeOneHourAgo()
    {
        ...
        return new DateTime('@'.($date->getTimestamp() - 3600));
    }
