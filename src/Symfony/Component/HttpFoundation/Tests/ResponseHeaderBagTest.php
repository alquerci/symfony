...
class Symfony_Component_HttpFoundation_Tests_ResponseHeaderBagTest extends PHPUnit_Framework_TestCase
{
    /**
     * @covers Symfony_Component_HttpFoundation_ResponseHeaderBag::allPreserveCase
     * @dataProvider provideAllPreserveCase
     */
    public function testAllPreserveCase($headers, $expected)
    {
        $bag = new Symfony_Component_HttpFoundation_ResponseHeaderBag($headers);
    ...
    {
        $bag = new Symfony_Component_HttpFoundation_ResponseHeaderBag(array());
        $this->assertEquals('no-cache', $bag->get('Cache-Control'));
        $this->assertTrue($bag->hasCacheControlDirective('no-cache'));

        $bag = new Symfony_Component_HttpFoundation_ResponseHeaderBag(array('Cache-Control' => 'public'));
        $this->assertEquals('public', $bag->get('Cache-Control'));
        $this->assertTrue($bag->hasCacheControlDirective('public'));

        $bag = new Symfony_Component_HttpFoundation_ResponseHeaderBag(array('ETag' => 'abcde'));
        $this->assertEquals('private, must-revalidate', $bag->get('Cache-Control'));
        $this->assertTrue($bag->hasCacheControlDirective('private'));
        $this->assertTrue($bag->hasCacheControlDirective('must-revalidate'));
        $this->assertFalse($bag->hasCacheControlDirective('max-age'));

        $bag = new Symfony_Component_HttpFoundation_ResponseHeaderBag(array('Expires' => 'Wed, 16 Feb 2011 14:17:43 GMT'));
        $this->assertEquals('private, must-revalidate', $bag->get('Cache-Control'));
        ...
        $bag = new Symfony_Component_HttpFoundation_ResponseHeaderBag(array('Last-Modified' => 'abcde'));
        $this->assertEquals('private, must-revalidate', $bag->get('Cache-Control'));

        $bag = new Symfony_Component_HttpFoundation_ResponseHeaderBag(array('Etag' => 'abcde', 'Last-Modified' => 'abcde'));
        $this->assertEquals('private, must-revalidate', $bag->get('Cache-Control'));

        $bag = new Symfony_Component_HttpFoundation_ResponseHeaderBag(array('cache-control' => 'max-age=100'));
        $this->assertEquals('max-age=100, private', $bag->get('Cache-Control'));

        $bag = new Symfony_Component_HttpFoundation_ResponseHeaderBag(array('cache-control' => 's-maxage=100'));
        $this->assertEquals('s-maxage=100', $bag->get('Cache-Control'));

        $bag = new Symfony_Component_HttpFoundation_ResponseHeaderBag(array('cache-control' => 'private, max-age=100'));
        $this->assertEquals('max-age=100, private', $bag->get('Cache-Control'));

        $bag = new Symfony_Component_HttpFoundation_ResponseHeaderBag(array('cache-control' => 'public, max-age=100'));
        $this->assertEquals('max-age=100, public', $bag->get('Cache-Control'));

        $bag = new Symfony_Component_HttpFoundation_ResponseHeaderBag();
    ...
    {
        $bag = new Symfony_Component_HttpFoundation_ResponseHeaderBag(array());
        $bag->setCookie(new Symfony_Component_HttpFoundation_Cookie('foo', 'bar'));
    ...
    {
        $bag = new Symfony_Component_HttpFoundation_ResponseHeaderBag();
        $bag->setCookie(new Symfony_Component_HttpFoundation_Cookie('foo', 'bar', 0, '/path/foo', 'foo.bar'));
        $bag->setCookie(new Symfony_Component_HttpFoundation_Cookie('foo', 'bar', 0, '/path/bar', 'foo.bar'));
        $bag->setCookie(new Symfony_Component_HttpFoundation_Cookie('foo', 'bar', 0, '/path/bar', 'bar.foo'));
        $bag->setCookie(new Symfony_Component_HttpFoundation_Cookie('foo', 'bar'));
        ...
        $cookies = $bag->getCookies(Symfony_Component_HttpFoundation_ResponseHeaderBag::COOKIES_ARRAY);
    ...
    public function testRemoveCookie()
    {
        $bag = new Symfony_Component_HttpFoundation_ResponseHeaderBag();
        $bag->setCookie(new Symfony_Component_HttpFoundation_Cookie('foo', 'bar', 0, '/path/foo', 'foo.bar'));
        $bag->setCookie(new Symfony_Component_HttpFoundation_Cookie('bar', 'foo', 0, '/path/bar', 'foo.bar'));
    ...
    {
        $bag = new Symfony_Component_HttpFoundation_ResponseHeaderBag();
        $bag->setCookie(new Symfony_Component_HttpFoundation_Cookie('foo', 'bar', 0));
        $bag->setCookie(new Symfony_Component_HttpFoundation_Cookie('bar', 'foo', 0));
    ...
    {
        $headers = new Symfony_Component_HttpFoundation_ResponseHeaderBag();
