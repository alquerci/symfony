...
class Symfony_Component_HttpFoundation_Tests_RequestTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Request::__construct
     */
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Request::initialize
     */
    ...
    {
        $request = Symfony_Component_HttpFoundation_Request::create('http://user_test:password_test@test.com/');
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Request::create
     */
    public function testCreate()
    {
        $request = Symfony_Component_HttpFoundation_Request::create('http://test.com/foo?bar=baz');
        ...
        $request = Symfony_Component_HttpFoundation_Request::create('http://test.com/foo', 'GET', array('bar' => 'baz'));
        $this->assertEquals('http://test.com/foo?bar=baz', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('bar=baz', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        ...
        $request = Symfony_Component_HttpFoundation_Request::create('http://test.com/foo?bar=foo', 'GET', array('bar' => 'baz'));
        $this->assertEquals('http://test.com/foo?bar=baz', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('bar=baz', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        ...
        $request = Symfony_Component_HttpFoundation_Request::create('https://test.com/foo?bar=baz');
        ...
        $request = Symfony_Component_HttpFoundation_Request::create('test.com:90/foo');
        ...
        $request = Symfony_Component_HttpFoundation_Request::create('https://test.com:90/foo');
        ...
        $request = Symfony_Component_HttpFoundation_Request::create('https://127.0.0.1:90/foo');
        ...
        $request = Symfony_Component_HttpFoundation_Request::create('https://[::1]:90/foo');
        ...
        $request = Symfony_Component_HttpFoundation_Request::create('http://example.com/jsonrpc', 'POST', array(), array(), array(), array(), $json);
        $this->assertEquals($json, $request->getContent());
        $this->assertFalse($request->isSecure());

        $request = Symfony_Component_HttpFoundation_Request::create('http://test.com');
        ...
        $request = Symfony_Component_HttpFoundation_Request::create('http://test.com?test=1');
        ...
        $request = Symfony_Component_HttpFoundation_Request::create('http://test.com:90/?test=1');
        ...
        $request = Symfony_Component_HttpFoundation_Request::create('http://test:test@test.com');
        $this->assertEquals('http://test.com/', $request->getUri());
        $this->assertEquals('/', $request->getPathInfo());
        $this->assertEquals('', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        ...
        $request = Symfony_Component_HttpFoundation_Request::create('http://testnopass@test.com');
        $this->assertEquals('http://test.com/', $request->getUri());
        $this->assertEquals('/', $request->getPathInfo());
        $this->assertEquals('', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
    ...
    public function testCreateCheckPrecedence()
    {
        ...
        $request = Symfony_Component_HttpFoundation_Request::create('/', 'DELETE', array(), array(), array(), array(
        ...
        $request = Symfony_Component_HttpFoundation_Request::create('http://thomas:pokemon@example.net:8080/?foo=bar', 'GET', array(), array(), array(), array(
            'HTTP_HOST'   => 'example.com',
            'HTTPS'       => 'on',
            'SERVER_PORT' => 443,
        ));
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Request::duplicate
     */
    public function testDuplicate()
    {
        $request = new Symfony_Component_HttpFoundation_Request(array('foo' => 'bar'), array('foo' => 'bar'), array('foo' => 'bar'), array(), array(), array('HTTP_FOO' => 'bar'));
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Request::getFormat
     * @covers Symfony_Component_HttpFoundation_Request::setFormat
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Request::getMimeType
     * @dataProvider getFormatToMimeTypeMapProvider
     */
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Request::getUri
     */
    public function testGetUri()
    {
        $server = array();

        // Standard Symfony_Component_HttpFoundation_Request on non default PORT
        ...
        // Symfony_Component_HttpFoundation_Request with URL REWRITING (hide index.php)
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Request::getUriForPath
     */
    public function testGetUriForPath()
    {
        ...
        $request = Symfony_Component_HttpFoundation_Request::create('http://test.com:90/foo?bar=baz');
        ...
        $request = Symfony_Component_HttpFoundation_Request::create('https://test.com:90/foo?bar=baz');
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Request::getUserInfo
     */
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Request::getSchemeAndHttpHost
     */
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Request::getQueryString
     * @covers Symfony_Component_HttpFoundation_Request::normalizeQueryString
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_Request::setMethod
     * @covers Symfony_Component_HttpFoundation_Request::getMethod
     */
    public function testGetSetMethod()
    {
        ...
        $this->assertFalse(Symfony_Component_HttpFoundation_Request::getHttpMethodParameterOverride(), 'httpMethodParameterOverride should be disabled by default');

        Symfony_Component_HttpFoundation_Request::enableHttpMethodParameterOverride();

        $this->assertTrue(Symfony_Component_HttpFoundation_Request::getHttpMethodParameterOverride(), 'httpMethodParameterOverride should be enabled now but it is not');
    ...
    public function testGetClientIp($expected, $proxy, $remoteAddr, $httpForwardedFor, $trustedProxies)
    {
        ...
        if ($proxy || $trustedProxies) {
            Symfony_Component_HttpFoundation_Request::setTrustedProxies(null === $trustedProxies ? array($remoteAddr) : $trustedProxies);
        }
        ...
        Symfony_Component_HttpFoundation_Request::setTrustedProxies(array());
    }
    ...
    {
        $req = new Symfony_Component_HttpFoundation_Request;
    ...
    public function testCreateFromGlobals($method)
    {
        ...
        $request = Symfony_Component_HttpFoundation_Request::createFromGlobals();
        ...
        $request = Symfony_Component_HttpFoundation_Tests_RequestContentProxy::createFromGlobals();
        $this->assertEquals($normalizedMethod, $request->getMethod());
        $this->assertEquals('mycontent', $request->request->get('content'));

        unset($_SERVER['REQUEST_METHOD'], $_SERVER['CONTENT_TYPE']);

        Symfony_Component_HttpFoundation_Request::createFromGlobals();
        Symfony_Component_HttpFoundation_Request::enableHttpMethodParameterOverride();
    ...
    public function testOverrideGlobals()
    {
        ...
        // as the Symfony_Component_HttpFoundation_Request::overrideGlobals really work, it erase $_SERVER, so we must backup it
        $server = $_SERVER;
        ...
        Symfony_Component_HttpFoundation_Request::setTrustedProxies(array('1.1.1.1'));
        $this->assertTrue($request->isSecure());
        Symfony_Component_HttpFoundation_Request::setTrustedProxies(array());
    ...
    public function testHasSession()
    {
        ...
        $request->setSession(new Symfony_Component_HttpFoundation_Session_Session(new Symfony_Component_HttpFoundation_Session_Storage_MockArraySessionStorage()));
    ...
    {
        Symfony_Component_HttpFoundation_Request::trustProxyData();
    }
    ...
    {
        $request = Symfony_Component_HttpFoundation_Request::create($uri, 'GET', array(), array(), array(), $server);
    ...
    {
        Symfony_Component_HttpFoundation_Tests_RequestContentProxy::stopTrustingProxyData();
    }

    private function disableHttpMethodParameterOverride()
    {
        Symfony_Component_HttpFoundation_Tests_RequestContentProxy::disableHttpMethodParameterOverride();
    }

    public function testTrustedProxies()
    {
        $request = Symfony_Component_HttpFoundation_Request::create('http://example.com/');
        ...
        Symfony_Component_HttpFoundation_Request::setTrustedProxies(array('3.3.3.3', '2.2.2.2'));
        ...
        // custom header names
        Symfony_Component_HttpFoundation_Request::setTrustedHeaderName(Symfony_Component_HttpFoundation_Request::HEADER_CLIENT_IP, 'X_MY_FOR');
        Symfony_Component_HttpFoundation_Request::setTrustedHeaderName(Symfony_Component_HttpFoundation_Request::HEADER_CLIENT_HOST, 'X_MY_HOST');
        Symfony_Component_HttpFoundation_Request::setTrustedHeaderName(Symfony_Component_HttpFoundation_Request::HEADER_CLIENT_PORT, 'X_MY_PORT');
        Symfony_Component_HttpFoundation_Request::setTrustedHeaderName(Symfony_Component_HttpFoundation_Request::HEADER_CLIENT_PROTO, 'X_MY_PROTO');
        ...
        Symfony_Component_HttpFoundation_Request::setTrustedHeaderName(Symfony_Component_HttpFoundation_Request::HEADER_CLIENT_IP, null);
        Symfony_Component_HttpFoundation_Request::setTrustedHeaderName(Symfony_Component_HttpFoundation_Request::HEADER_CLIENT_HOST, null);
        Symfony_Component_HttpFoundation_Request::setTrustedHeaderName(Symfony_Component_HttpFoundation_Request::HEADER_CLIENT_PORT, null);
        Symfony_Component_HttpFoundation_Request::setTrustedHeaderName(Symfony_Component_HttpFoundation_Request::HEADER_CLIENT_PROTO, null);
        $this->assertEquals('3.3.3.3', $request->getClientIp());
        $this->assertEquals('example.com', $request->getHost());
        $this->assertEquals(80, $request->getPort());
        $this->assertFalse($request->isSecure());
...
class Symfony_Component_HttpFoundation_Tests_RequestContentProxy extends Symfony_Component_HttpFoundation_Request
{
    public static function createFromGlobals($class = null)
    {
        return parent::createFromGlobals(__CLASS__);
    }

    public static function stopTrustingProxyData()
    {
        self::$trustProxy = false;
    }

    public static function disableHttpMethodParameterOverride()
    {
