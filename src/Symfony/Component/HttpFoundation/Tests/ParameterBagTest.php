...
class Symfony_Component_HttpFoundation_Tests_ParameterBagTest extends PHPUnit_Framework_TestCase
{
    /**
     * @covers Symfony_Component_HttpFoundation_ParameterBag::__construct
     */
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_ParameterBag::all
     */
    public function testAll()
    {
        $bag = new Symfony_Component_HttpFoundation_ParameterBag(array('foo' => 'bar'));
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_ParameterBag::replace
     */
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_ParameterBag::get
     */
    public function testGet()
    {
        $bag = new Symfony_Component_HttpFoundation_ParameterBag(array('foo' => 'bar', 'null' => null));
    ...
    {
        $bag = new Symfony_Component_HttpFoundation_ParameterBag(array('foo' => array('bar' => 'moo')));
    ...
    {
        $bag = new Symfony_Component_HttpFoundation_ParameterBag(array('foo' => array('bar' => array('moo' => 'boo'))));
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_ParameterBag::set
     */
    public function testSet()
    {
        $bag = new Symfony_Component_HttpFoundation_ParameterBag(array());
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_ParameterBag::has
     */
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_ParameterBag::getAlpha
     */
    public function testGetAlpha()
    {
        $bag = new Symfony_Component_HttpFoundation_ParameterBag(array('word' => 'foo_BAR_012'));
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_ParameterBag::getAlnum
     */
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_ParameterBag::getDigits
     */
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_ParameterBag::getInt
     */
    public function testGetInt()
    {
        $bag = new Symfony_Component_HttpFoundation_ParameterBag(array('digits' => '0123'));
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_ParameterBag::filter
     */
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_ParameterBag::getIterator
     */
    public function testGetIterator()
    {
        $parameters = array('foo' => 'bar', 'hello' => 'world');
        $bag = new Symfony_Component_HttpFoundation_ParameterBag($parameters);
    ...
    /**
     * @covers Symfony_Component_HttpFoundation_ParameterBag::count
     */
