 ...
 */
class Symfony_Component_HttpFoundation_Session_Storage_NativeSessionStorage implements Symfony_Component_HttpFoundation_Session_Storage_SessionStorageInterface
{
    /**
     * Array of SessionBagInterface
     *
     * @var Symfony_Component_HttpFoundation_Session_SessionBagInterface[]
     */
    protected $bags;
     ...
     * @param Symfony_Component_HttpFoundation_Session_Storage_MetadataBag $metaBag MetadataBag.
     */
    public function __construct(array $options = array(), $handler = null, Symfony_Component_HttpFoundation_Session_Storage_MetadataBag $metaBag = null)
    {
     ...
     *
     * @return Symfony_Component_HttpFoundation_Session_Storage_Proxy_AbstractProxy
     */
     ...
     *
     * @param Symfony_Component_HttpFoundation_Session_Storage_MetadataBag $metaBag
     */
    public function setMetadataBag(Symfony_Component_HttpFoundation_Session_Storage_MetadataBag $metaBag = null)
    {
        if (null === $metaBag) {
            $metaBag = new Symfony_Component_HttpFoundation_Session_Storage_MetadataBag();
        }
     ...
     *
     * @return Symfony_Component_HttpFoundation_Session_Storage_MetadataBag
     */
