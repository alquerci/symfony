 ...
 * @api
 */
class Symfony_Component_HttpFoundation_RequestMatcher implements Symfony_Component_HttpFoundation_RequestMatcherInterface
{
    /**
     * @var string
     */
    ...
    public function matches(Symfony_Component_HttpFoundation_Request $request)
    {
        ...
        if (null !== $this->ip && !Symfony_Component_HttpFoundation_IpUtils::checkIp($request->getClientIp(), $this->ip)) {
            return false;
        }
