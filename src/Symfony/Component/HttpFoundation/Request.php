...
class Symfony_Component_HttpFoundation_Request
{
    ...
    public function initialize(array $query = array(), array $request = array(), array $attributes = array(), array $cookies = array(), array $files = array(), array $server = array(), $content = null)
    {
        ...
        $this->attributes = new Symfony_Component_HttpFoundation_ParameterBag($attributes);
        $this->cookies = new Symfony_Component_HttpFoundation_ParameterBag($cookies);
        $this->files = new Symfony_Component_HttpFoundation_FileBag($files);
        $this->server = new Symfony_Component_HttpFoundation_ServerBag($server);
        $this->headers = new Symfony_Component_HttpFoundation_HeaderBag($this->server->getHeaders());
    ...
    public static function createFromGlobals($class = null)
    {
        ...
        if (0 === strpos($request->headers->get('CONTENT_TYPE'), 'application/x-www-form-urlencoded')
            ...
            $request->request = new Symfony_Component_HttpFoundation_ParameterBag($data);
        }
    ...
    public function duplicate(array $query = null, array $request = null, array $attributes = null, array $cookies = null, array $files = null, array $server = null)
    {
        ...
        if ($request !== null) {
            $dup->request = new Symfony_Component_HttpFoundation_ParameterBag($request);
        }
        if ($attributes !== null) {
            $dup->attributes = new Symfony_Component_HttpFoundation_ParameterBag($attributes);
        }
        if ($cookies !== null) {
            $dup->cookies = new Symfony_Component_HttpFoundation_ParameterBag($cookies);
        }
        if ($files !== null) {
            $dup->files = new Symfony_Component_HttpFoundation_FileBag($files);
        }
        if ($server !== null) {
            $dup->server = new Symfony_Component_HttpFoundation_ServerBag($server);
            $dup->headers = new Symfony_Component_HttpFoundation_HeaderBag($dup->server->getHeaders());
        }
        $dup->languages = null;
        $dup->charsets = null;
