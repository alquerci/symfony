 ...
 * @api
 */
class Symfony_Component_HttpFoundation_ResponseHeaderBag extends Symfony_Component_HttpFoundation_HeaderBag
{
    ...
    {
        $this->setCookie(new Symfony_Component_HttpFoundation_Cookie($name, null, 1, $path, $domain));
    }
