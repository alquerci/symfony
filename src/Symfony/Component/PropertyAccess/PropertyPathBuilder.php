 ...
 */
class Symfony_Component_PropertyAccess_PropertyPathBuilder
{
    /**
     * @var array
     */
     ...
     *
     * @param null|Symfony_Component_PropertyAccess_PropertyPathInterface $path The path to initially store
     *                                         in the builder. Optional.
     */
    public function __construct(Symfony_Component_PropertyAccess_PropertyPathInterface $path = null)
    {
        if (null !== $path) {
            $this->append($path);
        }
     ...
     *
     * @param Symfony_Component_PropertyAccess_PropertyPathInterface $path   The path to append
     ...
     */
    public function append(Symfony_Component_PropertyAccess_PropertyPathInterface $path, $offset = 0, $length = 0)
    {
        if (0 === $length) {
            $end = $path->getLength();
        } else {
     ...
     *
     * @throws Symfony_Component_PropertyAccess_Exception_OutOfBoundsException if offset is invalid
     */
    public function remove($offset, $length = 1)
    {
        if (!isset($this->elements[$offset])) {
            throw new Symfony_Component_PropertyAccess_Exception_OutOfBoundsException('The offset ' . $offset . ' is not within the property path');
        }
     ...
     * @param Symfony_Component_PropertyAccess_PropertyPathInterface $path       The path to insert
     ...
     *
     * @throws Symfony_Component_PropertyAccess_Exception_OutOfBoundsException If the offset is invalid
     */
    public function replace($offset, $length, Symfony_Component_PropertyAccess_PropertyPathInterface $path, $pathOffset = 0, $pathLength = 0)
    {
        if (!isset($this->elements[$offset])) {
            throw new Symfony_Component_PropertyAccess_Exception_OutOfBoundsException('The offset ' . $offset . ' is not within the property path');
        }
     ...
     *
     * @return Symfony_Component_PropertyAccess_PropertyPathInterface The constructed property path
     */
    public function getPropertyPath()
    {
        $pathAsString = $this->__toString();

        return '' !== $pathAsString ? new Symfony_Component_PropertyAccess_PropertyPath($pathAsString) : null;
    }
