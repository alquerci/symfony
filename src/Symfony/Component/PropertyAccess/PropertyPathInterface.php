 ...
 */
interface Symfony_Component_PropertyAccess_PropertyPathInterface extends Traversable
{
    /**
     ...
     *
     * @return Symfony_Component_PropertyAccess_PropertyPath The parent path or null
     */
