...
class Symfony_Component_PropertyAccess_Tests_StringUtilTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals($singular, Symfony_Component_PropertyAccess_StringUtil::singularify($plural));
    }
}
