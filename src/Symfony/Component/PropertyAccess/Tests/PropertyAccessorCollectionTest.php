...
class Symfony_Component_PropertyAccess_Tests_PropertyAccessorCollectionTest_Car
{
    private $axes;
...
class Symfony_Component_PropertyAccess_Tests_PropertyAccessorCollectionTest_CarCustomSingular
{
...
class Symfony_Component_PropertyAccess_Tests_PropertyAccessorCollectionTest_Engine
{
}

class Symfony_Component_PropertyAccess_Tests_PropertyAccessorCollectionTest_CarOnlyAdder
{
    public function addAxis($axis) {}
...
class Symfony_Component_PropertyAccess_Tests_PropertyAccessorCollectionTest_CarOnlyRemover
{
    public function removeAxis($axis) {}
...
class Symfony_Component_PropertyAccess_Tests_PropertyAccessorCollectionTest_CarNoAdderAndRemover
{
    public function getAxes() {}
}

class Symfony_Component_PropertyAccess_Tests_PropertyAccessorCollectionTest_CarNoAdderAndRemoverWithProperty
{
...
class Symfony_Component_PropertyAccess_Tests_PropertyAccessorCollectionTest_CompositeCar
{
...
class Symfony_Component_PropertyAccess_Tests_PropertyAccessorCollectionTest_CarStructure
{
    public function addAxis($axis) {}
...
abstract class Symfony_Component_PropertyAccess_Tests_PropertyAccessorCollectionTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testSetValueCallsAdderAndRemoverForCollections()
    {
        ...
        $car = new Symfony_Component_PropertyAccess_Tests_PropertyAccessorCollectionTest_Car($axesBefore);
    ...
    public function testNoAdderAndRemoverThrowsSensibleError($car, $path, $message)
    {
        ...
        } catch (Symfony_Component_PropertyAccess_Exception_ExceptionInterface $e) {
...
//                .'property path with "|{singular}" to override the guesser)'
                ,
            get_class($car),
            implode(', ', (array) $singulars = Symfony_Component_PropertyAccess_StringUtil::singularify('Axes'))
        );
