...
class Symfony_Component_DomCrawler_Tests_Field_FileFormFieldTest extends Symfony_Component_DomCrawler_Tests_Field_FormFieldTestCase
{
    public function testInitialize()
    {
        $node = $this->createNode('input', '', array('type' => 'file'));
        $field = new Symfony_Component_DomCrawler_Field_FileFormField($node);
    ...
    public function testSetValue($method)
    {
        ...
        $this->assertThat($value['tmp_name'], $this->isType('string'), "->$method() sets the tmp_name of the file field");
        ...
        $field->$method(dirname(__FILE__).'/../Fixtures/no-extension');
        $value = $field->getValue();
