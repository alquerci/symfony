...
class Symfony_Component_DomCrawler_Tests_Field_ChoiceFormFieldTest extends Symfony_Component_DomCrawler_Tests_Field_FormFieldTestCase
{
    public function testInitialize()
    {
        $node = $this->createNode('textarea', '');
        try {
            $field = new Symfony_Component_DomCrawler_Field_ChoiceFormField($node);
