...
class Symfony_Component_DomCrawler_Tests_CrawlerTest extends PHPUnit_Framework_TestCase
{
    public function testConstructor()
    {
        $crawler = new Symfony_Component_DomCrawler_Crawler();
        $this->assertEquals(0, count($crawler), '__construct() returns an empty crawler');

        $crawler = new Symfony_Component_DomCrawler_Crawler(new DOMNode());
        $this->assertEquals(1, count($crawler), '__construct() takes a node as a first argument');
    }

    /**
     * @covers Symfony_Component_DomCrawler_Crawler::add
     */
    ...
    /**
     * @covers Symfony_Component_DomCrawler_Crawler::addHtmlContent
     */
    ...
    {
        $crawler = new Symfony_Component_DomCrawler_Crawler(null, 'http://symfony.com');
    ...
    {
        $crawler = new Symfony_Component_DomCrawler_Crawler();
        $crawler->addHtmlContent(file_get_contents(dirname(__FILE__).'/Fixtures/windows-1250.html'), 'Windows-1250');
...
EOF;
    ...
    /**
     * @covers Symfony_Component_DomCrawler_Crawler::addXmlContent
     */
...
EOF;
        $crawler->addXmlContent($content, 'UTF-8');
    ...
    /**
     * @covers Symfony_Component_DomCrawler_Crawler::addContent
     */
    ...
    /**
     * @covers Symfony_Component_DomCrawler_Crawler::addDocument
     */
    ...
    /**
     * @covers Symfony_Component_DomCrawler_Crawler::addNodeList
     */
    ...
    /**
     * @covers Symfony_Component_DomCrawler_Crawler::addNodes
     */
    ...
    /**
     * @covers Symfony_Component_DomCrawler_Crawler::addNode
     */
    ...
    public function testEq()
    {
        ...
        $this->assertThat($crawler, $this->isInstanceOf('Symfony_Component_DomCrawler_Crawler'), '->eq() returns a new instance of a crawler');
    ...
    {
        $data = $this->createTestCrawler()->filterXPath('//ul[1]/li')->each(create_function('$node, $i', '
    ...
    public function testReduce()
    {
        ...
        $nodes = $crawler->reduce(create_function('$node, $i', '
            return $i == 1 ? false : true;
        '));
        $this->assertNotSame($nodes, $crawler, '->reduce() returns a new instance of a crawler');
        $this->assertThat($nodes, $this->isInstanceOf('Symfony_Component_DomCrawler_Crawler'), '->reduce() returns a new instance of a crawler');
    ...
    /**
     * @covers Symfony_Component_DomCrawler_Crawler::filterXPath
     */
    public function testFilterXPath()
    {
        ...
        $this->assertThat($crawler, $this->isInstanceOf('Symfony_Component_DomCrawler_Crawler'), '->filterXPath() returns a new instance of a crawler');
    ...
    /**
     * @covers Symfony_Component_DomCrawler_Crawler::filter
     */
    public function testFilter()
    {
        ...
        $this->assertThat($crawler, $this->isInstanceOf('Symfony_Component_DomCrawler_Crawler'), '->filter() returns a new instance of a crawler');
    ...
    public function testSelectLink()
    {
        ...
        $this->assertThat($crawler, $this->isInstanceOf('Symfony_Component_DomCrawler_Crawler'), '->selectLink() returns a new instance of a crawler');
    ...
    public function testSelectButton()
    {
        ...
        $this->assertThat($crawler, $this->isInstanceOf('Symfony_Component_DomCrawler_Crawler'), '->selectButton() returns a new instance of a crawler');
    ...
    public function testLink()
    {
        ...
        $this->assertThat($crawler->link(), $this->isInstanceOf('Symfony_Component_DomCrawler_Link'), '->link() returns a Link instance');
    ...
    {
        $crawler = $this->createTestCrawler('http://example.com/bar/')->selectLink('Foo');
        $this->assertThat($crawler->links(), $this->isType('array'), '->links() returns an array');

        $this->assertEquals(4, count($crawler->links()), '->links() returns an array');
        $links = $crawler->links();
        $this->assertThat($links[0], $this->isInstanceOf('Symfony_Component_DomCrawler_Link'), '->links() returns an array of Link instances');
    ...
    public function testForm()
    {
        ...
        $this->assertThat($crawler->form(), $this->isInstanceOf('Symfony_Component_DomCrawler_Form'), '->form() returns a Form instance');
    ...
    public function testLast()
    {
        ...
        $this->assertThat($crawler, $this->isInstanceOf('Symfony_Component_DomCrawler_Crawler'), '->last() returns a new instance of a crawler');
    ...
    public function testFirst()
    {
        ...
        $this->assertThat($crawler, $this->isInstanceOf('Symfony_Component_DomCrawler_Crawler'), '->first() returns a new instance of a crawler');
    ...
    public function testSiblings()
    {
        ...
        $this->assertThat($crawler, $this->isInstanceOf('Symfony_Component_DomCrawler_Crawler'), '->siblings() returns a new instance of a crawler');
    ...
    public function testNextAll()
    {
        ...
        $this->assertThat($crawler, $this->isInstanceOf('Symfony_Component_DomCrawler_Crawler'), '->nextAll() returns a new instance of a crawler');
    ...
    public function testPreviousAll()
    {
        ...
        $this->assertThat($crawler, $this->isInstanceOf('Symfony_Component_DomCrawler_Crawler'), '->previousAll() returns a new instance of a crawler');
    ...
    public function testChildren()
    {
        ...
        $this->assertThat($crawler, $this->isInstanceOf('Symfony_Component_DomCrawler_Crawler'), '->children() returns a new instance of a crawler');
    ...
    public function testParents()
    {
        ...
        $this->assertThat($crawler,$this->isInstanceOf('Symfony_Component_DomCrawler_Crawler'), '->parents() returns a new instance of a crawler');
    ...
    public function createTestCrawler($uri = null)
    {
        ...
        return new Symfony_Component_DomCrawler_Crawler($dom, $uri);
    }
