 ...
 */
class Symfony_Component_DomCrawler_FormFieldRegistry
{
     ...
     */
    public function add(Symfony_Component_DomCrawler_Field_FormField $field)
    {
    ...
    public function set($name, $value)
    {
        ...
        if (!is_array($value) || $target instanceof Symfony_Component_DomCrawler_Field_ChoiceFormField) {
