 ...
 * @api
 */
class Symfony_Component_DomCrawler_Field_ChoiceFormField extends Symfony_Component_DomCrawler_Field_FormField
{
    /**
     * @var string
     */
    ...
    private function buildOptionValue($node)
    {
        ...
        // empty check on DOMNode::nodeValue is seems buggy before PHP 5.3.3
        $defaultValue = (isset($node->nodeValue) && '' != $node->nodeValue) ? $node->nodeValue : '1';
