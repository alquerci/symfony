...
class Symfony_Component_Security_Tests_Core_Encoder_Pbkdf2PasswordEncoderTest extends PHPUnit_Framework_TestCase
{
    public function testIsPasswordValid()
    {
        $encoder = new Symfony_Component_Security_Core_Encoder_Pbkdf2PasswordEncoder('sha256', false, 1, 40);
    ...
    public function testEncodePassword()
    {
        ...
        $encoder = new Symfony_Component_Security_Core_Encoder_Pbkdf2PasswordEncoder('sha256', true, 1, 40);
        $this->assertSame('wSMvEPYnFf2gaufAogN8oZszzxA7cnulbYcMEfKQoqsQaXTHVgfIow==', $encoder->encodePassword('password', ''));

        $encoder = new Symfony_Component_Security_Core_Encoder_Pbkdf2PasswordEncoder('sha256', false, 2, 40);
    ...
    {
        $encoder = new Symfony_Component_Security_Core_Encoder_Pbkdf2PasswordEncoder('foobar');
