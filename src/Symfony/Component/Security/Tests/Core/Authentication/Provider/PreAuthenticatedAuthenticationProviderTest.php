...
class Symfony_Component_Security_Tests_Core_Authentication_Provider_PreAuthenticatedAuthenticationProviderTest extends PHPUnit_Framework_TestCase
{
    public function testSupports()
    {
        ...
        $token = $this->getMockBuilder('Symfony_Component_Security_Core_Authentication_Token_PreAuthenticatedToken')
    ...
    public function testAuthenticate()
    {
        ...
        $this->assertInstanceOf('Symfony_Component_Security_Core_Authentication_Token_PreAuthenticatedToken', $token);
    ...
    public function testAuthenticateWhenUserCheckerThrowsException()
    {
        ...
        $userChecker->expects($this->once())
                    ...
                    ->will($this->throwException($this->getMock('Symfony_Component_Security_Core_Exception_LockedException', null, array(), '', false)))
        ;
    ...
    {
        $token = $this->getMock('Symfony_Component_Security_Core_Authentication_Token_PreAuthenticatedToken', array('getUser', 'getCredentials', 'getProviderKey'), array(), '', false);
        if (false !== $user) {
    ...
    protected function getProvider($user = false, $userChecker = false)
    {
        ...
        return new Symfony_Component_Security_Core_Authentication_Provider_PreAuthenticatedAuthenticationProvider($userProvider, $userChecker, 'key');
    }
}
