...
class Symfony_Component_Security_Tests_Http_Firewall_DigestDataTest extends PHPUnit_Framework_TestCase
{
    public function testGetResponse()
    {
        $digestAuth = new Symfony_Component_Security_Http_Firewall_DigestData(
    ...
    {
        class_exists('Symfony_Component_Security_Http_Firewall_DigestAuthenticationListener', true);
    }
    ...
    private function calculateServerDigest($username, $realm, $password, $key, $nc, $cnonce, $qop, $method, $uri)
    {
        ...
        $digestAuth = new Symfony_Component_Security_Http_Firewall_DigestData($digest);
