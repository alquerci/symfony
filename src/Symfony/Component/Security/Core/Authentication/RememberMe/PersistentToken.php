 ...
 */
final class Symfony_Component_Security_Core_Authentication_RememberMe_PersistentToken implements Symfony_Component_Security_Core_Authentication_RememberMe_PersistentTokenInterface
{
    private $class;
    private $username;
    private $series;
