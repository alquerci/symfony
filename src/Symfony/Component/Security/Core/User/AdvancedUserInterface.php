 ...
 *
 * @see UserInterface
 * @see Symfony_Component_Security_Core_Exception_AccountStatusException
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
interface Symfony_Component_Security_Core_User_AdvancedUserInterface extends Symfony_Component_Security_Core_User_UserInterface
{
    /**
     ...
     *
     * @see Symfony_Component_Security_Core_Exception_AccountExpiredException
     */
     ...
     *
     * @see Symfony_Component_Security_Core_Exception_LockedException
     */
     ...
     *
     * @see Symfony_Component_Security_Core_Exception_CredentialsExpiredException
     */
     ...
     *
     * @see Symfony_Component_Security_Core_Exception_DisabledException
     */
