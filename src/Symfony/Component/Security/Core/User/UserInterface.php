 ...
 *
 * @see Symfony_Component_Security_Core_User_UserProviderInterface
 * @see Symfony_Component_Security_Core_User_AdvancedUserInterface
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
interface Symfony_Component_Security_Core_User_UserInterface
{
    /**
