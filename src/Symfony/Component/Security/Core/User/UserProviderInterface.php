 ...
 *
 * @see Symfony_Component_Security_Core_User_UserInterface
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
interface Symfony_Component_Security_Core_User_UserProviderInterface
{
    /**
     ...
     *
     * @see Symfony_Component_Security_Core_Exception_UsernameNotFoundException
     *
     * @throws Symfony_Component_Security_Core_Exception_UsernameNotFoundException if the user is not found
     *
     */
     ...
     * @return Symfony_Component_Security_Core_User_UserInterface
     *
     * @throws Symfony_Component_Security_Core_Exception_UnsupportedUserException if the account is not supported
     */
