 ...
 */
abstract class Symfony_Component_Security_Core_Encoder_BasePasswordEncoder implements Symfony_Component_Security_Core_Encoder_PasswordEncoderInterface
{
    /**
    ...
    {
        return Symfony_Component_Security_Core_Util_StringUtils::equals($password1, $password2);
    }
}
