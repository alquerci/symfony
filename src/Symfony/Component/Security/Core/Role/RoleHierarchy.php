 ...
 */
class Symfony_Component_Security_Core_Role_RoleHierarchy implements Symfony_Component_Security_Core_Role_RoleHierarchyInterface
{
    private $hierarchy;
    private $map;
    ...
    public function getReachableRoles(array $roles)
    {
        ...
        foreach ($roles as $role) {
            ...
            foreach ($this->map[$role->getRole()] as $r) {
                $reachableRoles[] = new Symfony_Component_Security_Core_Role_Role($r);
            }
        }
