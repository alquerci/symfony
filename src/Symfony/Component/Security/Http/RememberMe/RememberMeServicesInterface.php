 ...
 */
interface Symfony_Component_Security_Http_RememberMe_RememberMeServicesInterface
{
    /**
     ...
     */
    public function autoLogin(Symfony_Component_HttpFoundation_Request $request);
     ...
     * @param Symfony_Component_HttpFoundation_Request $request
     */
    public function loginFail(Symfony_Component_HttpFoundation_Request $request);
     ...
     */
    public function loginSuccess(Symfony_Component_HttpFoundation_Request $request, Symfony_Component_HttpFoundation_Response $response, Symfony_Component_Security_Core_Authentication_Token_TokenInterface $token);
}
