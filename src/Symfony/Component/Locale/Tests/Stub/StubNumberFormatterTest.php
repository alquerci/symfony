 ...
 * behavior of PHP.
 */
class Symfony_Component_Locale_Tests_Stub_StubNumberFormatterTest extends Symfony_Component_Locale_Tests_TestCase
{
    /**
    ...
    {
        $formatter = new Symfony_Component_Locale_Stub_StubNumberFormatter('pt_BR');
    }
    ...
    {
        $formatter = new Symfony_Component_Locale_Stub_StubNumberFormatter('en', Symfony_Component_Locale_Stub_StubNumberFormatter::PATTERN_DECIMAL);
    }
    ...
    {
        $formatter = new Symfony_Component_Locale_Stub_StubNumberFormatter('en', Symfony_Component_Locale_Stub_StubNumberFormatter::DECIMAL, '');
    }
    ...
    public function testSetAttributeWithUnsupportedAttribute()
    {
        ...
        $formatter->setAttribute(Symfony_Component_Locale_Stub_StubNumberFormatter::LENIENT_PARSE, null);
    }
    ...
    {
        $formatter = $this->getStubFormatterWithDecimalStyle();
        $ret = $formatter->setAttribute(Symfony_Component_Locale_Stub_StubNumberFormatter::ROUNDING_MODE, null);
    }

    public function testCreateStub()
    {
        $this->assertInstanceOf(
            'Symfony_Component_Locale_Stub_StubNumberFormatter',
            Symfony_Component_Locale_Stub_StubNumberFormatter::create('en', Symfony_Component_Locale_Stub_StubNumberFormatter::DECIMAL)
        );
    }
    ...
    {
        $formatter = $this->getStubFormatterWithDecimalStyle();
        $formatter->format(1, Symfony_Component_Locale_Stub_StubNumberFormatter::TYPE_INT32);
    }
    ...
    {
        $formatter = $this->getStubFormatterWithDecimalStyle();
        $formatter->format(1, Symfony_Component_Locale_Stub_StubNumberFormatter::TYPE_INT64);
    }
    ...
    {
        $formatter = $this->getStubFormatterWithDecimalStyle();
        $formatter->format(1, Symfony_Component_Locale_Stub_StubNumberFormatter::TYPE_DOUBLE);
    }
    ...
    {
        $formatter = $this->getStubFormatterWithDecimalStyle();
        $formatter->format(1, Symfony_Component_Locale_Stub_StubNumberFormatter::TYPE_CURRENCY);
    }

    public function testFormatTypeCurrencyReturnStub()
    {
        $formatter = $this->getStubFormatterWithDecimalStyle();
        $this->assertFalse(@$formatter->format(1, Symfony_Component_Locale_Stub_StubNumberFormatter::TYPE_CURRENCY));
    }
    ...
    public function testFormatFractionDigitsStub($value, $expected, $fractionDigits = null, $expectedFractionDigits = 1)
    {
        ...
        if (null !== $fractionDigits) {
            $attributeRet = $formatter->setAttribute(Symfony_Component_Locale_Stub_StubNumberFormatter::FRACTION_DIGITS, $fractionDigits);
        }

        $formattedValue = $formatter->format($value);
        $this->assertSame($expected, $formattedValue);
        $this->assertSame($expectedFractionDigits, $formatter->getAttribute(Symfony_Component_Locale_Stub_StubNumberFormatter::FRACTION_DIGITS));
    ...
    public function testFormatGroupingUsedStub($value, $expected, $groupingUsed = null, $expectedGroupingUsed = 1)
    {
        ...
        if (null !== $groupingUsed) {
            $attributeRet = $formatter->setAttribute(Symfony_Component_Locale_Stub_StubNumberFormatter::GROUPING_USED, $groupingUsed);
        }

        $formattedValue = $formatter->format($value);
        $this->assertSame($expected, $formattedValue);
        $this->assertSame($expectedGroupingUsed, $formatter->getAttribute(Symfony_Component_Locale_Stub_StubNumberFormatter::GROUPING_USED));
    ...
    {
        $formatter = $this->getStubFormatterWithDecimalStyle();
        $formatter->setAttribute(Symfony_Component_Locale_Stub_StubNumberFormatter::FRACTION_DIGITS, 2);

        $formatter->setAttribute(Symfony_Component_Locale_Stub_StubNumberFormatter::ROUNDING_MODE, Symfony_Component_Locale_Stub_StubNumberFormatter::ROUND_HALFUP);
    ...
    public function testFormatRoundingModeStubRoundHalfDown($value, $expected)
    {
        ...
        $formatter->setAttribute(Symfony_Component_Locale_Stub_StubNumberFormatter::ROUNDING_MODE, Symfony_Component_Locale_Stub_StubNumberFormatter::ROUND_HALFDOWN);
    ...
    public function testFormatRoundingModeStubRoundHalfEven($value, $expected)
    {
        ...
        $formatter->setAttribute(Symfony_Component_Locale_Stub_StubNumberFormatter::ROUNDING_MODE, Symfony_Component_Locale_Stub_StubNumberFormatter::ROUND_HALFEVEN);
    ...
    {
        $formatter = $this->getStubFormatterWithDecimalStyle();
        $this->assertEquals(Symfony_Component_Locale_Stub_StubIntl::U_ZERO_ERROR, $formatter->getErrorCode());
    }
    ...
    public function testParseStub($value, $expected, $message, $expectedPosition)
    {
        ...
        $this->assertSame($errorMessage, Symfony_Component_Locale_Stub_StubIntl::getErrorMessage());
        $this->assertSame($errorCode, Symfony_Component_Locale_Stub_StubIntl::getErrorCode());
        $this->assertSame($errorCode !== 0, Symfony_Component_Locale_Stub_StubIntl::isFailure(Symfony_Component_Locale_Stub_StubIntl::getErrorCode()));
        $this->assertSame($errorMessage, $formatter->getErrorMessage());
        $this->assertSame($errorCode, $formatter->getErrorCode());
        $this->assertSame($errorCode !== 0, Symfony_Component_Locale_Stub_StubIntl::isFailure($formatter->getErrorCode()));
    }
    ...
    {
        $formatter = $this->getStubFormatterWithDecimalStyle();
        $formatter->parse('1', Symfony_Component_Locale_Stub_StubNumberFormatter::TYPE_DEFAULT);
    }
    ...
    {
        $formatter = $this->getStubFormatterWithDecimalStyle();
        $parsedValue = $formatter->parse($value, Symfony_Component_Locale_Stub_StubNumberFormatter::TYPE_INT32);
    ...
    {
        $formatter = $this->getStubFormatterWithDecimalStyle();
        $formatter->parse('1', Symfony_Component_Locale_Stub_StubNumberFormatter::TYPE_CURRENCY);
    }
    ...
    {
        return new Symfony_Component_Locale_Stub_StubNumberFormatter('en', Symfony_Component_Locale_Stub_StubNumberFormatter::DECIMAL);
    }

    protected function getStubFormatterWithCurrencyStyle()
    {
        return new Symfony_Component_Locale_Stub_StubNumberFormatter('en', Symfony_Component_Locale_Stub_StubNumberFormatter::CURRENCY);
    }
