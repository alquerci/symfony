...
class Symfony_Component_Locale_Tests_Stub_StubIntlDateFormatterTest extends Symfony_Component_Locale_Tests_TestCase
{
    /**
    ...
    {
        $formatter = new Symfony_Component_Locale_Stub_StubIntlDateFormatter('pt_BR', Symfony_Component_Locale_Stub_StubIntlDateFormatter::MEDIUM, Symfony_Component_Locale_Stub_StubIntlDateFormatter::SHORT);
    }

    public function testConstructor()
    {
        $formatter = new Symfony_Component_Locale_Stub_StubIntlDateFormatter('en', Symfony_Component_Locale_Stub_StubIntlDateFormatter::MEDIUM, Symfony_Component_Locale_Stub_StubIntlDateFormatter::SHORT, 'UTC', Symfony_Component_Locale_Stub_StubIntlDateFormatter::GREGORIAN, 'y-M-d');
     ...
     * @covers Symfony_Component_Locale_Stub_StubIntlDateFormatter::getTimeZoneId
     * @covers Symfony_Component_Locale_Stub_StubIntlDateFormatter::setTimeZoneId
     * @see Symfony_Component_Locale_Tests_Stub_StubIntlDateFormatterTest::testDefaultTimeZoneIntl()
     */
    public function testConstructorDefaultTimeZoneStub()
    {
        $formatter = new Symfony_Component_Locale_Stub_StubIntlDateFormatter('en', Symfony_Component_Locale_Stub_StubIntlDateFormatter::MEDIUM, Symfony_Component_Locale_Stub_StubIntlDateFormatter::SHORT);
    ...
    public function testConstructorDefaultTimeZoneIntl()
    {
        ...
        $formatter = new IntlDateFormatter('en', Symfony_Component_Locale_Stub_StubIntlDateFormatter::MEDIUM, Symfony_Component_Locale_Stub_StubIntlDateFormatter::SHORT);
    ...
    public function testFormatWithUnsupportedTimestampArgument()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException', $e);
    ...
    {
        $errorCode = Symfony_Component_Locale_Stub_StubIntl::U_ZERO_ERROR;
        $errorMessage = 'U_ZERO_ERROR';

        $formatter = $this->createStubFormatter($pattern);
        $this->assertSame($expected, $formatter->format($timestamp));
        $this->assertSame($errorMessage, Symfony_Component_Locale_Stub_StubIntl::getErrorMessage());
        $this->assertSame($errorCode, Symfony_Component_Locale_Stub_StubIntl::getErrorCode());
        $this->assertFalse(Symfony_Component_Locale_Stub_StubIntl::isFailure(Symfony_Component_Locale_Stub_StubIntl::getErrorCode()));
        $this->assertSame($errorMessage, $formatter->getErrorMessage());
        $this->assertSame($errorCode, $formatter->getErrorCode());
        $this->assertFalse(Symfony_Component_Locale_Stub_StubIntl::isFailure($formatter->getErrorCode()));
    }
    ...
    {
        $errorCode = Symfony_Component_Locale_Stub_StubIntl::U_ILLEGAL_ARGUMENT_ERROR;

        $formatter = $this->createStubFormatter($pattern);
        $this->assertFalse($formatter->format($timestamp));
        $this->assertSame($errorMessage, Symfony_Component_Locale_Stub_StubIntl::getErrorMessage());
        $this->assertSame($errorCode, Symfony_Component_Locale_Stub_StubIntl::getErrorCode());
        $this->assertTrue(Symfony_Component_Locale_Stub_StubIntl::isFailure(Symfony_Component_Locale_Stub_StubIntl::getErrorCode()));
        $this->assertSame($errorMessage, $formatter->getErrorMessage());
        $this->assertSame($errorCode, $formatter->getErrorCode());
        $this->assertTrue(Symfony_Component_Locale_Stub_StubIntl::isFailure($formatter->getErrorCode()));
    }
    ...
    public function testFormatWithTimezoneStub($timestamp, $timezone, $expected)
    {
        ...
        $formatter = new Symfony_Component_Locale_Stub_StubIntlDateFormatter('en', Symfony_Component_Locale_Stub_StubIntlDateFormatter::MEDIUM, Symfony_Component_Locale_Stub_StubIntlDateFormatter::SHORT, $timezone, Symfony_Component_Locale_Stub_StubIntlDateFormatter::GREGORIAN, $pattern);
        $this->assertSame($expected, $formatter->format($timestamp));
    }
    ...
    /**
     * @expectedException Symfony_Component_Locale_Exception_NotImplementedException
     */
    ...
    public function testFormatWithDefaultTimezoneIntl()
    {
        ...
        $formatter = new IntlDateFormatter('en', Symfony_Component_Locale_Stub_StubIntlDateFormatter::MEDIUM, Symfony_Component_Locale_Stub_StubIntlDateFormatter::SHORT, 'UTC');
        $formatter->setPattern('yyyy-MM-dd HH:mm:ss');
    ...
    {
        $pattern = 'Y';
        $formatter = new Symfony_Component_Locale_Stub_StubIntlDateFormatter('en', Symfony_Component_Locale_Stub_StubIntlDateFormatter::MEDIUM, Symfony_Component_Locale_Stub_StubIntlDateFormatter::SHORT, 'UTC', Symfony_Component_Locale_Stub_StubIntlDateFormatter::GREGORIAN, $pattern);
        $formatter->format(0);
    }
    ...
    */
    ...
    {
        $formatter = new Symfony_Component_Locale_Stub_StubIntlDateFormatter('en', $datetype, $timetype, 'UTC');
        $this->assertSame($expected, $formatter->format($timestamp));
    }
    ...
    */
    ...
    {
        $data = array(
            array(0, Symfony_Component_Locale_Stub_StubIntlDateFormatter::FULL, Symfony_Component_Locale_Stub_StubIntlDateFormatter::NONE, 'Thursday, January 1, 1970'),
            array(0, Symfony_Component_Locale_Stub_StubIntlDateFormatter::LONG, Symfony_Component_Locale_Stub_StubIntlDateFormatter::NONE, 'January 1, 1970'),
            array(0, Symfony_Component_Locale_Stub_StubIntlDateFormatter::MEDIUM, Symfony_Component_Locale_Stub_StubIntlDateFormatter::NONE, 'Jan 1, 1970'),
            array(0, Symfony_Component_Locale_Stub_StubIntlDateFormatter::SHORT, Symfony_Component_Locale_Stub_StubIntlDateFormatter::NONE, '1/1/70'),
        );

        if ($this->isIntlExtensionLoaded() && $this->isGreaterOrEqualThanIcuVersion('4.8')) {
            $data[] = array(0, Symfony_Component_Locale_Stub_StubIntlDateFormatter::NONE, Symfony_Component_Locale_Stub_StubIntlDateFormatter::FULL, '12:00:00 AM GMT');
            $data[] = array(0, Symfony_Component_Locale_Stub_StubIntlDateFormatter::NONE, Symfony_Component_Locale_Stub_StubIntlDateFormatter::LONG, '12:00:00 AM GMT');
        }

        $data[] = array(0, Symfony_Component_Locale_Stub_StubIntlDateFormatter::NONE, Symfony_Component_Locale_Stub_StubIntlDateFormatter::MEDIUM, '12:00:00 AM');
        $data[] = array(0, Symfony_Component_Locale_Stub_StubIntlDateFormatter::NONE, Symfony_Component_Locale_Stub_StubIntlDateFormatter::SHORT, '12:00 AM');
    ...
    {
        $formatter = $this->createStubFormatter();
        $this->assertEquals(Symfony_Component_Locale_Stub_StubIntlDateFormatter::GREGORIAN, $formatter->getCalendar());
    }

    public function testGetDateType()
    {
        $formatter = new Symfony_Component_Locale_Stub_StubIntlDateFormatter('en', Symfony_Component_Locale_Stub_StubIntlDateFormatter::FULL, Symfony_Component_Locale_Stub_StubIntlDateFormatter::NONE);
        $this->assertEquals(Symfony_Component_Locale_Stub_StubIntlDateFormatter::FULL, $formatter->getDateType());
    }

    public function testGetErrorCode()
    {
        $formatter = $this->createStubFormatter();
        $this->assertEquals(Symfony_Component_Locale_Stub_StubIntl::getErrorCode(), $formatter->getErrorCode());
    }

    public function testGetErrorMessage()
    {
        $formatter = $this->createStubFormatter();
        $this->assertEquals(Symfony_Component_Locale_Stub_StubIntl::getErrorMessage(), $formatter->getErrorMessage());
    }
    ...
    {
        $formatter = new Symfony_Component_Locale_Stub_StubIntlDateFormatter('en', Symfony_Component_Locale_Stub_StubIntlDateFormatter::FULL, Symfony_Component_Locale_Stub_StubIntlDateFormatter::NONE, 'UTC', Symfony_Component_Locale_Stub_StubIntlDateFormatter::GREGORIAN, 'yyyy-MM-dd');
    ...
    public function testGetTimeType()
    {
        ...
        $this->assertEquals(Symfony_Component_Locale_Stub_StubIntlDateFormatter::FULL, $formatter->getTimeType());
    }
    ...
    {
        $formatter = $this->createStubFormatter();
        $formatter->setCalendar(Symfony_Component_Locale_Stub_StubIntlDateFormatter::GREGORIAN);
    }
    ...
    {
        $formatter = Symfony_Component_Locale_Stub_StubIntlDateFormatter::create('en', Symfony_Component_Locale_Stub_StubIntlDateFormatter::MEDIUM, Symfony_Component_Locale_Stub_StubIntlDateFormatter::SHORT);
        $this->assertInstanceOf('Symfony_Component_Locale_Stub_StubIntlDateFormatter', $formatter);
    }

    protected function createStubFormatter($pattern = null)
    {
        return new Symfony_Component_Locale_Stub_StubIntlDateFormatter('en', Symfony_Component_Locale_Stub_StubIntlDateFormatter::MEDIUM, Symfony_Component_Locale_Stub_StubIntlDateFormatter::SHORT, 'UTC', Symfony_Component_Locale_Stub_StubIntlDateFormatter::GREGORIAN, $pattern);
    }
