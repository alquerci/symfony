...
/**
 * Provides a stub Symfony_Component_Locale_Locale for the 'en' locale.
 *
 * @author Eriksen Costa <eriksen.costa@infranology.com.br>
 */
class Symfony_Component_Locale_Stub_StubLocale
{
    const DEFAULT_LOCALE = null;

    /** Symfony_Component_Locale_Locale method constants */
    ...
    public static function getDataDirectory()
    {
        ...
        if (null === $dataDirectory) {
            ...
            } elseif (file_exists(dirname(__FILE__).'/../Resources/data/data-version.php')) {
                $dataDirectory = include dirname(__FILE__).'/../Resources/data/data-version.php';
            }
        }

        return dirname(__FILE__).'/../Resources/data/'.$dataDirectory;
    }
    ...
    {
        $dataDirectory = Symfony_Component_Locale_Locale::getIcuDataDirectory();

        if ('en' !== $locale) {
            throw new InvalidArgumentException(sprintf('Only the \'en\' locale is supported. %s', Symfony_Component_Locale_Exception_NotImplementedException::INTL_INSTALL_MESSAGE));
        }
