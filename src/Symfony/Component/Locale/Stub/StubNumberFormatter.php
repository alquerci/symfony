 ...
 */
class Symfony_Component_Locale_Stub_StubNumberFormatter
{
     ...
     * @var integer
     */
    protected $errorCode = Symfony_Component_Locale_Stub_StubIntl::U_ZERO_ERROR;
     ...
     * Symfony_Component_Locale_Stub_StubNumberFormatter::ROUNDING_MODE. Symfony_Component_Locale_Stub_StubNumberFormatter::ROUND_DOWN
     * and Symfony_Component_Locale_Stub_StubNumberFormatter::ROUND_UP does not have a PHP only equivalent
     *
     * @var array
     */
     ...
     *
     * @throws Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException  When $locale different than 'en' is passed
     * @throws Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException  When the $style is not supported
     * @throws Symfony_Component_Locale_Exception_MethodArgumentNotImplementedException       When the pattern value is different than null
     */
    public function __construct($locale = 'en', $style = null, $pattern = null)
    {
        if ('en' != $locale) {
            throw new Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException(__METHOD__, 'locale', $locale, 'Only the \'en\' locale is supported');
        }

        if (!in_array($style, self::$supportedStyles)) {
            $message = sprintf('The available styles are: %s.', implode(', ', array_keys(self::$supportedStyles)));
            throw new Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException(__METHOD__, 'style', $style, $message);
        }

        if (null !== $pattern) {
            throw new Symfony_Component_Locale_Exception_MethodArgumentNotImplementedException(__METHOD__, 'pattern');
        }
     ...
     *                           described in the ICU DecimalFormat or ICU RuleBasedNumberFormat documentation
     *
     * @return Symfony_Component_Locale_Stub_StubNumberFormatter
     *
     * @see    http://www.php.net/manual/en/numberformatter.create.php
     * @see    http://www.icu-project.org/apiref/icu4c/classDecimalFormat.html#_details
     * @see    http://www.icu-project.org/apiref/icu4c/classRuleBasedNumberFormat.html#_details
     ...
     * @throws Symfony_Component_Locale_Exception_MethodArgumentNotImplementedException  If the $type is different than TYPE_DEFAULT
     */
    public function format($value, $type = self::TYPE_DEFAULT)
    {
        ...
        if ($this->style == self::CURRENCY) {
            throw new RuntimeException(sprintf(
                ...
                __METHOD__, Symfony_Component_Locale_Exception_NotImplementedException::INTL_INSTALL_MESSAGE
            ));
        }

        // Only the default type is supported.
        if ($type != self::TYPE_DEFAULT) {
            throw new Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException(__METHOD__, 'type', $type, 'Only TYPE_DEFAULT is supported');
        }
     ...
     */
    public function getLocale($type = Symfony_Component_Locale_Stub_StubLocale::ACTUAL_LOCALE)
    {
        return $this->locale;
    }
     ...
     *
     * @throws Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException  When the $attr is not supported
     * @throws Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException  When the $value is not supported
     */
    public function setAttribute($attr, $value)
    {
        if (!in_array($attr, self::$supportedAttributes)) {
            ...
            throw new Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException(__METHOD__, 'attr', $value, $message);
        }
    ...
    {
        Symfony_Component_Locale_Stub_StubIntl::setError(Symfony_Component_Locale_Stub_StubIntl::U_ZERO_ERROR);
        $this->errorCode = Symfony_Component_Locale_Stub_StubIntl::getErrorCode();
        $this->errorMessage = Symfony_Component_Locale_Stub_StubIntl::getErrorMessage();
    }
    ...
    {
        $currencies = Symfony_Component_Locale_Stub_StubLocale::getCurrenciesData($this->locale);
