 ...
 */
class Symfony_Component_Locale_Stub_StubIntlDateFormatter
{
    /**
     ...
     * @throws Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException  When $calendar different than GREGORIAN is passed
     */
    public function __construct($locale, $datetype, $timetype, $timezone = null, $calendar = self::GREGORIAN, $pattern = null)
    {
        ...
        if (self::GREGORIAN !== $calendar) {
            throw new Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException(__METHOD__, 'calendar', $calendar, 'Only the GREGORIAN calendar is supported');
        }
     ...
     * @param string $pattern Optional pattern to use when formatting
     *
     * @return Symfony_Component_Locale_Stub_StubIntlDateFormatter
     *
     * @see    http://www.php.net/manual/en/intldateformatter.create.php
     * @see    http://userguide.icu-project.org/formatparse/datetime
     *
     ...
     *
     * @throws Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException If one of the formatting characters is not implemented
     */
    public function format($timestamp)
    {
        ...
        if (is_array($timestamp)) {
            ...
            throw new Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException(__METHOD__, 'timestamp', $timestamp, $message);
        }
        ...
        if (null !== $argumentError) {
            Symfony_Component_Locale_Stub_StubIntl::setError(Symfony_Component_Locale_Stub_StubIntl::U_ILLEGAL_ARGUMENT_ERROR, $argumentError);
        ...
        $transformer = new Symfony_Component_Locale_Stub_DateFormat_FullTransformer($this->getPattern(), $this->getTimeZoneId());
     ...
     *
     * @throws Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException When $lenient is true
     */
    public function setLenient($lenient)
    {
        if ($lenient) {
            throw new Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException(__METHOD__, 'lenient', $lenient, 'Only the strict parser is supported');
        }
    }
    ...
    public function setTimeZoneId($timeZoneId)
    {
        ...
        if ('GMT' !== $timeZoneId && 0 === strpos($timeZoneId, 'GMT')) {
            try {
                $timeZoneId = Symfony_Component_Locale_Stub_DateFormat_TimeZoneTransformer::getEtcTimeZoneId($timeZoneId);
