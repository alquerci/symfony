 ...
 */
class Symfony_Component_Locale_Stub_StubCollator
{
    /** Attribute constants */
     ...
     * @param string $locale The locale code
     *
     * @return Symfony_Component_Locale_Stub_StubCollator
     *
     * @throws Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException  When $locale different than 'en' is passed
     */
     ...
     *                           Symfony_Component_Locale_Stub_StubCollator::SORT_REGULAR - compare items normally (don't change types)
    ...
    {
        return Symfony_Component_Locale_Stub_StubIntl::U_ZERO_ERROR;
    }
     ...
     *                           Symfony_Component_Locale_Stub_StubCollator::PRIMARY
     *                           Symfony_Component_Locale_Stub_StubCollator::SECONDARY
     *                           Symfony_Component_Locale_Stub_StubCollator::TERTIARY
     *                           Symfony_Component_Locale_Stub_StubCollator::QUATERNARY
     *                           Symfony_Component_Locale_Stub_StubCollator::IDENTICAL
     *                           Symfony_Component_Locale_Stub_StubCollator::DEFAULT
     *
     * @return Boolean           True on success or false on failure
     *
     ...
     *                             Symfony_Component_Locale_Stub_StubCollator::SORT_NUMERIC
     *                             Symfony_Component_Locale_Stub_StubCollator::SORT_STRING
     *
     * @return Boolean             True on success or false on failure
     *
