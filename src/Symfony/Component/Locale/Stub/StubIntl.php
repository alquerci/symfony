 ...
 */
abstract class Symfony_Component_Locale_Stub_StubIntl
{
    /**
     ...
     *
     * @param integer $errorCode The error code returned by Symfony_Component_Locale_Stub_StubIntl::getErrorCode()
     *
     * @return Boolean
     */
     ...
     *
     * Returns Symfony_Component_Locale_Stub_StubIntl::U_ZERO_ERROR if no error occurred.
     *
     * @return integer
     */
     ...
     *
     * @param integer $code The error code returned by Symfony_Component_Locale_Stub_StubIntl::getErrorCode()
     *
     * @return string
     */
