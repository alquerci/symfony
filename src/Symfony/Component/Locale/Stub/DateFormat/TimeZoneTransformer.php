 ...
 */
class Symfony_Component_Locale_Stub_DateFormat_TimeZoneTransformer extends Symfony_Component_Locale_Stub_DateFormat_Transformer
{
    /**
     * {@inheritDoc}
     *
     * @throws Symfony_Component_Locale_Exception_NotImplementedException  When time zone is different than UTC or GMT (Etc/GMT)
     */
    public function format(DateTime $dateTime, $length)
    {
        ...
        if (!in_array($timeZone, array('Etc', 'UTC'))) {
            throw new Symfony_Component_Locale_Exception_NotImplementedException('Time zone different than GMT or UTC is not supported as a formatting output.');
        }
     ...
     *
     * @throws Symfony_Component_Locale_Exception_NotImplementedException   When the GMT time zone have minutes offset different than zero
    ...
    public static function getEtcTimeZoneId($formattedTimeZone)
    {
        ...
        if (preg_match('/GMT(?P<signal>[+-])(?P<hours>\d{2}):?(?P<minutes>\d{2})$/', $formattedTimeZone, $matches)) {
            ...
            if (0 < $minutes) {
                throw new Symfony_Component_Locale_Exception_NotImplementedException(sprintf(
