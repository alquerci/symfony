 ...
 */
class Symfony_Component_Locale_Stub_DateFormat_FullTransformer
{
    private $quoteMatch = "'(?:[^']+|'')*'";
    ...
    public function __construct($pattern, $timezone)
    {
        ...
        $this->transformers = array(
            'M' => new Symfony_Component_Locale_Stub_DateFormat_MonthTransformer(),
            'L' => new Symfony_Component_Locale_Stub_DateFormat_MonthTransformer(),
            'y' => new Symfony_Component_Locale_Stub_DateFormat_YearTransformer(),
            'd' => new Symfony_Component_Locale_Stub_DateFormat_DayTransformer(),
            'q' => new Symfony_Component_Locale_Stub_DateFormat_QuarterTransformer(),
            'Q' => new Symfony_Component_Locale_Stub_DateFormat_QuarterTransformer(),
            'h' => new Symfony_Component_Locale_Stub_DateFormat_Hour1201Transformer(),
            'D' => new Symfony_Component_Locale_Stub_DateFormat_DayOfYearTransformer(),
            'E' => new Symfony_Component_Locale_Stub_DateFormat_DayOfWeekTransformer(),
            'a' => new Symfony_Component_Locale_Stub_DateFormat_AmPmTransformer(),
            'H' => new Symfony_Component_Locale_Stub_DateFormat_Hour2400Transformer(),
            'K' => new Symfony_Component_Locale_Stub_DateFormat_Hour1200Transformer(),
            'k' => new Symfony_Component_Locale_Stub_DateFormat_Hour2401Transformer(),
            'm' => new Symfony_Component_Locale_Stub_DateFormat_MinuteTransformer(),
            's' => new Symfony_Component_Locale_Stub_DateFormat_SecondTransformer(),
            'z' => new Symfony_Component_Locale_Stub_DateFormat_TimeZoneTransformer(),
        );
    }
     ...
     *
     * @return Symfony_Component_Locale_Stub_DateFormat_Transformer[] Associative array of Transformer objects (format char => Transformer)
     */
     ...
     * @return string                   The formatted value
     *
     * @throws Symfony_Component_Locale_Exception_NotImplementedException  When it encounters a not implemented date character
     */
    public function formatReplace($dateChars, $dateTime)
    {
        ...
        if (false !== strpos($this->notImplementedChars, $dateChars[0])) {
            throw new Symfony_Component_Locale_Exception_NotImplementedException(sprintf("Unimplemented date character '%s' in format '%s'", $dateChars[0], $this->pattern));
        }
    }
    ...
    public function parse(DateTime $dateTime, $value)
    {
        ...
        Symfony_Component_Locale_Stub_StubIntl::setError(Symfony_Component_Locale_Stub_StubIntl::U_PARSE_ERROR, 'Date parsing failed');
    ...
    protected function calculateUnixTimestamp(DateTime $dateTime, array $options)
    {
        ...
        // Normalize hour
        if ($hourInstance instanceof Symfony_Component_Locale_Stub_DateFormat_HourTransformer) {
