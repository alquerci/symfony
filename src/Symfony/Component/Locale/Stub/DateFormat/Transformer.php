 ...
 */
abstract class Symfony_Component_Locale_Stub_DateFormat_Transformer
{
    /**
     ...
     * @param int    $length  The length of the Symfony_Component_Locale_Stub_DateFormat_Transformer pattern string
     *
