 ...
 */
class Symfony_Component_Locale_Exception_MethodArgumentValueNotImplementedException extends Symfony_Component_Locale_Exception_NotImplementedException
{
    /**
     * Constructor
     *
