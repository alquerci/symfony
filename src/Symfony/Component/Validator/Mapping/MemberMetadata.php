...
abstract class Symfony_Component_Validator_Mapping_MemberMetadata extends Symfony_Component_Validator_Mapping_ElementMetadata implements Symfony_Component_Validator_PropertyMetadataInterface, Symfony_Component_Validator_ClassBasedInterface
{
    public $class;
    public $name;
    public $property;
    ...
    {
        if (!in_array(Symfony_Component_Validator_Constraint::PROPERTY_CONSTRAINT, (array) $constraint->getTargets())) {
