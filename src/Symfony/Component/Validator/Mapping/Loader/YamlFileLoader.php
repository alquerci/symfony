...
class Symfony_Component_Validator_Mapping_Loader_YamlFileLoader extends Symfony_Component_Validator_Mapping_Loader_FileLoader
{
    /**
    ...
    public function loadClassMetadata(Symfony_Component_Validator_Mapping_ClassMetadata $metadata)
    {
        if (null === $this->classes) {
            $this->classes = Symfony_Component_Yaml_Yaml::parse($this->file);
