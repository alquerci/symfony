...
class Symfony_Component_Validator_Mapping_Loader_XmlFileLoader extends Symfony_Component_Validator_Mapping_Loader_FileLoader
{
    /**
     ...
     *
     * @throws Symfony_Component_Validator_Exception_MappingException
     */
    protected function parseFile($file)
    {
        try {
            $dom = Symfony_Component_Config_Util_XmlUtils::loadFile($file, dirname(__FILE__).'/schema/dic/constraint-mapping/constraint-mapping-1.0.xsd');
        } catch (Exception $e) {
            throw new Symfony_Component_Validator_Exception_MappingException($e->getMessage(), $e->getCode(), $e);
        }
