 ...
 */
interface Symfony_Component_Validator_PropertyMetadataContainerInterface
{
    /**
     ...
     * @param string $property The property name.
     *
     * @return Symfony_Component_Validator_PropertyMetadataInterface[] A list of metadata instances. Empty if
