...
class Symfony_Component_Validator_Tests_Constraints_TypeValidatorTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->validator = new Symfony_Component_Validator_Constraints_TypeValidator();
    ...
    public function testNullIsValid()
    {
        ...
        $this->validator->validate(null, new Symfony_Component_Validator_Constraints_Type(array('type' => 'integer')));
    }
    ...
    public function testEmptyIsValidIfString()
    {
        ...
        $this->validator->validate('', new Symfony_Component_Validator_Constraints_Type(array('type' => 'string')));
    }
    ...
    public function testEmptyIsInvalidIfNoString()
    {
        ...
        $this->validator->validate('', new Symfony_Component_Validator_Constraints_Type(array('type' => 'integer')));
    }
    ...
    public function testValidValues($value, $type)
    {
        ...
        $constraint = new Symfony_Component_Validator_Constraints_Type(array('type' => $type));
    ...
    {
        $constraint = new Symfony_Component_Validator_Constraints_Type(array(
            'type' => $type,
            'message' => 'myMessage'
        ));
