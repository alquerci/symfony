...
class Symfony_Component_Validator_Tests_Constraints_IpValidatorTest extends PHPUnit_Framework_TestCase
{
    protected $context;
    protected $validator;
    ...
    protected function setUp()
    {
        ...
        $this->validator = new Symfony_Component_Validator_Constraints_IpValidator();
    ...
    public function testNullIsValid()
    {
        ...
        $this->validator->validate(null, new Symfony_Component_Validator_Constraints_Ip());
    }
    ...
    public function testEmptyStringIsValid()
    {
        ...
        $this->validator->validate('', new Symfony_Component_Validator_Constraints_Ip());
    }
    ...
    {
        $this->validator->validate(new stdClass(), new Symfony_Component_Validator_Constraints_Ip());
    }
    ...
    {
        $ip = new Symfony_Component_Validator_Constraints_Ip(array(
            'version' => 666,
        ));
    }
    ...
    public function testValidIpsV4($ip)
    {
        ...
        $this->validator->validate($ip, new Symfony_Component_Validator_Constraints_Ip(array(
            'version' => Symfony_Component_Validator_Constraints_Ip::V4,
        )));
    }
    ...
    public function testValidIpsV6($ip)
    {
        ...
        $this->validator->validate($ip, new Symfony_Component_Validator_Constraints_Ip(array(
            'version' => Symfony_Component_Validator_Constraints_Ip::V6,
        )));
    }
    ...
    public function testValidIpsAll($ip)
    {
        ...
        $this->validator->validate($ip, new Symfony_Component_Validator_Constraints_Ip(array(
            'version' => Symfony_Component_Validator_Constraints_Ip::ALL,
        )));
    }
    ...
    {
        $constraint = new Symfony_Component_Validator_Constraints_Ip(array(
            'version' => Symfony_Component_Validator_Constraints_Ip::V4,
            'message' => 'myMessage',
        ));
    ...
    {
        $constraint = new Symfony_Component_Validator_Constraints_Ip(array(
            'version' => Symfony_Component_Validator_Constraints_Ip::V4_NO_PRIV,
            'message' => 'myMessage',
        ));
    ...
    {
        $constraint = new Symfony_Component_Validator_Constraints_Ip(array(
            'version' => Symfony_Component_Validator_Constraints_Ip::V4_NO_RES,
            'message' => 'myMessage',
        ));
    ...
    {
        $constraint = new Symfony_Component_Validator_Constraints_Ip(array(
            'version' => Symfony_Component_Validator_Constraints_Ip::V4_ONLY_PUBLIC,
            'message' => 'myMessage',
        ));
    ...
    {
        $constraint = new Symfony_Component_Validator_Constraints_Ip(array(
            'version' => Symfony_Component_Validator_Constraints_Ip::V6_NO_PRIV,
            'message' => 'myMessage',
        ));
    ...
    {
        $constraint = new Symfony_Component_Validator_Constraints_Ip(array(
            'version' => Symfony_Component_Validator_Constraints_Ip::V6_NO_RES,
            'message' => 'myMessage',
        ));
    ...
    {
        $constraint = new Symfony_Component_Validator_Constraints_Ip(array(
            'version' => Symfony_Component_Validator_Constraints_Ip::V6_ONLY_PUBLIC,
            'message' => 'myMessage',
        ));
    ...
    {
        $constraint = new Symfony_Component_Validator_Constraints_Ip(array(
            'version' => Symfony_Component_Validator_Constraints_Ip::ALL_NO_PRIV,
            'message' => 'myMessage',
        ));
    ...
    {
        $constraint = new Symfony_Component_Validator_Constraints_Ip(array(
            'version' => Symfony_Component_Validator_Constraints_Ip::ALL_NO_RES,
            'message' => 'myMessage',
        ));
    ...
    {
        $constraint = new Symfony_Component_Validator_Constraints_Ip(array(
            'version' => Symfony_Component_Validator_Constraints_Ip::ALL_ONLY_PUBLIC,
            'message' => 'myMessage',
        ));
