 ...
 */
abstract class Symfony_Component_Validator_Tests_Constraints_CountValidatorTest extends PHPUnit_Framework_TestCase
{
    protected $context;
    protected $validator;
    ...
    protected function setUp()
    {
        ...
        $this->validator = new Symfony_Component_Validator_Constraints_CountValidator();
    ...
    public function testNullIsValid()
    {
        ...
        $this->validator->validate(null, new Symfony_Component_Validator_Constraints_Count(6));
    }
    ...
    {
        $this->validator->validate(new stdClass(), new Symfony_Component_Validator_Constraints_Count(5));
    }
    ...
    public function testValidValuesMax($value)
    {
        ...
        $constraint = new Symfony_Component_Validator_Constraints_Count(array('max' => 3));
    ...
    public function testValidValuesMin($value)
    {
        ...
        $constraint = new Symfony_Component_Validator_Constraints_Count(array('min' => 5));
        $this->validator->validate($value, $constraint);
    }
    ...
    public function testValidValuesExact($value)
    {
        ...
        $constraint = new Symfony_Component_Validator_Constraints_Count(4);
        $this->validator->validate($value, $constraint);
    }
    ...
    {
        $constraint = new Symfony_Component_Validator_Constraints_Count(array(
            'max' => 4,
    ...
    {
        $constraint = new Symfony_Component_Validator_Constraints_Count(5);
