...
class Symfony_Component_Validator_Tests_Constraints_LengthValidatorTest extends PHPUnit_Framework_TestCase
{
    protected $context;
    protected $validator;
    ...
    protected function setUp()
    {
        ...
        $this->validator = new Symfony_Component_Validator_Constraints_LengthValidator();
    ...
    public function testNullIsValid()
    {
        ...
        $this->validator->validate(null, new Symfony_Component_Validator_Constraints_Length(6));
    }
    ...
    public function testEmptyStringIsValid()
    {
        ...
        $this->validator->validate('', new Symfony_Component_Validator_Constraints_Length(6));
    }
    ...
    {
        $this->validator->validate(new stdClass(), new Symfony_Component_Validator_Constraints_Length(5));
    }
    ...
    public function testValidValuesMin($value, $mbOnly = false)
    {
        ...
        $constraint = new Symfony_Component_Validator_Constraints_Length(array('min' => 5));
    ...
    public function testValidValuesMax($value, $mbOnly = false)
    {
        ...
        $constraint = new Symfony_Component_Validator_Constraints_Length(array('max' => 3));
        $this->validator->validate($value, $constraint);
    }
    ...
    public function testValidValuesExact($value, $mbOnly = false)
    {
        ...
        $constraint = new Symfony_Component_Validator_Constraints_Length(4);
        $this->validator->validate($value, $constraint);
    }
    ...
    public function testInvalidValuesMin($value, $mbOnly = false)
    {
        ...
        $constraint = new Symfony_Component_Validator_Constraints_Length(array(
            'min' => 4,
    ...
    {
        $constraint = new Symfony_Component_Validator_Constraints_Length(5);
