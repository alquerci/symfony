...
class Symfony_Component_Validator_Tests_Constraints_CardSchemeValidatorTest extends PHPUnit_Framework_TestCase
{
    protected $context;
    protected $validator;
    ...
    protected function setUp()
    {
        ...
        $this->validator = new Symfony_Component_Validator_Constraints_CardSchemeValidator();
    ...
    public function testNullIsValid()
    {
        ...
        $this->validator->validate(null, new Symfony_Component_Validator_Constraints_CardScheme(array('schemes' => array())));
    }
    ...
    public function testEmptyStringIsValid()
    {
        ...
        $this->validator->validate('', new Symfony_Component_Validator_Constraints_CardScheme(array('schemes' => array())));
    }
    ...
    public function testValidNumbers($scheme, $number)
    {
        ...
        $this->validator->validate($number, new Symfony_Component_Validator_Constraints_CardScheme(array('schemes' => $scheme)));
    }
