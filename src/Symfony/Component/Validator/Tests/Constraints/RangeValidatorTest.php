...
class Symfony_Component_Validator_Tests_Constraints_RangeValidatorTest extends PHPUnit_Framework_TestCase
{
    protected $context;
    protected $validator;
    ...
    protected function setUp()
    {
        ...
        $this->validator = new Symfony_Component_Validator_Constraints_RangeValidator();
    ...
    public function testNullIsValid()
    {
        ...
        $this->validator->validate(null, new Symfony_Component_Validator_Constraints_Range(array('min' => 10, 'max' => 20)));
    }
    ...
    public function testValidValuesMin($value)
    {
        ...
        $constraint = new Symfony_Component_Validator_Constraints_Range(array('min' => 10));
    ...
    public function testValidValuesMax($value)
    {
        ...
        $constraint = new Symfony_Component_Validator_Constraints_Range(array('max' => 20));
        $this->validator->validate($value, $constraint);
    }
    ...
    public function testValidValuesMinMax($value)
    {
        ...
        $constraint = new Symfony_Component_Validator_Constraints_Range(array('min' => 10, 'max' => 20));
        $this->validator->validate($value, $constraint);
    }
    ...
    {
        $constraint = new Symfony_Component_Validator_Constraints_Range(array(
            'min' => 10,
