...
class Symfony_Component_Validator_Tests_Constraints_LuhnValidatorTest extends PHPUnit_Framework_TestCase
{
    protected $context;
    protected $validator;
    ...
    protected function setUp()
    {
        ...
        $this->validator = new Symfony_Component_Validator_Constraints_LuhnValidator();
    ...
    public function testNullIsValid()
    {
        ...
        $this->validator->validate(null, new Symfony_Component_Validator_Constraints_Luhn());
    }
    ...
    public function testEmptyStringIsValid()
    {
        ...
        $this->validator->validate('', new Symfony_Component_Validator_Constraints_Luhn());
    }
    ...
    public function testValidNumbers($number)
    {
        ...
        $this->validator->validate($number, new Symfony_Component_Validator_Constraints_Luhn());
    }
    ...
    {
        $constraint = new Symfony_Component_Validator_Constraints_Luhn();
