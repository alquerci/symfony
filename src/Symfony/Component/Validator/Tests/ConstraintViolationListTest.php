...
class Symfony_Component_Validator_Tests_ConstraintViolationListTest extends PHPUnit_Framework_TestCase
{
    protected $list;

    protected function setUp()
    {
        $this->list = new Symfony_Component_Validator_ConstraintViolationList();
    }
    ...
    public function testInitWithViolations()
    {
        ...
        $this->list = new Symfony_Component_Validator_ConstraintViolationList(array($violation));
    ...
    public function testAddAll()
    {
        ...
        $otherList = new Symfony_Component_Validator_ConstraintViolationList($violations);
    ...
    public function testIterator()
    {
        ...
        $this->list = new Symfony_Component_Validator_ConstraintViolationList($violations);
    ...
    {
        $this->list = new Symfony_Component_Validator_ConstraintViolationList(array(
...
EOF;
    ...
    {
        return new Symfony_Component_Validator_ConstraintViolation($message, $message, array(), $root, $propertyPath, null);
    }
}
