...
class Symfony_Component_Validator_Tests_ExecutionContextTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var Symfony_Component_Validator_ExecutionContext
     */
    private $context;

    protected function setUp()
    {
        $this->visitor = $this->getMockBuilder('Symfony_Component_Validator_ValidationVisitor')
            ->disableOriginalConstructor()
            ->getMock();
        $this->violations = new Symfony_Component_Validator_ConstraintViolationList();
        $this->metadata = $this->getMock('Symfony_Component_Validator_MetadataInterface');
        $this->metadataFactory = $this->getMock('Symfony_Component_Validator_MetadataFactoryInterface');
        $this->globalContext = $this->getMock('Symfony_Component_Validator_GlobalExecutionContextInterface');
        ...
        $this->translator = $this->getMock('Symfony_Component_Translation_TranslatorInterface');
        $this->context = new Symfony_Component_Validator_ExecutionContext($this->globalContext, $this->translator, self::TRANS_DOMAIN, $this->metadata, 'currentValue', 'Group', 'foo.bar');
    }
    ...
    public function testInitWithClassMetadata()
    {
        // BC
        set_error_handler(array($this, "deprecationErrorHandler"));
        $this->metadata = new Symfony_Component_Validator_Mapping_ClassMetadata('Symfony_Component_Validator_Tests_ExecutionContextTest_TestClass');
        $this->context = new Symfony_Component_Validator_ExecutionContext($this->globalContext, $this->translator, self::TRANS_DOMAIN, $this->metadata, 'currentValue', 'Group', 'foo.bar');

        $this->assertSame('Symfony_Component_Validator_Tests_ExecutionContextTest_TestClass', $this->context->getCurrentClass());
        $this->assertNull($this->context->getCurrentProperty());
        restore_error_handler();
    }
    ...
    public function testInitWithPropertyMetadata()
    {
        // BC
        set_error_handler(array($this, "deprecationErrorHandler"));
        $this->metadata = new Symfony_Component_Validator_Mapping_PropertyMetadata('Symfony_Component_Validator_Tests_ExecutionContextTest_TestClass', 'myProperty');
        $this->context = new Symfony_Component_Validator_ExecutionContext($this->globalContext, $this->translator, self::TRANS_DOMAIN, $this->metadata, 'currentValue', 'Group', 'foo.bar');
    ...
    public function testAddViolation()
    {
        ...
        $this->assertEquals(new Symfony_Component_Validator_ConstraintViolationList(array(
    ...
    {
        $this->context = new Symfony_Component_Validator_ExecutionContext($this->globalContext, $this->translator, self::TRANS_DOMAIN, $this->metadata, 'currentValue', 'Group', '');

        $this->assertEquals('bam.baz', $this->context->getPropertyPath('bam.baz'));
    }
}

class Symfony_Component_Validator_Tests_ExecutionContextTest_TestClass
{
    public $myProperty;
}
