 ...
 */
class Symfony_Component_Validator_ExecutionContext implements Symfony_Component_Validator_ExecutionContextInterface
{
    /**
     * @var Symfony_Component_Validator_GlobalExecutionContextInterface
     */
    ...
    /**
     * @var Symfony_Component_Validator_MetadataInterface
     */
    private $metadata;
     ...
     *
     * @param Symfony_Component_Validator_GlobalExecutionContextInterface $globalContext     The global context storing node-independent state.
     ...
     * @param Symfony_Component_Validator_MetadataInterface               $metadata          The metadata of the validated node.
     ...
     */
    public function __construct(Symfony_Component_Validator_GlobalExecutionContextInterface $globalContext, Symfony_Component_Translation_TranslatorInterface $translator, $translationDomain = null, Symfony_Component_Validator_MetadataInterface $metadata = null, $value = null, $group = null, $propertyPath = '')
    {
        if (null === $group) {
            $group = Symfony_Component_Validator_Constraint::DEFAULT_GROUP;
        }
    ...
    {
        if ($this->metadata instanceof Symfony_Component_Validator_ClassBasedInterface) {
    ...
    {
        if ($this->metadata instanceof Symfony_Component_Validator_PropertyMetadataInterface) {
