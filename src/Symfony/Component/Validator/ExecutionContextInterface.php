 ...
 * {@link getMetadata}) which for example returns a {@link Mapping_PropertyMetadata}
 * or a {@link Mapping_ClassMetadata} object. he context also contains the
 ...
 * @api
 */
interface Symfony_Component_Validator_ExecutionContextInterface
{
    /**
     ...
     *
     * @return Symfony_Component_Validator_ConstraintViolationListInterface The constraint violation list.
     *
     * @api
     */
     ...
     * {@link Mapping_ClassMetadata} instance if the current value is an object,
     * a {@link Mapping_PropertyMetadata} instance if the current value is
     * the value of a property and a {@link Mapping_GetterMetadata} instance if
     ...
     * null.
     *
     * @return Symfony_Component_Validator_MetadataInterface|null The metadata of the currently validated
     *                                value.
     */
