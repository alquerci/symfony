 ...
 */
interface Symfony_Component_Validator_MetadataInterface
{
    /**
     ...
     *
     * @param Symfony_Component_Validator_ValidationVisitorInterface $visitor      The visitor implementing the validation logic.
     ...
     */
    public function accept(Symfony_Component_Validator_ValidationVisitorInterface $visitor, $value, $group, $propertyPath);
     ...
     *
     * @return Symfony_Component_Validator_Constraint[] A list of constraint instances.
     */
