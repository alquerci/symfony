 ...
 * @api
 */
class Symfony_Component_Validator_Constraints_Ip extends Symfony_Component_Validator_Constraint
{
    const V4 = '4';
    const V6 = '6';
    const ALL = 'all';
    ...
    public function __construct($options = null)
    {
        ...
        if (!in_array($this->version, self::$versions)) {
            throw new Symfony_Component_Validator_Exception_ConstraintDefinitionException(sprintf('The option "version" must be one of "%s"', implode('", "', self::$versions)));
        }
    }
}
