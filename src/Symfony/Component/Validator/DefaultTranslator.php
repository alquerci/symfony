 ...
 * Example usage:
 *
 *     $translator = new Symfony_Component_Validator_DefaultTranslator();
 *
 ...
 * {@link Symfony_Component_Translation_Translator} and can be used in places
 * where translation is not required by default but should be optional.
 *
 * @author Bernhard Schussek <bschussek@gmail.com>
 */
class Symfony_Component_Validator_DefaultTranslator implements Symfony_Component_Translation_TranslatorInterface
{
    /**
     ...
     * {@link Symfony_Component_Translation_Translator}, but it does not
     ...
     * implementation of {@link Symfony_Component_Translation_TranslatorInterface} if you need this or similar
     * functionality.
     *
     * Example usage:
     *
     ...
     *
     * @throws Symfony_Component_Validator_Exception_InvalidArgumentException If the message id does not have the format
     *                                  "singular|plural".
     */
    public function transChoice($id, $number, array $parameters = array(), $domain = null, $locale = null)
    {
        ...
        if (!isset($ids[1])) {
            throw new Symfony_Component_Validator_Exception_InvalidArgumentException(sprintf('The message "%s" cannot be pluralized, because it is missing a plural (e.g. "There is one apple|There are %%count%% apples").', $id));
        }
     ...
     *
     * @throws Symfony_Component_Validator_Exception_BadMethodCallException
     */
    public function setLocale($locale)
    {
        throw new Symfony_Component_Validator_Exception_BadMethodCallException('Unsupported method.');
    }
