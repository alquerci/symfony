 ...
 */
interface Symfony_Component_Validator_ValidationVisitorInterface
{
    /**
     * Validates a value.
     *
     ...
     *
     * @throws Symfony_Component_Validator_Exception_NoSuchMetadataException If no metadata can be found for
     *                                           the given value.
     */
     ...
     * {@link Symfony_Component_Validator_ValidationVisitorInterface}.
     *
     * @param Symfony_Component_Validator_MetadataInterface $metadata     The metadata holding the constraints.
     * @param mixed             $value        The value to validate.
     * @param string            $group        The validation group to validate.
     * @param string            $propertyPath The current property path in the validation graph.
     */
     ...
     * visitor.
     *
     * @return Symfony_Component_Validator_GraphWalker The graph walker.
     *
