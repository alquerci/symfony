...
class Symfony_Component_Translation_Tests_MessageSelectorTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $selector = new Symfony_Component_Translation_MessageSelector();
