...
class Symfony_Component_Translation_Tests_MessageCatalogueTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $catalogue = new Symfony_Component_Translation_MessageCatalogue('en', array('domain1' => array(), 'domain2' => array()));
    ...
    {
        $catalogue = new Symfony_Component_Translation_MessageCatalogue('en', $messages = array('domain1' => array('foo' => 'foo'), 'domain2' => array('bar' => 'bar')));
    ...
    {
        $catalogue = new Symfony_Component_Translation_MessageCatalogue('en', array('domain1' => array('foo' => 'foo'), 'domain2' => array('bar' => 'bar')));
    ...
    public function testAddCatalogue()
    {
        ...
        $r = $this->getMock('Symfony_Component_Config_Resource_ResourceInterface');
        $r->expects($this->any())->method('__toString')->will($this->returnValue('r'));

        $r1 = $this->getMock('Symfony_Component_Config_Resource_ResourceInterface');
        $r1->expects($this->any())->method('__toString')->will($this->returnValue('r1'));

        $catalogue = new Symfony_Component_Translation_MessageCatalogue('en', array('domain1' => array('foo' => 'foo'), 'domain2' => array('bar' => 'bar')));
        $catalogue->addResource($r);

        $catalogue1 = new Symfony_Component_Translation_MessageCatalogue('en', array('domain1' => array('foo1' => 'foo1')));
    ...
    public function testAddFallbackCatalogue()
    {
        ...
        $catalogue = new Symfony_Component_Translation_MessageCatalogue('en_US', array('domain1' => array('foo' => 'foo'), 'domain2' => array('bar' => 'bar')));
        $catalogue->addResource($r);

        $catalogue1 = new Symfony_Component_Translation_MessageCatalogue('en', array('domain1' => array('foo' => 'bar', 'foo1' => 'foo1')));
        $catalogue1->addResource($r1);
    ...
    {
        $main = new Symfony_Component_Translation_MessageCatalogue('en_US');
        $fallback = new Symfony_Component_Translation_MessageCatalogue('fr_FR');
    ...
    {
        $catalogue = new Symfony_Component_Translation_MessageCatalogue('en');
        $catalogue->addCatalogue(new Symfony_Component_Translation_MessageCatalogue('fr', array()));
    }
    ...
    {
        $cat1 = new Symfony_Component_Translation_MessageCatalogue('en');
        $cat1->setMetadata('a', 'b');
        $this->assertEquals(array('messages' => array('a' => 'b')), $cat1->getMetadata('', ''), 'Cat1 contains messages metadata.');

        $cat2 = new Symfony_Component_Translation_MessageCatalogue('en');
