...
class Symfony_Component_Translation_Tests_IdentityTranslatorTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $translator = new Symfony_Component_Translation_IdentityTranslator(new Symfony_Component_Translation_MessageSelector());
