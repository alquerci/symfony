 ...
 * @api
 */
class Symfony_Component_Translation_MessageCatalogue implements Symfony_Component_Translation_MessageCatalogueInterface, Symfony_Component_Translation_MetadataAwareInterface
{
    ...
    public function addCatalogue(Symfony_Component_Translation_MessageCatalogueInterface $catalogue)
    {
        ...
        if ($catalogue instanceof Symfony_Component_Translation_MetadataAwareInterface) {
