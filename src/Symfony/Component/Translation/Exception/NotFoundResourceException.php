 ...
 * @api
 */
class Symfony_Component_Translation_Exception_NotFoundResourceException extends InvalidArgumentException implements Symfony_Component_Translation_Exception_ExceptionInterface
{
    /**
     * @var Exception
     */
