 ...
 * @api
 */
class Symfony_Component_BrowserKit_CookieJar
{
     ...
     * Sets a cookie.
     *
     * @param Symfony_Component_BrowserKit_Cookie $cookie A Cookie instance
     *
     * @api
     */
    public function set(Symfony_Component_BrowserKit_Cookie $cookie)
    {
     ...
     *
     * @return Symfony_Component_BrowserKit_Cookie|null A Cookie instance or null if the cookie does not exist
     *
     * @api
     */
    ...
    public function updateFromSetCookie(array $setCookies, $uri = null)
    {
        ...
        foreach ($cookies as $cookie) {
            try {
                $this->set(Symfony_Component_BrowserKit_Cookie::fromString($cookie, $uri));
     ...
     *
     * @param Symfony_Component_BrowserKit_Response $response A Response object
     * @param string   $uri      The base URL
     */
    public function updateFromResponse(Symfony_Component_BrowserKit_Response $response, $uri = null)
    {
     ...
     *
     * @return Symfony_Component_BrowserKit_Cookie[] An array of cookies
     */
    public function all()
    {
        $this->flushExpiredCookies();
