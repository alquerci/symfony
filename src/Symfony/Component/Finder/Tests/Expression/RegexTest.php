...
class Symfony_Component_Finder_Tests_Expression_RegexTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $expr = new Symfony_Component_Finder_Expression_Expression($regex);
    ...
    {
        $expr = new Symfony_Component_Finder_Expression_Expression('~abc~is');
