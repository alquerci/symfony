...
class Symfony_Component_Finder_Tests_FinderTest extends Symfony_Component_Finder_Tests_Iterator_RealIteratorTestCase
{

    public function testCreate()
    {
        $this->assertInstanceOf('Symfony_Component_Finder_Finder', Symfony_Component_Finder_Finder::create());
    }
    ...
    {
        $finder = $this->buildFinder($adapter);
        $this->assertSame($finder, $finder->sort(create_function('SplFileInfo $a, SplFileInfo $b', 'return strcmp($a->getRealpath(), $b->getRealpath());')));
        $this->assertIterator($this->toAbsolute(array('foo', 'foo bar', 'foo/bar.tmp', 'test.php', 'test.py', 'toto')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    {
        $finder = $this->buildFinder($adapter);
        $this->assertSame($finder, $finder->filter(create_function('SplFileInfo $f', 'return preg_match("/test/", $f) > 0;')));
        $this->assertIterator($this->toAbsolute(array('test.php', 'test.py')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testGetIterator($adapter)
    {
        ...
        $a = array_values(array_map(create_function('$a', 'return (string) $a;'), $a));
        sort($a);
    ...
    {
        $this->assertInstanceOf('Symfony_Component_Finder_Finder', $this->buildFinder($adapter)->append(array()));
    }
    ...
    public function testAppendDoesNotRequireIn($adapter)
    {
        ...
        $finder1 = Symfony_Component_Finder_Finder::create()->append($finder);
    ...
    {
        $directory = Symfony_Component_Finder_Finder::create()->directories()->in(self::$tmpDir);
        $i = 0;
    ...
    {
        $files = Symfony_Component_Finder_Finder::create()->files()->in(dirname(__FILE__).DIRECTORY_SEPARATOR.'Fixtures');
        $i = 0;
    ...
    {
        $finder = Symfony_Component_Finder_Finder::create()->files();
        count($finder);
    }
     ...
     * @dataProvider getAdaptersTestData
     */
    public function testContainsOnDirectory(Symfony_Component_Finder_Adapter_AdapterInterface $adapter)
    {
        $finder = $this->buildFinder($adapter);
     ...
     * @dataProvider getAdaptersTestData
     */
    public function testNotContainsOnDirectory(Symfony_Component_Finder_Adapter_AdapterInterface $adapter)
    {
        $finder = $this->buildFinder($adapter);
        $finder->in(dirname(__FILE__))
            ->directories()
     ...
     * @dataProvider getAdaptersTestData
     */
    public function testMultipleLocations(Symfony_Component_Finder_Adapter_AdapterInterface $adapter)
    {
        $locations = array(
            self::$tmpDir.'/',
            self::$tmpDir.'/toto/',
     ...
     * @dataProvider getAdaptersTestData
     */
    public function testIteratorKeys(Symfony_Component_Finder_Adapter_AdapterInterface $adapter)
    {
        $finder = $this->buildFinder($adapter)->in(self::$tmpDir);
    ...
    public function testAdaptersOrdering()
    {
        $finder = Symfony_Component_Finder_Finder::create()
            ->removeAdapters()
            ->addAdapter(new Symfony_Component_Finder_Tests_FakeAdapter_NamedAdapter('a'), 0)
            ->addAdapter(new Symfony_Component_Finder_Tests_FakeAdapter_NamedAdapter('b'), -50)
            ->addAdapter(new Symfony_Component_Finder_Tests_FakeAdapter_NamedAdapter('c'), 50)
            ->addAdapter(new Symfony_Component_Finder_Tests_FakeAdapter_NamedAdapter('d'), -25)
            ->addAdapter(new Symfony_Component_Finder_Tests_FakeAdapter_NamedAdapter('e'), 25);

        $this->assertEquals(
            array('c', 'e', 'a', 'd', 'b'),
            array_map(create_function('Symfony_Component_Finder_Adapter_AdapterInterface $adapter', '
    ...
    public function testAdaptersChaining()
    {
        ...
        foreach ($filenames as $file) {
            $iterator->append(new Symfony_Component_Finder_SplFileInfo($file, null, null));
        }

        $finder = Symfony_Component_Finder_Finder::create()
            ->removeAdapters()
            ->addAdapter(new Symfony_Component_Finder_Tests_FakeAdapter_UnsupportedAdapter(), 3)
            ->addAdapter(new Symfony_Component_Finder_Tests_FakeAdapter_FailingAdapter(), 2)
            ->addAdapter(new Symfony_Component_Finder_Tests_FakeAdapter_DummyAdapter($iterator), 1);
    ...
    {
        return array_map(
            create_function('$adapter', 'return array($adapter);'),
     ...
     */
    public function testPath(Symfony_Component_Finder_Adapter_AdapterInterface $adapter, $matchPatterns, $noMatchPatterns, array $expected)
    {
        $finder = $this->buildFinder($adapter);
        $finder->in(dirname(__FILE__).DIRECTORY_SEPARATOR.'Fixtures')
            ->path($matchPatterns)
    ...
    public function testAdapterSelection()
    {
        ...
        $adapters = Symfony_Component_Finder_Finder::create()->getAdapters();
        $this->assertTrue($adapters[0] instanceof Symfony_Component_Finder_Adapter_PhpAdapter);

        // test another adapter selection
// TODO $adapters = Symfony_Component_Finder_Finder::create()->setAdapter('gnu_find')->getAdapters();
// TODO $this->assertTrue($adapters[0] instanceof Symfony_Component_Finder_Adapter_GnuFindAdapter);

        // test that useBestAdapter method removes selection
// TODO $adapters = Symfony_Component_Finder_Finder::create()->useBestAdapter()->getAdapters();
// TODO $this->assertFalse($adapters[0] instanceof Symfony_Component_Finder_Adapter_PhpAdapter);
    }
    ...
    private function buildFinder(Symfony_Component_Finder_Adapter_AdapterInterface $adapter)
    {
        return Symfony_Component_Finder_Finder::create()
            ->removeAdapters()
            ->addAdapter($adapter);
    }
    ...
    private function getValidAdapters()
    {
        return array_filter(
            array(
// TODO         new Symfony_Component_Finder_Adapter_BsdFindAdapter(),
// TODO         new Symfony_Component_Finder_Adapter_GnuFindAdapter(),
                new Symfony_Component_Finder_Adapter_PhpAdapter()
            ),
            create_function('Symfony_Component_Finder_Adapter_AdapterInterface $adapter', '
