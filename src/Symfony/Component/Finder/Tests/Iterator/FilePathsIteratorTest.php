...
class Symfony_Component_Finder_Tests_Iterator_FilePathsIteratorTest extends Symfony_Component_Finder_Tests_Iterator_RealIteratorTestCase
{
    /**
    ...
    {
        $iterator = new Symfony_Component_Finder_Iterator_FilePathsIterator($paths, $baseDir);
