...
class Symfony_Component_Finder_Tests_Iterator_PathFilterIteratorTest extends Symfony_Component_Finder_Tests_Iterator_IteratorTestCase
{
    ...
    {
        $iterator = new Symfony_Component_Finder_Iterator_PathFilterIterator($inner, $matchPatterns, $noMatchPatterns);
