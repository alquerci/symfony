...
class Symfony_Component_Finder_Tests_Iterator_MultiplePcreFilterIteratorTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $testIterator = new Symfony_Component_Finder_Tests_Iterator_TestMultiplePcreFilterIterator();
...
class Symfony_Component_Finder_Tests_Iterator_TestMultiplePcreFilterIterator extends Symfony_Component_Finder_Iterator_MultiplePcreFilterIterator
{
