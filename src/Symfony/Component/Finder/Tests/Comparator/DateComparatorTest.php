...
class Symfony_Component_Finder_Tests_Comparator_DateComparatorTest extends PHPUnit_Framework_TestCase
{
    public function testConstructor()
    {
        try {
            new Symfony_Component_Finder_Comparator_DateComparator('foobar');
        ...
        try {
            new Symfony_Component_Finder_Comparator_DateComparator('');
            $this->fail('__construct() throws an InvalidArgumentException if the test expression is not valid.');
        } catch (Exception $e) {
            $this->assertInstanceOf('InvalidArgumentException', $e, '__construct() throws an InvalidArgumentException if the test expression is not valid.');
        }
    ...
    {
        $c = new Symfony_Component_Finder_Comparator_DateComparator($test);
