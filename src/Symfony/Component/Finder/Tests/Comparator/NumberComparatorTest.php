...
class Symfony_Component_Finder_Tests_Comparator_NumberComparatorTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testConstructor($successes, $failures)
    {
        foreach ($successes as $s) {
            new Symfony_Component_Finder_Comparator_NumberComparator($s);
        }

        foreach ($failures as $f) {
            try {
                new Symfony_Component_Finder_Comparator_NumberComparator($f);
    ...
    {
        $c = new Symfony_Component_Finder_Comparator_NumberComparator($test);
