 ...
 */
class Symfony_Component_Finder_Iterator_FilePathsIterator extends ArrayIterator
{
    /**
     * @var string
     */
    ...
    /**
     * @var Symfony_Component_Finder_SplFileInfo
     */
    private $current;
    ...
    private function buildProperties()
    {
        ...
        $this->current = new Symfony_Component_Finder_SplFileInfo(parent::current(), $this->subPath, $this->subPathname);
    }
}
