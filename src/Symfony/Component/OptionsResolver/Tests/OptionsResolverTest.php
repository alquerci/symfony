...
class Symfony_Component_OptionsResolver_Tests_OptionsResolverTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->resolver = new Symfony_Component_OptionsResolver_OptionsResolver();
    }
    ...
    /**
     * @expectedException Symfony_Component_OptionsResolver_Exception_MissingOptionsException
     */
