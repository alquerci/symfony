 ...
 */
interface Symfony_Component_OptionsResolver_OptionsResolverInterface
{
    /**
     ...
     *
     * @return Symfony_Component_OptionsResolver_OptionsResolverInterface The resolver instance.
     */
     ...
     * @return Symfony_Component_OptionsResolver_OptionsResolverInterface The resolver instance.
     *
     * @throws Symfony_Component_OptionsResolver_Exception_OptionDefinitionException When trying to pass default values.
     */
     ...
     * @return Symfony_Component_OptionsResolver_OptionsResolverInterface The resolver instance.
     *
     * @throws Symfony_Component_OptionsResolver_Exception_InvalidOptionsException If an option has not been defined
     ...
     * @return Symfony_Component_OptionsResolver_OptionsResolverInterface The resolver instance.
     *
     * @throws Symfony_Component_OptionsResolver_Exception_InvalidOptionsException If an option has not been defined for
     ...
     *
     * @throws Symfony_Component_OptionsResolver_Exception_InvalidOptionsException   If any of the passed options has not
