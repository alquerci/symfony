 ...
 */
class Symfony_Component_OptionsResolver_Options implements ArrayAccess, Iterator, Countable
{
    /**
     ...
     *
     * <code>
     * function (Symfony_Component_OptionsResolver_Options $options)
     * </code>
     *
    ...
    public function set($option, $value)
    {
        ...
        if ($this->reading) {
            throw new Symfony_Component_OptionsResolver_Exception_OptionDefinitionException('Options cannot be set anymore once options have been read.');
        }
     ...
     *
     * <code>
     * function (Symfony_Component_OptionsResolver_Options $options, $value)
     * </code>
     *
     * This closure will be evaluated once the option is read using
     * {@link get()}. The closure has access to the resolved values of
    ...
    {
        if ($this->reading) {
            throw new Symfony_Component_OptionsResolver_Exception_OptionDefinitionException('Options cannot be replaced anymore once options have been read.');
        }
    ...
    {
        if ($this->reading) {
            throw new Symfony_Component_OptionsResolver_Exception_OptionDefinitionException('Options cannot be overloaded anymore once options have been read.');
        }
     ...
     * @throws Symfony_Component_OptionsResolver_Exception_OptionDefinitionException If a cyclic dependency is detected
    ...
    {
        if ($this->reading) {
            throw new Symfony_Component_OptionsResolver_Exception_OptionDefinitionException('Options cannot be removed anymore once options have been read.');
        }
    ...
    {
        if ($this->reading) {
            throw new Symfony_Component_OptionsResolver_Exception_OptionDefinitionException('Options cannot be cleared anymore once options have been read.');
        }
     ...
     *
     * @throws Symfony_Component_OptionsResolver_Exception_OptionDefinitionException If the option has a cyclic dependency
     *                                   on another option.
     */
    private function resolve($option)
    {
        ...
        if (isset($this->lock[$option])) {
            ...
            throw new Symfony_Component_OptionsResolver_Exception_OptionDefinitionException('The options "' . implode('", "', $conflicts) . '" have a cyclic dependency.');
        }
