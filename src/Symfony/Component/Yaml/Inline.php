...
class Symfony_Component_Yaml_Inline
{
     ...
     *
     * @throws Symfony_Component_Yaml_Exception_ParseException
     */
    public static function parse($value, $exceptionOnInvalidType = false, $objectSupport = false)
    {
        ...
        if (preg_replace('/\s+#.*$/A', '', substr($value, $i))) {
            throw new Symfony_Component_Yaml_Exception_ParseException(sprintf('Unexpected characters near "%s".', substr($value, $i)));
        }
     ...
     *
     * @throws Symfony_Component_Yaml_Exception_DumpException When trying to dump PHP resource
     */
    public static function dump($value, $exceptionOnInvalidType = false, $objectSupport = false)
    {
        switch (true) {
            ...
            case is_object($value):
                ...
                if ($exceptionOnInvalidType) {
                    throw new Symfony_Component_Yaml_Exception_DumpException('Object support when dumping a YAML file has been disabled.');
                }
     ...
     *
     * @throws Symfony_Component_Yaml_Exception_ParseException When malformed inline YAML string is parsed
     */
        ...
        if (in_array($scalar[$i], $stringDelimiters)) {
            ...
            if (null !== $delimiters) {
                ...
                if (!in_array($tmp[0], $delimiters)) {
                    throw new Symfony_Component_Yaml_Exception_ParseException(sprintf('Unexpected characters (%s).', substr($scalar, $i)));
                }
            }
        } else {
            // "normal" string
        ...
        switch (true) {
            ...
            case 0 === strpos($scalar, '!!php/object:'):
                ...
                if (self::$exceptionOnInvalidType) {
                    throw new Symfony_Component_Yaml_Exception_ParseException('Object support when parsing a YAML file has been disabled.');
                }
