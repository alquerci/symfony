...
class Symfony_Component_Yaml_Tests_InlineTest extends PHPUnit_Framework_TestCase
{
    public function testParse()
    {
        foreach ($this->getTestsForParse() as $yaml => $value) {
            $this->assertSame($value, Symfony_Component_Yaml_Inline::parse($yaml), sprintf('::parse() converts an inline YAML to a PHP structure (%s)', $yaml));
        }
    }
    ...
    public function testParseScalarWithIncorrectlyQuotedStringShouldThrowException()
    {
        ...
        Symfony_Component_Yaml_Inline::parse($value);
    }
    ...
    {
        Symfony_Component_Yaml_Inline::parse('[foo] bar');
    }
    ...
    {
        Symfony_Component_Yaml_Inline::parse('{ foo: bar } bar');
    }
