 ...
 * @api
 */
class Symfony_Component_Filesystem_Exception_IOException extends RuntimeException implements Symfony_Component_Filesystem_Exception_ExceptionInterface
{
    /**
     * @var Exception
     */
