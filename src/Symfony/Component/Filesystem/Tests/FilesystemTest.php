...
/**
 * Test class for Symfony_Component_Filesystem_Filesystem.
 */
class Symfony_Component_Filesystem_Tests_FilesystemTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    /**
     * @var Symfony_Component_Filesystem_Filesystem $filesystem
     */
    ...
    {
        $this->filesystem = new Symfony_Component_Filesystem_Filesystem();
    ...
    /**
     * @expectedException Symfony_Component_Filesystem_Exception_IOException
     */
