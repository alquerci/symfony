...
class Symfony_Component_Templating_Loader_FilesystemLoader extends Symfony_Component_Templating_Loader_Loader
{
     ...
     *
     * @return Symfony_Component_Templating_Storage_Storage|Boolean false if the template cannot be loaded, a Symfony_Component_Templating_Storage_Storage instance otherwise
     *
     * @api
     */
