...
class Symfony_Component_Templating_Tests_Helper_SlotsHelperTest extends PHPUnit_Framework_TestCase
{
    public function testHasGetSet()
    {
        $helper = new Symfony_Component_Templating_Helper_SlotsHelper();
        $helper->set('foo', 'bar');
