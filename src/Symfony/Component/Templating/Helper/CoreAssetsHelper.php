...
class Symfony_Component_Templating_Helper_CoreAssetsHelper extends Symfony_Component_Templating_Helper_Helper implements Symfony_Component_Templating_Asset_PackageInterface
{
     ...
     * Constructor.
     *
     * @param Symfony_Component_Templating_Asset_PackageInterface $defaultPackage The default package
     ...
     * @param Symfony_Component_Templating_Asset_PackageInterface $package The package
     */
     ...
     *
     * @return Symfony_Component_Templating_Asset_PackageInterface An asset package
     *
