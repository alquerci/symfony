...
class Symfony_Component_Templating_PhpEngine implements Symfony_Component_Templating_EngineInterface, ArrayAccess
{
     ...
     *
     * @param Symfony_Component_Templating_Storage_Storage $template   The template to render
     * @param array   $parameters An array of parameters to pass to the template
     *
     ...
     * Sets a helper.
     *
     * @param Symfony_Component_Templating_Helper_HelperInterface $name  The helper instance
     ...
     * Adds some helpers.
     *
     * @param Symfony_Component_Templating_Helper_HelperInterface[] $helpers An array of helper
     *
     * @api
     */
     ...
     * Sets a helper.
     *
     * @param Symfony_Component_Templating_Helper_HelperInterface $helper The helper instance
     ...
     * @param string $name The helper name
     *
     * @return Symfony_Component_Templating_Helper_HelperInterface The helper instance
     *
     * @throws InvalidArgumentException if the helper is not defined
     *
     * @api
    ...
    protected function initializeEscapers()
    {
        ...
        $this->escapers = array(
            'html' => array($this, '_initializeEscapersCBhtml'),
            'js'   => array($this, '_initializeEscapersCBjs'),
        );
     ...
     * @return string the escaped value
     */
    public function _initializeEscapersCBhtml($value)
    {
     ...
     * @return string the escaped value
     */
    public function _initializeEscapersCBjs($value)
    {
        if ('UTF-8' != $this->getCharset()) {
            $value = $this->convertEncoding($value, 'UTF-8', $this->getCharset());
        }

        $callback = array($this, '_initializeEscapersCBjsCB');
    ...
    private function _initializeEscapersCBjsCB($matches)
    {
        $char = $matches[0];
     ...
     *
     * @return Symfony_Component_Templating_Loader_LoaderInterface A LoaderInterface instance
     */
     ...
     * @param mixed $name A template name or a TemplateReferenceInterface instance
     *
     * @return Symfony_Component_Templating_Storage_Storage A Storage instance
     *
