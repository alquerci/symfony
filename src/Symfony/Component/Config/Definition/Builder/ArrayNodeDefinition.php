...
class Symfony_Component_Config_Definition_Builder_ArrayNodeDefinition extends Symfony_Component_Config_Definition_Builder_NodeDefinition implements Symfony_Component_Config_Definition_Builder_ParentNodeDefinitionInterface
{
     ...
     *
     * @param Symfony_Component_Config_Definition_Builder_NodeBuilder $builder A custom NodeBuilder
     */
     ...
     *
     * @return Symfony_Component_Config_Definition_Builder_NodeBuilder
     */
     ...
     *
     * @return Symfony_Component_Config_Definition_Builder_ArrayNodeDefinition
     */
     ...
     *
     *     $node = new Symfony_Component_Config_Definition_Builder_ArrayNodeDefinition()
     *         ->children()
     *             ->scalarNode('foo')->end()
     *             ->scalarNode('baz')->end()
     *         ->end()
     ...
     *     ;
     *
     * @param Symfony_Component_Config_Definition_Builder_NodeDefinition $node A NodeDefinition instance
     *
     * @return Symfony_Component_Config_Definition_Builder_ArrayNodeDefinition This node
     */
     ...
     *
     * @return Symfony_Component_Config_Definition_Builder_NodeBuilder The node builder
     */
    protected function getNodeBuilder()
    {
        if (null === $this->nodeBuilder) {
            $this->nodeBuilder = new Symfony_Component_Config_Definition_Builder_NodeBuilder();
        }
    ...
    protected function createNode()
    {
        if (null === $this->prototype) {
            $node = new Symfony_Component_Config_Definition_ArrayNode($this->name, $this->parent);
            ...
            $node = new Symfony_Component_Config_Definition_PrototypedArrayNode($this->name, $this->parent);
            ...
            if (false !== $this->addDefaultChildren) {
                ...
                if ($this->prototype instanceof $this && null === $this->prototype->prototype) {
     ...
     *
     * @param Symfony_Component_Config_Definition_ArrayNode $node The related node
     *
     * @throws Symfony_Component_Config_Definition_Exception_InvalidDefinitionException
     */
    protected function validateConcreteNode(Symfony_Component_Config_Definition_ArrayNode $node)
    {
        $path = $node->getPath();

        if (null !== $this->key) {
            throw new Symfony_Component_Config_Definition_Exception_InvalidDefinitionException(
     ...
     *
     * @param Symfony_Component_Config_Definition_PrototypedArrayNode $node The related node
     *
     * @throws Symfony_Component_Config_Definition_Exception_InvalidDefinitionException
     */
    protected function validatePrototypeNode(Symfony_Component_Config_Definition_PrototypedArrayNode $node)
    {
        $path = $node->getPath();
