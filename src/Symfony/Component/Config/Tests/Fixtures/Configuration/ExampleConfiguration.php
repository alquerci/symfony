...
class Symfony_Component_Config_Tests_Fixtures_Configuration_ExampleConfiguration implements Symfony_Component_Config_Definition_ConfigurationInterface
{
