...
class Symfony_Component_Config_Tests_Definition_NormalizerTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function getEncoderTests()
    {
        ...
        return array_map(create_function('$v', '
            return array($v);
        '), $configs);
    }
    ...
    public function getAnonymousKeysTests()
    {
        ...
        return array_map(create_function('$v', 'return array($v);'), $configs);
    }
    ...
    public static function assertNormalized(Symfony_Component_Config_Definition_NodeInterface $tree, $denormalized, $normalized)
    {
