...
class Symfony_Component_Config_Tests_Definition_Builder_ExprBuilderTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testIfTrueExpression()
    {
        ...
        $test = $this->getTestBuilder()
            ->ifTrue(create_function('$v', 'return true;'))
            ->then($this->returnClosure('new_value'))
        ->end();
        $this->assertFinalizedValueIs('new_value', $test);

        $test = $this->getTestBuilder()
            ->ifTrue(create_function('$v', 'return false;'))
            ->then($this->returnClosure('new_value'))
        ->end();
     ...
     * @return Symfony_Component_Config_Definition_Builder_TreeBuilder
     */
     ...
     * @param Symfony_Component_Config_Definition_Builder_TreeBuilder $testBuilder The tree builder to finalize
     ...
     * @param Symfony_Component_Config_Definition_Builder_TreeBuilder $treeBuilder The tree builder to finalize
