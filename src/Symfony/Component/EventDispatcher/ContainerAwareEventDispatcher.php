 ...
 */
class Symfony_Component_EventDispatcher_ContainerAwareEventDispatcher extends Symfony_Component_EventDispatcher_EventDispatcher
{
    /**
    ...
    {
        foreach (call_user_func(array($class, 'getSubscribedEvents')) as $eventName => $params) {
            if (is_string($params)) {
