...
/**
 * Symfony_Component_Form_Form represents a form.
 *
 ...
 */
class Symfony_Component_Form_Form implements IteratorAggregate, Symfony_Component_Form_FormInterface
{
    /**
     * The form's configuration
     * @var Symfony_Component_Form_FormConfigInterface
     */
    private $config;
     ...
     * @var Symfony_Component_Form_FormInterface[] An array of Symfony_Component_Form_FormInterface instances
     */
    private $children = array();

    /**
     * The errors of this form
     * @var Symfony_Component_Form_FormError[] An array of Symfony_Component_Form_FormError instances
     */
     ...
     *
     * @param Symfony_Component_Form_FormConfigInterface $config The form configuration.
     *
     * @throws Symfony_Component_Form_FormException if a data mapper is not provided for a compound form
     */
    public function __construct(Symfony_Component_Form_FormConfigInterface $config)
    {
        ...
        if ($config->getCompound() && !$config->getDataMapper()) {
            throw new Symfony_Component_Form_Exception_Exception('Compound forms need a data mapper');
        }
    ...
    public function getPropertyPath()
    {
        ...
        if ($this->parent && null === $this->parent->getConfig()->getDataClass()) {
            return new Symfony_Component_PropertyAccess_PropertyPath('[' . $this->getName() . ']');
        }
     ...
     *             {@link getConfig()} and {@link Symfony_Component_Form_FormConfigInterface::getType()} instead.
     */
    ...
    {
        if ($this->bound) {
            throw new Symfony_Component_Form_Exception_AlreadyBoundException('You cannot set the parent of a bound form');
        }

        if (null !== $parent && '' === $this->config->getName()) {
            throw new Symfony_Component_Form_Exception_Exception('A form with an empty name cannot have a parent form.');
        }
     ...
     *
     * @deprecated Deprecated since version 2.1, to be removed in 2.3. Use
     *             {@link getConfig()} and {@link Symfony_Component_Form_FormConfigInterface::hasAttribute()} instead.
     */
     ...
     *
     * @deprecated Deprecated since version 2.1, to be removed in 2.3. Use
     *             {@link getConfig()} and {@link Symfony_Component_Form_FormConfigInterface::getAttribute()} instead.
     */
    ...
    public function setData($modelData)
    {
        ...
        if ($this->bound && $this->initialized) {
            throw new Symfony_Component_Form_Exception_AlreadyBoundException('You cannot change the data of a bound form');
        }
        ...
        if ($this->lockSetData) {
            throw new Symfony_Component_Form_Exception_Exception('A cycle was detected. Listeners to the PRE_SET_DATA event must not call setData(). You should call setData() on the FormEvent object instead.');
        }
        ...
        if ($dispatcher->hasListeners(Symfony_Component_Form_FormEvents::PRE_SET_DATA) || $dispatcher->hasListeners(Symfony_Component_Form_FormEvents::SET_DATA)) {
            $event = new Symfony_Component_Form_FormEvent($this, $modelData);
        ...
        if (!Symfony_Component_Form_Util_FormUtil::isEmpty($viewData)) {
            ...
            if (null === $dataClass && is_object($viewData) && !$viewData instanceof ArrayAccess) {
                ...
                throw new Symfony_Component_Form_Exception_Exception(
        ...
        if ($dispatcher->hasListeners(Symfony_Component_Form_FormEvents::POST_SET_DATA)) {
            $event = new Symfony_Component_Form_FormEvent($this, $modelData);
            $dispatcher->dispatch(Symfony_Component_Form_FormEvents::POST_SET_DATA, $event);
        }
    ...
    {
        if ($this->bound) {
            throw new Symfony_Component_Form_Exception_AlreadyBoundException('A form can only be bound once');
        }
        ...
        if ($dispatcher->hasListeners(Symfony_Component_Form_FormEvents::PRE_BIND) || $dispatcher->hasListeners(Symfony_Component_Form_FormEvents::BIND_CLIENT_DATA)) {
            $event = new Symfony_Component_Form_FormEvent($this, $submittedData);
        ...
        try {
            ...
            // representation
            if ($dispatcher->hasListeners(Symfony_Component_Form_FormEvents::BIND) || $dispatcher->hasListeners(Symfony_Component_Form_FormEvents::BIND_NORM_DATA)) {
                $event = new Symfony_Component_Form_FormEvent($this, $normData);
            ...
            $viewData = $this->normToView($normData);
        } catch (Symfony_Component_Form_Exception_TransformationFailedException $e) {
        ...
        if ($dispatcher->hasListeners(Symfony_Component_Form_FormEvents::POST_BIND)) {
            $event = new Symfony_Component_Form_FormEvent($this, $viewData);
            $dispatcher->dispatch(Symfony_Component_Form_FormEvents::POST_BIND, $event);
        }
     ...
     *
     * @param Symfony_Component_HttpFoundation_Request $request The request to bind to the form
     *
     * @return Symfony_Component_Form_Form This form
     *
     * @throws Symfony_Component_Form_FormException if the method of the request is not one of GET, POST or PUT
     *
     * @deprecated Deprecated since version 2.1, to be removed in 2.3. Use
     *             {@link Symfony_Component_Form_FormConfigInterface::bind()} instead.
     */
     ...
     *
     * @deprecated Deprecated since version 2.1, to be removed in 2.3. Use
     *             {@link getConfig()} and {@link Symfony_Component_Form_FormConfigInterface::getErrorBubbling()} instead.
     */
    ...
    public function isEmpty()
    {
        ...
        return Symfony_Component_Form_Util_FormUtil::isEmpty($this->modelData) ||
            // arrays, countables
     ...
     *
     * @return Symfony_Component_Form_DataTransformerInterface[] An array of Symfony_Component_Form_DataTransformerInterface
     *
     * @deprecated Deprecated since version 2.1, to be removed in 2.3. Use
     *             {@link getConfig()} and {@link Symfony_Component_Form_FormConfigInterface::getModelTransformers()} instead.
     */
     ...
     *
     * @deprecated Deprecated since version 2.1, to be removed in 2.3. Use
     *             {@link getConfig()} and {@link Symfony_Component_Form_FormConfigInterface::getViewTransformers()} instead.
     */
    ...
    {
        if ($this->bound) {
            throw new Symfony_Component_Form_Exception_AlreadyBoundException('You cannot add children to a bound form');
        }

        if (!$this->config->getCompound()) {
            throw new Symfony_Component_Form_Exception_Exception('You cannot add children to a simple form. Maybe you should set the option "compound" to true?');
        }
        ...
        if (!$child instanceof Symfony_Component_Form_FormInterface) {
            if (!is_string($child) && !is_int($child)) {
                throw new Symfony_Component_Form_Exception_UnexpectedTypeException($child, 'string, integer or Symfony_Component_Form_FormInterface');
            }
    ...
    {
        if ($this->bound) {
            throw new Symfony_Component_Form_Exception_AlreadyBoundException('You cannot remove children from a bound form');
        }
     ...
     * @param Symfony_Component_Form_FormInterface $child The child to be added.
     *
     * @throws Symfony_Component_Form_Exception_AlreadyBoundException If the form has already been bound.
     * @throws Symfony_Component_Form_FormException         When trying to add a child to a non-compound form.
     *
     * @see self::add()
     */
