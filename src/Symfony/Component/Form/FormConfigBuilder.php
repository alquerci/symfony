 ...
 */
class Symfony_Component_Form_FormConfigBuilder implements Symfony_Component_Form_FormConfigBuilderInterface
{
    /**
     * @var Boolean
     */
     ...
     * @param Symfony_Component_EventDispatcher_EventDispatcherInterface $dispatcher The event dispatcher
     * @param array                    $options    The form options
     *
     * @throws InvalidArgumentException If the data class is not a valid class or if
     *                                   the name contains invalid characters.
     */
    public function __construct($name, $dataClass, Symfony_Component_EventDispatcher_EventDispatcherInterface $dispatcher, array $options = array())
    {
     ...
     *
     * @return Symfony_Component_Form_FormConfigBuilder The configuration object.
     *
     * @throws Symfony_Component_Form_Exception_BadMethodCallException if the form configuration is locked
     *
    ...
    public function setPropertyPath($propertyPath)
    {
        ...
        if (null !== $propertyPath && !$propertyPath instanceof Symfony_Component_PropertyAccess_PropertyPathInterface) {
    ...
    public function getFormConfig()
    {
        ...
        if (!$config->dispatcher instanceof Symfony_Component_EventDispatcher_ImmutableEventDispatcher) {
            $config->dispatcher = new Symfony_Component_EventDispatcher_ImmutableEventDispatcher($config->dispatcher);
        }
     ...
     *
     * @throws Symfony_Component_Form_Exception_UnexpectedTypeException   If the name is not a string or an integer.
     * @throws InvalidArgumentException If the name contains invalid characters.
     */
    public static function validateName($name)
    {
        if (null !== $name && !is_string($name) && !is_int($name)) {
            throw new Symfony_Component_Form_Exception_UnexpectedTypeException($name, 'string, integer or null');
        }
