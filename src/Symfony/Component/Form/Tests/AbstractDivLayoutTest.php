...
abstract class Symfony_Component_Form_Tests_AbstractDivLayoutTest extends Symfony_Component_Form_Tests_AbstractLayoutTest
{
    public function testRow()
    {
        $form = $this->factory->createNamed('name', 'text');
        $form->addError(new Symfony_Component_Form_FormError('[trans]Error![/trans]'));
...
'
    ...
    public function testCollectionWithAlternatingRowTypes()
    {
        ...
        $form = $this->factory->createNamed('name', 'collection', $data, array(
            'type' => new Symfony_Component_Form_Tests_Fixtures_AlternatingRowType(),
        ));
...
'
    ...
    public function testNestedFormError()
    {
        ...
        $form->get('child')->addError(new Symfony_Component_Form_FormError('[trans]Error![/trans]'));
