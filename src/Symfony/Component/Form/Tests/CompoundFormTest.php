...
class Symfony_Component_Form_Tests_CompoundFormTest extends Symfony_Component_Form_Tests_AbstractFormTest
{
    ...
    public function testBindPostOrPutRequest($method)
    {
        ...
        $form = $this->getBuilder('author')
            ->setCompound(true)
            ->setDataMapper($this->getDataMapper())
            ->addEventSubscriber(new Symfony_Component_Form_Extension_HttpFoundation_EventListener_BindRequestListener())
            ->getForm();
        ...
        $file = new Symfony_Component_HttpFoundation_File_UploadedFile($path, 'upload.png', 'image/png', 123, UPLOAD_ERR_OK);
    ...
    public function testBindPostOrPutRequestWithSingleChildForm($method)
    {
        ...
        $request = new Symfony_Component_HttpFoundation_Request(array(), array(), array(), array(), $files, array(
            'REQUEST_METHOD' => $method,
        ));
    ...
    public function testBindPostOrPutRequestWithSingleChildFormUploadedFile($method)
    {
        ...
        $request = new Symfony_Component_HttpFoundation_Request(array(), $values, array(), array(), array(), array(
            'REQUEST_METHOD' => $method,
        ));
