 ...
 */
class Symfony_Component_Form_Tests_Extension_Csrf_CsrfProvider_DefaultCsrfProviderTest extends PHPUnit_Framework_TestCase
{
    protected $provider;
    ...
    {
        $this->provider = new Symfony_Component_Form_Extension_Csrf_CsrfProvider_DefaultCsrfProvider('SECRET');
    }
