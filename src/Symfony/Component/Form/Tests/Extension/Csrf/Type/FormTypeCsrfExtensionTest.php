...
class Symfony_Component_Form_Tests_Extension_Csrf_Type_FormTypeCsrfExtensionTest_ChildType extends Symfony_Component_Form_AbstractType
{
...
class Symfony_Component_Form_Tests_Extension_Csrf_Type_FormTypeCsrfExtensionTest extends Symfony_Component_Form_Tests_Extension_Core_Type_TypeTestCase
{
    ...
    public function testNoCsrfProtectionOnPrototype()
    {
        $prototypeView = $this->factory
            ->create('collection', null, array(
                'type' => new Symfony_Component_Form_Tests_Extension_Csrf_Type_FormTypeCsrfExtensionTest_ChildType(),
                'options' => array(
                    'csrf_field_name' => 'csrf',
                ),
                'prototype' => true,
