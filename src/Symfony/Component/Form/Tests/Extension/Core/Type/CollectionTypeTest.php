...
class Symfony_Component_Form_Tests_Extension_Core_Type_CollectionTypeTest extends Symfony_Component_Form_Tests_Extension_Core_Type_TypeTestCase
{
    ...
    public function testSetDataAdjustsSize()
    {
        ...
        $this->assertInstanceOf('Symfony_Component_Form_Form', $form[0]);
        $this->assertInstanceOf('Symfony_Component_Form_Form', $form[1]);
