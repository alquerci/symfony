...
class Symfony_Component_Form_Tests_Extension_Core_Type_ChoiceTypeTest extends Symfony_Component_Form_Tests_Extension_Core_Type_TypeTestCase
{
    ...
    /**
     * @expectedException Symfony_Component_OptionsResolver_Exception_InvalidOptionsException
     */
    ...
    public function testBindSingleNonExpandedObjectChoices()
    {
        $form = $this->factory->create('choice', null, array(
            'multiple' => false,
            'expanded' => false,
            'choice_list' => new Symfony_Component_Form_Extension_Core_ChoiceList_ObjectChoiceList(
                $this->objectChoices,
                // label path
                'name',
                array(),
    ...
    public function testPassChoicesToView()
    {
        ...
        $this->assertEquals(array(
            new Symfony_Component_Form_Extension_Core_View_ChoiceView('a', 'a', 'A'),
            new Symfony_Component_Form_Extension_Core_View_ChoiceView('b', 'b', 'B'),
            new Symfony_Component_Form_Extension_Core_View_ChoiceView('c', 'c', 'C'),
            new Symfony_Component_Form_Extension_Core_View_ChoiceView('d', 'd', 'D'),
        ), $view->vars['choices']);
    }
    ...
    public function testPassPreferredChoicesToView()
    {
        ...
        $this->assertEquals(array(
            0 => new Symfony_Component_Form_Extension_Core_View_ChoiceView('a', 'a', 'A'),
            2 => new Symfony_Component_Form_Extension_Core_View_ChoiceView('c', 'c', 'C'),
        ), $view->vars['choices']);
        $this->assertEquals(array(
            1 => new Symfony_Component_Form_Extension_Core_View_ChoiceView('b', 'b', 'B'),
            3 => new Symfony_Component_Form_Extension_Core_View_ChoiceView('d', 'd', 'D'),
    ...
    public function testPassHierarchicalChoicesToView()
    {
        ...
        $this->assertEquals(array(
            'Symfony' => array(
                0 => new Symfony_Component_Form_Extension_Core_View_ChoiceView('a', 'a', 'Bernhard'),
                2 => new Symfony_Component_Form_Extension_Core_View_ChoiceView('c', 'c', 'Kris'),
            ),
            'Doctrine' => array(
                4 => new Symfony_Component_Form_Extension_Core_View_ChoiceView('e', 'e', 'Roman'),
            ),
        ), $view->vars['choices']);
        $this->assertEquals(array(
            'Symfony' => array(
                1 => new Symfony_Component_Form_Extension_Core_View_ChoiceView('b', 'b', 'Fabien'),
            ),
            'Doctrine' => array(
                3 => new Symfony_Component_Form_Extension_Core_View_ChoiceView('d', 'd', 'Jon'),
            ),
        ), $view->vars['preferred_choices']);
    }
    ...
    public function testPassChoiceDataToView()
    {
        ...
        $form = $this->factory->create('choice', null, array(
            'choice_list' => new Symfony_Component_Form_Extension_Core_ChoiceList_ObjectChoiceList(array($obj1, $obj2, $obj3, $obj4), 'label', array(), null, 'value'),
        ));
        $view = $form->createView();

        $this->assertEquals(array(
            new Symfony_Component_Form_Extension_Core_View_ChoiceView($obj1, 'a', 'A'),
            new Symfony_Component_Form_Extension_Core_View_ChoiceView($obj2, 'b', 'B'),
            new Symfony_Component_Form_Extension_Core_View_ChoiceView($obj3, 'c', 'C'),
            new Symfony_Component_Form_Extension_Core_View_ChoiceView($obj4, 'd', 'D'),
        ), $view->vars['choices']);
    }
