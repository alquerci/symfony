...
class Symfony_Component_Form_Tests_Extension_Core_Type_FormTest_AuthorWithoutRefSetter
{
    protected $reference;
...
class Symfony_Component_Form_Tests_Extension_Core_Type_FormTypeTest extends Symfony_Component_Form_Tests_Extension_Core_Type_TypeTestCase
{
    ...
    public function testBindWithEmptyDataCreatesObjectIfClassAvailable()
    {
        ...
        $author = new Symfony_Component_Form_Tests_Fixtures_Author();
    ...
    public function testBindWithEmptyDataCreatesObjectIfInitiallyBoundWithObject()
    {
        $form = $this->factory->create('form', null, array(
            ...
            'data' => new Symfony_Component_Form_Tests_Fixtures_Author(),
            'required' => false,
        ));
        $form->add($this->factory->createNamed('firstName', 'text'));
        $form->add($this->factory->createNamed('lastName', 'text'));
    ...
    public function testBindEmptyWithEmptyDataCreatesObjectIfRequired()
    {
        ...
        $this->assertEquals(new Symfony_Component_Form_Tests_Fixtures_Author(), $form->getData());
    }
    ...
    {
        $author = new Symfony_Component_Form_Tests_Extension_Core_Type_FormTest_AuthorWithoutRefSetter(new Symfony_Component_Form_Tests_Fixtures_Author());
    ...
    {
        // no reference
        $author = new Symfony_Component_Form_Tests_Extension_Core_Type_FormTest_AuthorWithoutRefSetter(null);
        $newReference = new Symfony_Component_Form_Tests_Fixtures_Author();
    ...
    {
        $author = new Symfony_Component_Form_Tests_Extension_Core_Type_FormTest_AuthorWithoutRefSetter('scalar');
    ...
    {
        $ref1 = new Symfony_Component_Form_Tests_Fixtures_Author();
        $ref2 = new Symfony_Component_Form_Tests_Fixtures_Author();
    ...
    public function testPropertyPath()
    {
        ...
        $this->assertEquals(new Symfony_Component_PropertyAccess_PropertyPath('foo'), $form->getPropertyPath());
    ...
    public function testViewNotValidBound()
    {
        $form = $this->factory->create('form');
        $form->bind(array());
        $form->addError(new Symfony_Component_Form_FormError('An error'));
        $view = $form->createView();
