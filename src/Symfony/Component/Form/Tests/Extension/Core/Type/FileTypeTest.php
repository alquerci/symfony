...
class Symfony_Component_Form_Tests_Extension_Core_Type_FileTypeTest extends Symfony_Component_Form_Tests_Extension_Core_Type_TypeTestCase
{
    ...
    {
        $file = $this
            ->getMockBuilder('Symfony_Component_HttpFoundation_File_UploadedFile')
