...
class Symfony_Component_Form_Tests_Extension_Core_Type_DateTypeTest extends Symfony_Component_Form_Tests_Extension_Core_Type_LocalizedTestCase
{
    ...
    public function testYearsOption()
    {
        ...
        $this->assertEquals(array(
            new Symfony_Component_Form_Extension_Core_View_ChoiceView('2010', '2010', '2010'),
            new Symfony_Component_Form_Extension_Core_View_ChoiceView('2011', '2011', '2011'),
    ...
    {
        $error = new Symfony_Component_Form_FormError('Invalid!');
        $form = $this->factory->create('date', null, array(
            'widget' => $widget,
        ));
