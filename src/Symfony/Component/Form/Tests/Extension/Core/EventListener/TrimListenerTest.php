...
class Symfony_Component_Form_Tests_Extension_Core_EventListener_TrimListenerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testTrim()
    {
        ...
        $filter = new Symfony_Component_Form_Extension_Core_EventListener_TrimListener();
