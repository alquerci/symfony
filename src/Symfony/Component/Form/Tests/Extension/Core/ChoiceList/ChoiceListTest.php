...
class Symfony_Component_Form_Tests_Extension_Core_ChoiceList_ChoiceListTest extends PHPUnit_Framework_TestCase
{
    private $obj1;
    ...
    protected function setUp()
    {
        ...
        $this->list = new Symfony_Component_Form_Extension_Core_ChoiceList_ChoiceList(
            array(
    ...
    public function testInitNestedTraversable()
    {
        ...
        $this->assertEquals(array(
            'Group' => array(1 => new Symfony_Component_Form_Extension_Core_View_ChoiceView($this->obj2, '1', 'B'))
        ), $this->list->getPreferredViews());
        $this->assertEquals(array(
            'Group' => array(0 => new Symfony_Component_Form_Extension_Core_View_ChoiceView($this->obj1, '0', 'A')),
            2 => new Symfony_Component_Form_Extension_Core_View_ChoiceView($traversableChoice, '2', 'C')
    ...
    public function testLabelsContainingNull()
    {
        ...
        $this->assertEquals(
            array(0 => new Symfony_Component_Form_Extension_Core_View_ChoiceView($this->obj1, '0', 'A'), 1 => new Symfony_Component_Form_Extension_Core_View_ChoiceView($this->obj2, '1', null)),
            $this->list->getRemainingViews()
        );
    }
}
