...
class Symfony_Component_Form_Tests_Extension_Core_ChoiceList_SimpleChoiceListTest extends PHPUnit_Framework_TestCase
{
    private $list;
    ...
    protected function setUp()
    {
        ...
        $this->list = new Symfony_Component_Form_Extension_Core_ChoiceList_SimpleChoiceList($choices, array('b', 'c'));

        // Use COPY_CHOICE strategy to test for the various associated problems
        $this->numericList = new Symfony_Component_Form_Extension_Core_ChoiceList_SimpleChoiceList($numericChoices, array(1, 2));
    }
    ...
    public function testInitArray()
    {
        ...
        $this->list = new Symfony_Component_Form_Extension_Core_ChoiceList_SimpleChoiceList($choices, array('b'));
    ...
    public function testInitNestedArray()
    {
        ...
        $this->assertEquals(array(
            'Group 1' => array(1 => new Symfony_Component_Form_Extension_Core_View_ChoiceView('b', 'b', 'B')),
            'Group 2' => array(2 => new Symfony_Component_Form_Extension_Core_View_ChoiceView('c', 'c', 'C'))
        ), $this->list->getPreferredViews());
        $this->assertEquals(array(
            'Group 1' => array(0 => new Symfony_Component_Form_Extension_Core_View_ChoiceView('a', 'a', 'A')),
            'Group 2' => array(3 => new Symfony_Component_Form_Extension_Core_View_ChoiceView('d', 'd', 'D'))
    ...
    public function testGetValuesForChoicesDealsWithDirtyValues($choice, $value)
    {
        ...
        $this->list = new Symfony_Component_Form_Extension_Core_ChoiceList_SimpleChoiceList($choices, array());
