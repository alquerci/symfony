...
class Symfony_Component_Form_Tests_Extension_Core_DataTransformer_DateTimeToStringTransformerTest extends Symfony_Component_Form_Tests_Extension_Core_DataTransformer_DateTimeTestCase
{
    ...
    {
        $transformer = new Symfony_Component_Form_Extension_Core_DataTransformer_DateTimeToStringTransformer('UTC', 'UTC', $format);
    ...
    {
        $transformer = new Symfony_Component_Form_Extension_Core_DataTransformer_DateTimeToStringTransformer();
    ...
    {
        $transformer = new Symfony_Component_Form_Extension_Core_DataTransformer_DateTimeToStringTransformer('Asia/Hong_Kong', 'America/New_York', 'Y-m-d H:i:s');
    ...
    public function testReverseTransformUsingPipe($format, $input, $output)
    {
        ...
        $reverseTransformer = new Symfony_Component_Form_Extension_Core_DataTransformer_DateTimeToStringTransformer('UTC', 'UTC', $format, true);
    ...
    {
        $reverseTransformer = new Symfony_Component_Form_Extension_Core_DataTransformer_DateTimeToStringTransformer('UTC', 'UTC', $format, false);
    ...
    {
        $reverseTransformer = new Symfony_Component_Form_Extension_Core_DataTransformer_DateTimeToStringTransformer();
    ...
    {
        $reverseTransformer = new Symfony_Component_Form_Extension_Core_DataTransformer_DateTimeToStringTransformer('America/New_York', 'Asia/Hong_Kong', 'Y-m-d H:i:s');
    ...
    public function testReverseTransformExpectsValidDateString()
    {
        ...
        $this->setExpectedException('Symfony_Component_Form_Exception_TransformationFailedException');
