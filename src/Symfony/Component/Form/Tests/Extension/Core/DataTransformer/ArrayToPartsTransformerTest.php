...
class Symfony_Component_Form_Tests_Extension_Core_DataTransformer_ArrayToPartsTransformerTest extends PHPUnit_Framework_TestCase
{
    private $transformer;

    protected function setUp()
    {
        $this->transformer = new Symfony_Component_Form_Extension_Core_DataTransformer_ArrayToPartsTransformer(array(
            'first' => array('a', 'b', 'c'),
            'second' => array('d', 'e', 'f'),
        ));
    }
