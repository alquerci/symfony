 ...
 */
class Symfony_Component_Form_Tests_Extension_Validator_ViolationMapper_ViolationPathTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testCreatePath($string, $entries, $slicedPath = null)
    {
        ...
        $path = new Symfony_Component_Form_Extension_Validator_ViolationMapper_ViolationPath($string);
    ...
    {
        $path = new Symfony_Component_Form_Extension_Validator_ViolationMapper_ViolationPath($violationPath);
        $parent = $parentPath === null ? null : new Symfony_Component_Form_Extension_Validator_ViolationMapper_ViolationPath($parentPath);
    ...
    {
        $path = new Symfony_Component_Form_Extension_Validator_ViolationMapper_ViolationPath('children[address].data[street].name');
