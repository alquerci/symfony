...
abstract class Symfony_Component_Form_Tests_AbstractLayoutTest extends Symfony_Component_Form_Tests_FormIntegrationTestCase
{
    ...
    {
        return array(
            new Symfony_Component_Form_Extension_Csrf_CsrfExtension($this->csrfProvider),
        );
    }
    ...
    protected function assertWidgetMatchesXpath(Symfony_Component_Form_FormView $view, array $vars, $xpath)
    {
    ...
    abstract protected function renderEnctype(Symfony_Component_Form_FormView $view);

    abstract protected function renderLabel(Symfony_Component_Form_FormView $view, $label = null, array $vars = array());

    abstract protected function renderErrors(Symfony_Component_Form_FormView $view);

    abstract protected function renderWidget(Symfony_Component_Form_FormView $view, array $vars = array());

    abstract protected function renderRow(Symfony_Component_Form_FormView $view, array $vars = array());

    abstract protected function renderRest(Symfony_Component_Form_FormView $view, array $vars = array());

    abstract protected function setTheme(Symfony_Component_Form_FormView $view, array $themes);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'text');
        $form->addError(new Symfony_Component_Form_FormError('[trans]Error 1[/trans]'));
        $form->addError(new Symfony_Component_Form_FormError('[trans]Error 2[/trans]'));
        $view = $form->createView();
...
'
    ...
    public function testDateErrorBubbling()
    {
        ...
        $child->addError(new Symfony_Component_Form_FormError('[trans]Error![/trans]'));
        $view = $form->createView();
