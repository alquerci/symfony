 ...
 */
class Symfony_Component_Form_Exception_TransformationFailedException extends RuntimeException implements Symfony_Component_Form_Exception_ExceptionInterface
{
    /**
     * @var Exception
     */
