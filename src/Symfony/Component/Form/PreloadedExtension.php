 ...
 */
class Symfony_Component_Form_PreloadedExtension implements Symfony_Component_Form_FormExtensionInterface
{
    /**
     * @var array
     */
     ...
     * @param Symfony_Component_Form_FormTypeGuesserInterface|null $typeGuesser    The guesser that the extension should support.
     */
    public function __construct(array $types, array $typeExtensions, Symfony_Component_Form_FormTypeGuesserInterface $typeGuesser = null)
    {
        $this->types = $types;
