 ...
 */
interface Symfony_Component_Form_FormRendererEngineInterface
{
    /**
     ...
     * is later passed to {@link renderBlock()} by the rendering algorithm.
     *
     * @param Symfony_Component_Form_FormView          $view               The view for determining the
     ...
     *
     * @param Symfony_Component_Form_FormView          $view      The view to render.
