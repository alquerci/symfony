 ...
 */
class Symfony_Component_Form_Extension_Validator_ViolationMapper_MappingRule
{
    /**
    ...
    public function __construct(Symfony_Component_Form_FormInterface $origin, $propertyPath, $targetPath)
    {
        $this->origin = $origin;
     ...
     *
     * @return null|Symfony_Component_Form_FormInterface The mapped form or null.
     */
     ...
     * @return Symfony_Component_Form_FormInterface
     *
     * @throws Symfony_Component_Form_Exception_ErrorMappingException
     */
    public function getTarget()
    {
        ...
        foreach ($childNames as $childName) {
            if (!$target->has($childName)) {
                throw new Symfony_Component_Form_Exception_ErrorMappingException(sprintf('The child "%s" of "%s" mapped by the rule "%s" in "%s" does not exist.', $childName, $target->getName(), $this->targetPath, $this->origin->getName()));
            }
