 ...
 */
class Symfony_Component_Form_Extension_Validator_ViolationMapper_ViolationPath implements IteratorAggregate, Symfony_Component_PropertyAccess_PropertyPathInterface
{
    /**
     * @var array
     */
    ...
    {
        $path = new Symfony_Component_PropertyAccess_PropertyPath($violationPath);
     ...
     *
     * @return Symfony_Component_Form_Extension_Validator_ViolationMapper_ViolationPathIterator
     */
    public function getIterator()
    {
        return new Symfony_Component_Form_Extension_Validator_ViolationMapper_ViolationPathIterator($this);
    }
