 ...
 * $choiceList = new Symfony_Component_Form_Extension_Core_ChoiceList_ObjectChoiceList($choices, 'name');
 * </code>
 *
 * @author Bernhard Schussek <bschussek@gmail.com>
 */
class Symfony_Component_Form_Extension_Core_ChoiceList_ObjectChoiceList extends Symfony_Component_Form_Extension_Core_ChoiceList_ChoiceList
{
    /**
     ...
     *
     * @var Symfony_Component_PropertyAccess_PropertyPath
     */
    private $labelPath;
     ...
     * @param Symfony_Component_PropertyAccess_PropertyAccessorInterface $propertyAccessor The reflection graph for reading property paths.
     */
    ...
    protected function initialize($choices, array $labels, array $preferredChoices)
    {
        if (null !== $this->groupPath) {
            ...
            foreach ($choices as $i => $choice) {
                ...
                } catch (Symfony_Component_PropertyAccess_Exception_NoSuchPropertyException $e) {
