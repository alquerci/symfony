 ...
 */
class Symfony_Component_Form_Extension_Core_DataTransformer_DateTimeToStringTransformer extends Symfony_Component_Form_Extension_Core_DataTransformer_BaseDateTimeTransformer
{
    /**
     ...
     *
     * @throws Symfony_Component_Form_Exception_UnexpectedTypeException if the given value is not a DateTime instance
