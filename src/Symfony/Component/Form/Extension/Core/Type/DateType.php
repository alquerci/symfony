...
class Symfony_Component_Form_Extension_Core_Type_DateType extends Symfony_Component_Form_AbstractType
{
    ...
    public function buildForm(Symfony_Component_Form_FormBuilderInterface $builder, array $options)
    {
        ...
        if (!in_array($dateFormat, self::$acceptedFormats, true)) {
            throw new Symfony_Component_OptionsResolver_Exception_InvalidOptionsException('The "format" option must be one of the IntlDateFormatter constants (FULL, LONG, MEDIUM, SHORT) or a string representing a custom format.');
        }

        if (null !== $pattern && (false === strpos($pattern, 'y') || false === strpos($pattern, 'M') || false === strpos($pattern, 'd'))) {
            throw new Symfony_Component_OptionsResolver_Exception_InvalidOptionsException(sprintf('The "format" option should contain the letters "y", "M" and "d". Its current value is "%s".', $pattern));
        }
        ...
        if ('single_text' === $options['widget']) {
            ...
            $builder
                ...
                ->addViewTransformer(new Symfony_Component_Form_Extension_Core_DataTransformer_DateTimeToArrayTransformer(
        ...
        if ('string' === $options['input']) {
            $builder->addModelTransformer(new Symfony_Component_Form_ReversedTransformer(
                new Symfony_Component_Form_Extension_Core_DataTransformer_DateTimeToStringTransformer($options['model_timezone'], $options['model_timezone'], 'Y-m-d')
            ));
            ...
            $builder->addModelTransformer(new Symfony_Component_Form_ReversedTransformer(
                new Symfony_Component_Form_Extension_Core_DataTransformer_DateTimeToArrayTransformer($options['model_timezone'], $options['model_timezone'], array('year', 'month', 'day'))
            ));
        }
    }
