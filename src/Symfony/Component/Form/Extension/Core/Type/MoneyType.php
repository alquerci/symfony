...
class Symfony_Component_Form_Extension_Core_Type_MoneyType extends Symfony_Component_Form_AbstractType
{
    ...
    {
        $builder
            ->addViewTransformer(new Symfony_Component_Form_Extension_Core_DataTransformer_MoneyToLocalizedStringTransformer(
                $options['precision'],
                $options['grouping'],
                null,
                $options['divisor']
