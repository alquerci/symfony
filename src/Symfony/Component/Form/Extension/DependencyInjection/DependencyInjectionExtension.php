...
class Symfony_Component_Form_Extension_DependencyInjection_DependencyInjectionExtension implements Symfony_Component_Form_FormExtensionInterface
{
    private $container;
    ...
    public function getTypeGuesser()
    {
        if (!$this->guesserLoaded) {
            ...
            if (count($guessers) > 0) {
                $this->guesser = new Symfony_Component_Form_FormTypeGuesserChain($guessers);
            }
        }
