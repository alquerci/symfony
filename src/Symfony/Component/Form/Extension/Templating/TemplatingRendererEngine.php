 ...
 */
class Symfony_Component_Form_Extension_Templating_TemplatingRendererEngine extends Symfony_Component_Form_AbstractRendererEngine
{
    /**
     * @var Symfony_Component_Templating_EngineInterface
     */
    private $engine;

    public function __construct(Symfony_Component_Templating_EngineInterface $engine, array $defaultThemes = array())
    {
     ...
     * {@inheritdoc}
     */
    public function renderBlock(Symfony_Component_Form_FormView $view, $resource, $blockName, array $variables = array())
    {
     ...
     */
    protected function loadResourceForBlockName($cacheKey, Symfony_Component_Form_FormView $view, $blockName)
    {
