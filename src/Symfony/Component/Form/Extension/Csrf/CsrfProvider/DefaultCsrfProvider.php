 ...
 */
class Symfony_Component_Form_Extension_Csrf_CsrfProvider_DefaultCsrfProvider implements Symfony_Component_Form_Extension_Csrf_CsrfProvider_CsrfProviderInterface
{
    /**
