 ...
 */
abstract class Symfony_Bundle_SecurityBundle_DependencyInjection_Security_Factory_AbstractFactory implements Symfony_Bundle_SecurityBundle_DependencyInjection_Security_Factory_SecurityFactoryInterface
{
    ...
    public function create(Symfony_Component_DependencyInjection_ContainerBuilder $container, $id, $config, $userProviderId, $defaultEntryPointId)
    {
     ...
     */
    abstract protected function createAuthProvider(Symfony_Component_DependencyInjection_ContainerBuilder $container, $id, $config, $userProviderId);
    ...
    protected function createListener($container, $id, $config, $userProvider)
    {
        ...
        $listener = new Symfony_Component_DependencyInjection_DefinitionDecorator($listenerId);
        $listener->replaceArgument(4, $id);
        $listener->replaceArgument(5, new Symfony_Component_DependencyInjection_Reference($this->createAuthenticationSuccessHandler($container, $id, $config)));
        $listener->replaceArgument(6, new Symfony_Component_DependencyInjection_Reference($this->createAuthenticationFailureHandler($container, $id, $config)));
    ...
    protected function createAuthenticationSuccessHandler($container, $id, $config)
    {
        ...
        $successHandler = $container->setDefinition($successHandlerId, new Symfony_Component_DependencyInjection_DefinitionDecorator('security.authentication.success_handler'));
    ...
    protected function createAuthenticationFailureHandler($container, $id, $config)
    {
        ...
        $failureHandler = $container->setDefinition($id, new Symfony_Component_DependencyInjection_DefinitionDecorator('security.authentication.failure_handler'));
