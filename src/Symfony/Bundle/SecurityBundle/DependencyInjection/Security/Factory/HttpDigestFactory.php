 ...
 */
class Symfony_Bundle_SecurityBundle_DependencyInjection_Security_Factory_HttpDigestFactory implements Symfony_Bundle_SecurityBundle_DependencyInjection_Security_Factory_SecurityFactoryInterface
{
    public function create(Symfony_Component_DependencyInjection_ContainerBuilder $container, $id, $config, $userProvider, $defaultEntryPoint)
    {
        ...
        $listener = $container->setDefinition($listenerId, new Symfony_Component_DependencyInjection_DefinitionDecorator('security.authentication.listener.digest'));
    ...
    protected function createEntryPoint($container, $id, $config, $defaultEntryPoint)
    {
        ...
        $container
            ->setDefinition($entryPointId, new Symfony_Component_DependencyInjection_DefinitionDecorator('security.authentication.digest_entry_point'))
