 ...
 */
class Symfony_Bundle_FrameworkBundle_Templating_DelegatingEngine extends Symfony_Component_Templating_DelegatingEngine implements Symfony_Bundle_FrameworkBundle_Templating_EngineInterface
{
    protected $container;
     ...
     */
    public function __construct(Symfony_Component_DependencyInjection_ContainerInterface $container, array $engineIds)
    {
