 ...
 */
class Symfony_Bundle_FrameworkBundle_Templating_Helper_CodeHelper extends Symfony_Component_Templating_Helper_Helper
{
    ...
    {
        return preg_replace_callback('/in ("|&quot;)?(.+?)\1(?: +(?:on|at))? +line (\d+)/s', array($this, '_formatFileFromTextCB'), $text);
    }

    protected function _formatFileFromTextCB($match)
    {
