 ...
 */
class Symfony_Bundle_FrameworkBundle_HttpKernel extends Symfony_Component_HttpKernel_DependencyInjection_ContainerAwareHttpKernel
{
    /**
    ...
    public function forward($controller, array $attributes = array(), array $query = array())
    {
        ...
        return $this->handle($subRequest, Symfony_Component_HttpKernel_HttpKernelInterface::SUB_REQUEST);
    }
