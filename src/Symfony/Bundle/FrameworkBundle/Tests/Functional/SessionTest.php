 ...
 * @group functional
 */
class Symfony_Bundle_FrameworkBundle_Tests_Functional_SessionTest extends Symfony_Bundle_FrameworkBundle_Tests_Functional_WebTestCase
{
    /**
    ...
    public function getConfigs()
    {
        return array(
            // configfile, insulate
// TODO Process        array('config.yml', true),
