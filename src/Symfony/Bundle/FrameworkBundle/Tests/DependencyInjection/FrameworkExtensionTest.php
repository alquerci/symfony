...
abstract class Symfony_Bundle_FrameworkBundle_Tests_DependencyInjection_FrameworkExtensionTest extends Symfony_Bundle_FrameworkBundle_Tests_TestCase
{
...
*/
    ...
    public function testRouterRequiresResourceOption()
    {
        ...
        $loader = new Symfony_Bundle_FrameworkBundle_DependencyInjection_FrameworkExtension();
    ...
    public function testSession()
    {
        ...
        $this->assertEquals('session.storage.native', (string) $container->getAlias('session.storage')->__toString());
        $this->assertEquals('session.handler.native_file', (string) $container->getAlias('session.handler')->__toString());
    ...
    public function testTemplating()
    {
        ...
        $this->assertInstanceOf('Symfony_Component_DependencyInjection_DefinitionDecorator', $package);
        ...
        $this->assertEquals('templating.engine.delegating', (string) $container->getAlias('templating')->__toString(), '->registerTemplatingConfiguration() configures delegating loader if multiple engines are provided');
    ...
    public function testTranslator()
    {
        ...
        $this->assertEquals('translator.default', (string) $container->getAlias('translator')->__toString(), '->registerTranslatorConfiguration() redefines translator service from identity to real translator');
        ...
        $rootDirectory = str_replace('/', DIRECTORY_SEPARATOR, realpath(dirname(__FILE__).'/../../../../..').'/');
        $files = array();
...
/* TODO Validator
    public function testValidation()
    {
        ...
        $this->assertContains(
            realpath(dirname(__FILE__).'/../../../../Component/Form/Resources/config/validation.xml'),
...
/* TODO Annotations
    ...
    {
        if (!class_exists('Doctrine_Common_Version')) {
        ...
        $this->assertInstanceOf('Doctrine_Common_Annotations_FileCacheReader', $container->get('annotation_reader'));
    }
*/
...
/* TODO Validator
    public function testValidationPaths()
    {
        ...
        $container = $this->createContainerFromFile('validation_annotations', array(
            'kernel.bundles' => array('TestBundle' => 'Symfony_Bundle_FrameworkBundle_Tests_TestBundle'),
        ));
...
*/
    ...
    {
        return new Symfony_Component_DependencyInjection_ContainerBuilder(new Symfony_Component_DependencyInjection_ParameterBag_ParameterBag(array_merge(array(
            'kernel.bundles'          => array('FrameworkBundle' => 'Symfony_Bundle_FrameworkBundle_FrameworkBundle'),
            'kernel.cache_dir'        => dirname(__FILE__),
            'kernel.compiled_classes' => array(),
            'kernel.debug'            => false,
            'kernel.environment'      => 'test',
            'kernel.name'             => 'kernel',
            'kernel.root_dir'         => dirname(__FILE__),
        ), $data)));
    }
    ...
    protected function createContainerFromFile($file, $data = array())
    {
        ...
        $container->registerExtension(new Symfony_Bundle_FrameworkBundle_DependencyInjection_FrameworkExtension());
