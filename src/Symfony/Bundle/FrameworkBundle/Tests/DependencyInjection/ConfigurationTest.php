...
class Symfony_Bundle_FrameworkBundle_Tests_DependencyInjection_ConfigurationTest extends PHPUnit_Framework_TestCase
{
    public function testDefaultConfig()
    {
        $processor = new Symfony_Component_Config_Definition_Processor();
        $config = $processor->processConfiguration(new Symfony_Bundle_FrameworkBundle_DependencyInjection_Configuration(), array(array('secret' => 's3cr3t')));
    ...
    {
        $processor = new Symfony_Component_Config_Definition_Processor();
        $configuration = new Symfony_Bundle_FrameworkBundle_DependencyInjection_Configuration(array());
