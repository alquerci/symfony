...
class Symfony_Bundle_FrameworkBundle_Tests_Translation_TranslatorTest extends PHPUnit_Framework_TestCase
{
    protected $tmpDir;
    ...
    public function testTransWithCaching()
    {
        ...
        $loader = $this->getMock('Symfony_Component_Translation_Loader_LoaderInterface');
    ...
    public function testGetLocale()
    {
        ...
        $translator = new Symfony_Bundle_FrameworkBundle_Translation_Translator($container, new Symfony_Component_Translation_MessageSelector());
    ...
    {
        $translator = new Symfony_Bundle_FrameworkBundle_Translation_Translator(
            $this->getContainer($loader),
            new Symfony_Component_Translation_MessageSelector(),
