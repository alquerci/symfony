 ...
 */
class Symfony_Bundle_FrameworkBundle_Controller_ControllerNameParser
{
    protected $kernel;
     ...
     */
    public function __construct(Symfony_Component_HttpKernel_KernelInterface $kernel)
    {
        $this->kernel = $kernel;
    }
    ...
    public function parse($controller)
    {
        ...
        foreach ($this->kernel->getBundle($bundle, false) as $b) {
            $try = $b->getNamespace().'_Controller_'.$controller.'Controller';
            if (class_exists($try)) {
